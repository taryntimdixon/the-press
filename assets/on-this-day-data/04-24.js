/* Detail payload for 04-24. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-24"] = {
  "date": "04-24",
  "displayDate": "April 24",
  "year": 1990,
  "title": "Hubble Space Telescope",
  "topic": "Hubble Space Telescope",
  "headline": "The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery.",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 24"
  ...
  "summary": [
    "April 24, 1990, is not just a date label for Hubble Space Telescope. It is the point where a larger space exploration story becomes visible enough to study. The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    {
      "title": "STS-31",
      "source": "https://en.wikipedia.org/wiki/STS-31",
    ...
    },
    {
      ...
      "description": "Space Shuttle orbiter (1984–2011)"
    }
  ],
  "coolFacts": [
    "April 24 places the reader in 1990, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Hubble%20Space%20Telescope%201990&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://www.nasa.gov/search/?search=Hubble%20Space%20Telescope%201990",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Hubble%20Space%20Telescope%201990",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Hubble%20Space%20Telescope%201990",
  ...
  "article": [
    ...
    {
      "text": "April 24, 1990, is not just a date label for Hubble Space Telescope. It is the point where a larger space exploration story becomes visible enough to study. The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 24, 1990, the Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. Why it mattered: Hubble Space Telescope put a new mission, institution, product, or public force into motion, and it pushed space exploration into a new. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation... The source record identifies Hubble Space Telescope as nASA/ESA space telescope launched in 1990. Related subjects include Hubble Space Telescope (NASA/ESA space telescope launched in 1990), STS-31 (1990 American crewed spaceflight to deploy the Hubble Space Telescope), Space Shuttle Discovery (Space Shuttle orbiter (1984–2011)).... The related trail points to Hubble Space Telescope, STS-31, Space Shuttle Discovery, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Hubble Space Telescope, the detail work starts with the nouns inside the event itself: The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of April 24 is easy: The Hubble Space Telescope was launched aboard STS-31 by Space Shuttle Discovery. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-24");
