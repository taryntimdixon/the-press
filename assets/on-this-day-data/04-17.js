/* Detail payload for 04-17. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-17"] = {
  "date": "04-17",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA announced the discovery of Kepler-186f, the first exoplanet with a radius similar to Earth's discovered in the... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 17"
  ...
  "related": [
    ...
    {
      "title": "Kepler-186f",
      "source": "https://en.wikipedia.org/wiki/Kepler-186f",
      "description": "Terrestrial exoplanet orbiting Kepler-186"
    },
    {
      "title": "Exoplanet",
      "source": "https://en.wikipedia.org/wiki/Exoplanet",
      "description": "Planet outside of the Solar System"
    },
    {
      "title": "Habitable zone",
      "source": "https://en.wikipedia.org/wiki/Habitable_zone",
      "description": "Orbits where planets may have liquid surface water"
    }
  ],
  "coolFacts": [
    "April 17 places the reader in 2014, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%202014&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%202014",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=NASA%202014",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=NASA%202014",
  ...
  "article": [
    ...
    {
      "text": "April 17, 2014, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA announced the discovery of Kepler-186f, the first exoplanet with a radius similar to Earth's discovered in the habitable zone of another star. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The short version of April 17 is easy: NASA announced the discovery of Kepler-186f, the first exoplanet with a radius similar to Earth's discovered in the habitable zone of another star. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-17");
