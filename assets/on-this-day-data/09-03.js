...
window.PRESS_ON_THIS_DAY_DETAIL["09-03"] = {
  ...
  "dek": "The Holocaust: In possibly the first Jewish ghetto uprising, residents of the Łachwa Ghetto in occupied Poland, informed... The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 3"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with The Holocaust.",
  ...
  "article": [
    ...
    {
      "text": "The short version of September 3 is easy: The Holocaust: In possibly the first Jewish ghetto uprising, residents of the Łachwa Ghetto in occupied Poland, informed of the upcoming \"liquidation\" of the ghetto, unsuccessfully fought against their Nazi captors. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
