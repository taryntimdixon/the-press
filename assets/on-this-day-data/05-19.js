/* Detail payload for 05-19. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-19"] = {
  "date": "05-19",
  "displayDate": "May 19",
  "year": 2010,
  ...
  "sourceDescription": "State suppression of pro-democracy protests in Bangkok, Thailand",
  "visual": "protest",
  "palette": "public-square",
  "dek": "In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition... The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 19"
    ...
    {
      "label": "Main event",
      "value": "2010 Thai military crackdown"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "State suppression of pro-democracy protests in Bangkok, Thailand"
    }
  ],
  "summary": [
    "May 19, 2010, is not just a date label for 2010 Thai military crackdown. It is the point where a larger protest story becomes visible enough to study. In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition leaders. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a street, square, prison, factory gate, school, or public building where ordinary people made power answer back. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. 2010 Thai military crackdown belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1883,
  "related": [
    {
      "title": "Royal Thai Armed Forces",
      "source": "https://en.wikipedia.org/wiki/Royal_Thai_Armed_Forces",
      "description": "Unified military forces of Thailand"
    },
    {
      "title": "2010 Thai military crackdown",
      "source": "https://en.wikipedia.org/wiki/2010_Thai_military_crackdown",
      "description": "State suppression of pro-democracy protests in Bangkok, Thailand"
    },
    {
      "title": "2010 Thai political protests",
      "source": "https://en.wikipedia.org/wiki/2010_Thai_political_protests",
      "description": "Pro-democracy protests in Thailand"
    },
    {
      "title": "United Front for Democracy Against Dictatorship",
      "source": "https://en.wikipedia.org/wiki/United_Front_for_Democracy_Against_Dictatorship",
      "description": "Pro-democracy political pressure group in Thailand"
    }
  ],
  "coolFacts": [
    "May 19 places the reader in 2010, inside a protest story with consequences beyond the date itself.",
    ...
    "The central source trail begins with 2010 Thai military crackdown.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: 2010 Thai military crackdown",
      "href": "https://commons.wikimedia.org/w/index.php?search=2010%20Thai%20military%20crackdown%202010&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: 2010 Thai military crackdown",
      "href": "https://catalog.archives.gov/search?q=2010%20Thai%20military%20crackdown%202010",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: 2010 Thai military crackdown",
      "href": "https://archive.org/search?query=2010%20Thai%20military%20crackdown%202010",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: 2010 Thai military crackdown",
      "href": "https://www.britannica.com/search?query=2010%20Thai%20military%20crackdown",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: 2010 Thai military crackdown",
      "href": "https://www.nytimes.com/search?query=2010%20Thai%20military%20crackdown%202010",
  ...
  "article": [
    ...
    {
      "text": "May 19, 2010, is not just a date label for 2010 Thai military crackdown. It is the point where a larger protest story becomes visible enough to study. In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition leaders. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed the emotional temperature of politics and showed what pressure from below could do. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. 2010 Thai military crackdown matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as state suppression of pro-democracy protests in Bangkok, Thailand. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 19, 2010, In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition leaders. Why it mattered: 2010 Thai military crackdown matters because it showed public pressure becoming a political force rather than background noise. In the wider protest story, it showed public pressure becoming a political force rather than background noise. The source record identifies 2010 Thai military crackdown as state suppression of pro-democracy protests in Bangkok, Thailand. Related subjects include Royal Thai Armed Forces (Unified military forces of Thailand), 2010 Thai military crackdown (State suppression of pro-democracy protests in Bangkok, Thailand), 2010 Thai political... The related trail points to Royal Thai Armed Forces, 2010 Thai military crackdown, 2010 Thai political protests, United Front for Democracy Against Dictatorship, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten 2010 Thai military crackdown into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. 2010 Thai military crackdown is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For 2010 Thai military crackdown, the detail work starts with the nouns inside the event itself: In Bangkok, the Thai military concluded a week-long crackdown on widespread protests by forcing the surrender of opposition leaders. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-19");
