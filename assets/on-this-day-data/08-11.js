...
window.PRESS_ON_THIS_DAY_DETAIL["08-11"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is DJ Kool Herc.",
  ...
  "article": [
    ...
    {
      "text": "The short version of August 11 is easy: At a party in New York City, Jamaican musician DJ Kool Herc began rapping during an extended break, laying the foundation for hip hop music. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
