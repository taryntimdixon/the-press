...
window.PRESS_ON_THIS_DAY_DETAIL["01-23"] = {
  ...
  "article": [
    ...
    {
      "text": "The short version of January 23 is easy: The final signal was detected from the NASA space probe Pioneer 10, then about 12 billion kilometres (7.5 billion miles) from Earth. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
