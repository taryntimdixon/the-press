/* Detail payload for 09-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-21"] = {
  "date": "09-21",
  ...
  "sourceDescription": "1968 Soviet spaceflight, first lunar mission to carry animals",
  "visual": "space",
  "palette": "lunar",
  "dek": "The Soviet Union's Zond 5 landed in the Indian Ocean, becoming the first spacecraft to safely return to Earth after travelling around the Moon. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 21"
    ...
    {
      "label": "Source trail",
      "value": "1968 Soviet spaceflight, first lunar mission to carry animals"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Zond 5",
      "source": "https://en.wikipedia.org/wiki/Zond_5",
      "description": "1968 Soviet spaceflight, first lunar mission to carry animals"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Zond 5",
      "href": "https://commons.wikimedia.org/w/index.php?search=Zond%205%201968&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Zond 5",
      "href": "https://www.nasa.gov/search/?search=Zond%205%201968",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Zond 5",
      "href": "https://archive.org/search?query=Zond%205%201968",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Zond 5",
      "href": "https://www.britannica.com/search?query=Zond%205",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Zond 5",
      "href": "https://www.nytimes.com/search?query=Zond%205%201968",
  ...
  "article": [
    ...
    {
      "text": "September 21, 1968, is not just a date label for Zond 5. It is the point where a larger space exploration story becomes visible enough to study. The Soviet Union's Zond 5 landed in the Indian Ocean, becoming the first spacecraft to safely return to Earth after travelling around the Moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Zond 5 matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 1968 Soviet spaceflight, first lunar mission to carry animals. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 21, 1968, the Soviet Union's Zond 5 landed in the Indian Ocean, becoming the first spacecraft to safely return to Earth after travelling around the Moon. Why it mattered: Zond 5 marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and. The source record identifies Zond 5 as 1968 Soviet spaceflight, first lunar mission to carry animals. Related subjects include Zond 5 (1968 Soviet spaceflight, first lunar mission to carry animals). The lasting consequence was a larger map of what humans and their machines could. The related trail points to Zond 5, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Zond 5 is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Zond 5, the detail work starts with the nouns inside the event itself: The Soviet Union's Zond 5 landed in the Indian Ocean, becoming the first spacecraft to safely return to Earth after travelling around the Moon. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-21");
