...
window.PRESS_ON_THIS_DAY_DETAIL["05-20"] = {
  ...
  "visual": "civic",
  "palette": "civic",
  "dek": "In deciding Romer v. Evans, the U.S. Supreme Court struck down a constitutional amendment in Colorado that prevented... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 20"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Romer v. Evans.",
  ...
  "article": [
    ...
    {
      "text": "The short version of May 20 is easy: In deciding Romer v. Evans, the U.S. Supreme Court struck down a constitutional amendment in Colorado that prevented protected status under the law for homosexuals or bisexuals. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
