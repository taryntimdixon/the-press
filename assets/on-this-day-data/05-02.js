/* Detail payload for 05-02. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-02"] = {
  "date": "05-02",
  "displayDate": "May 2",
  "year": 1889,
  ...
  "sourceDescription": "1889 trade agreement between the Ethiopian Empire and the Kingdom of Italy",
  "visual": "civic",
  "palette": "civic",
  "dek": "The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 2"
    ...
    {
      "label": "Source trail",
      "value": "1889 trade agreement between the Ethiopian Empire and the Kingdom of Italy"
    }
  ],
  "summary": [
    "May 2, 1889, is not just a date label for Treaty of Wuchale. It is the point where a larger government and civic power story becomes visible enough to study. The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another war. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a formal place where documents, offices, ceremonies, laws, and public legitimacy became the center of the story. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Treaty of Wuchale belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1886,
  "related": [
    {
      "title": "Treaty of Wuchale",
      "source": "https://en.wikipedia.org/wiki/Treaty_of_Wuchale",
      "description": "1889 trade agreement between the Ethiopian Empire and the Kingdom of Italy"
    },
    {
      "title": "Italo-Ethiopian War of 1887–1889",
      "source": "https://en.wikipedia.org/wiki/Italo-Ethiopian_War_of_1887%E2%80%931889",
      "description": "1887–1889 conflict with Ethiopia during the Italian colonization of East Africa"
    },
    {
      "title": "First Italo-Ethiopian War",
      "source": "https://en.wikipedia.org/wiki/First_Italo-Ethiopian_War",
      "description": "1895–1896 war between the Ethiopia and Italy"
    }
  ],
  "coolFacts": [
    "May 2 places the reader in 1889, inside a government and civic power story with consequences beyond the date itself.",
    "The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another war.",
    "The central source trail begins with Treaty of Wuchale.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Treaty of Wuchale",
      "href": "https://commons.wikimedia.org/w/index.php?search=Treaty%20of%20Wuchale%201889&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Treaty of Wuchale",
      "href": "https://catalog.archives.gov/search?q=Treaty%20of%20Wuchale%201889",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Treaty of Wuchale",
      "href": "https://archive.org/search?query=Treaty%20of%20Wuchale%201889",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Treaty of Wuchale",
      "href": "https://www.britannica.com/search?query=Treaty%20of%20Wuchale",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Treaty of Wuchale",
      "href": "https://www.nytimes.com/search?query=Treaty%20of%20Wuchale%201889",
  ...
  "article": [
    ...
    {
      "text": "May 2, 1889, is not just a date label for Treaty of Wuchale. It is the point where a larger government and civic power story becomes visible enough to study. The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another war. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 2, 1889, the Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another war. Why it mattered: Treaty of Wuchale turned an argument into a formal rule, and it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Treaty of Wuchale as 1889 trade agreement between the Ethiopian Empire and the Kingdom of Italy. Related subjects include Treaty of Wuchale (1889 trade agreement between the Ethiopian Empire and the Kingdom of Italy), Italo-Ethiopian War of 1887–1889 (1887–1889 conflict... The related trail points to Treaty of Wuchale, Italo-Ethiopian War of 1887–1889, First Italo-Ethiopian War, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Treaty of Wuchale into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Treaty of Wuchale is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Treaty of Wuchale, the detail work starts with the nouns inside the event itself: The Treaty of Wuchale was signed, ending the Italo-Ethiopian War, but differences in translation later led to another war. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-02");
