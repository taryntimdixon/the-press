/* Detail payload for 08-05. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-05"] = {
  "date": "08-05",
  "displayDate": "August 5",
  "year": 2011,
  "title": "Juno (spacecraft)",
  "topic": "Juno (spacecraft)",
  "headline": "NASA launched the Juno probe to Jupiter as part of the New Frontiers program.",
  ...
  "sourceLabel": "Wikipedia: Juno (spacecraft)",
  "sourceDescription": "Second NASA orbiter mission to Jupiter (2011–Present)",
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA launched the Juno probe to Jupiter as part of the New Frontiers program. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 5"
    ...
    {
      "label": "Source trail",
      "value": "Second NASA orbiter mission to Jupiter (2011–Present)"
    }
  ],
  "summary": [
    "August 5, 2011, is not just a date label for Juno (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. NASA launched the Juno probe to Jupiter as part of the New Frontiers program. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "NASA launched the Juno probe to Jupiter as part of the New Frontiers program. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Juno (spacecraft) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1838,
  "related": [
    {
      "title": "Juno (spacecraft)",
      "source": "https://en.wikipedia.org/wiki/Juno_(spacecraft)",
      "description": "Second NASA orbiter mission to Jupiter (2011–Present)"
    },
    {
      "title": "Jupiter",
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/New_Frontiers_program",
      "description": "Series of space exploration missions being conducted by NASA"
    }
  ],
  "coolFacts": [
    "August 5 places the reader in 2011, inside a space exploration story with consequences beyond the date itself.",
    "NASA launched the Juno probe to Jupiter as part of the New Frontiers program.",
    "The central source trail begins with Juno (spacecraft).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Juno (spacecraft)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Juno%20(spacecraft)%202011&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Juno (spacecraft)",
      "href": "https://www.nasa.gov/search/?search=Juno%20(spacecraft)%202011",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Juno (spacecraft)",
      "href": "https://archive.org/search?query=Juno%20(spacecraft)%202011",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Juno (spacecraft)",
      "href": "https://www.britannica.com/search?query=Juno%20(spacecraft)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Juno (spacecraft)",
      "href": "https://www.nytimes.com/search?query=Juno%20(spacecraft)%202011",
  ...
  "article": [
    ...
    {
      "text": "August 5, 2011, is not just a date label for Juno (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. NASA launched the Juno probe to Jupiter as part of the New Frontiers program. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "NASA launched the Juno probe to Jupiter as part of the New Frontiers program. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 5, 2011, NASA launched the Juno probe to Jupiter as part of the New Frontiers program. Why it mattered: Juno (spacecraft) put a new mission, institution, product, or public force into motion, and it pushed space exploration into a new. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications... The source record identifies Juno (spacecraft) as second NASA orbiter mission to Jupiter (2011–Present). Related subjects include Juno (spacecraft) (Second NASA orbiter mission to Jupiter (2011–Present)), Jupiter (Fifth planet from the Sun), New Frontiers program (Series of space exploration missions being conducted by NASA).... The related trail points to Juno (spacecraft), Jupiter, New Frontiers program, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Juno (spacecraft) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Juno (spacecraft) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Juno (spacecraft), the detail work starts with the nouns inside the event itself: NASA launched the Juno probe to Jupiter as part of the New Frontiers program. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-05");
