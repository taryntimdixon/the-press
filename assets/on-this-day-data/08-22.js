/* Detail payload for 08-22. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-22"] = {
  "date": "08-22",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "American politician and jurist (born 1947)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Roy Moore",
      "source": "https://en.wikipedia.org/wiki/Roy_Moore",
      "description": "American politician and jurist (born 1947)"
    },
    {
      "title": "Ten Commandments",
      "source": "https://en.wikipedia.org/wiki/Ten_Commandments",
      "description": "Biblical principles relating to ethics and worship"
    },
    {
      "title": "Supreme Court of Alabama",
      "source": "https://en.wikipedia.org/wiki/Supreme_Court_of_Alabama",
      "description": "Highest court in the U.S. state of Alabama"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Roy Moore",
      "href": "https://commons.wikimedia.org/w/index.php?search=Roy%20Moore%202003&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Roy Moore",
      "href": "https://catalog.archives.gov/search?q=Roy%20Moore%202003",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Roy Moore",
      "href": "https://archive.org/search?query=Roy%20Moore%202003",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Roy Moore",
      "href": "https://www.britannica.com/search?query=Roy%20Moore",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Roy Moore",
      "href": "https://www.nytimes.com/search?query=Roy%20Moore%202003",
  ...
  "article": [
    ...
    {
      "text": "August 22, 2003, is not just a date label for Roy Moore. It is the point where a larger government and civic power story becomes visible enough to study. Roy Moore, Alabama's chief justice, was suspended after refusing to comply with a U.S. federal court order to remove a rock inscribed with the Ten Commandments from the lobby of the Supreme Court of Alabama building. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Roy Moore into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Roy Moore is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-22");
