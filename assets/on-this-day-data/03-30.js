/* Detail payload for 03-30. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-30"] = {
  "date": "03-30",
  ...
  "sourceDescription": "1977 film by Woody Allen",
  "visual": "culture",
  "palette": "stage",
  "dek": "Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 30"
    ...
    {
      "label": "Source trail",
      "value": "1977 film by Woody Allen"
    }
  ],
  "summary": [
    "March 30, 1977, is not just a date label for Annie Hall. It is the point where a larger culture story becomes visible enough to study. Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Annie Hall",
      "source": "https://en.wikipedia.org/wiki/Annie_Hall",
      "description": "1977 film by Woody Allen"
    },
    {
      "title": "LA Film Festival",
      "source": "https://en.wikipedia.org/wiki/LA_Film_Festival",
      "description": "Annual film festival held in Los Angeles, California, U.S."
    },
    {
      "title": "Writers Guild of America",
      "source": "https://en.wikipedia.org/wiki/Writers_Guild_of_America",
      "description": "US TV and film writer labor unions"
    }
  ],
  "coolFacts": [
    "March 30 places the reader in 1977, inside a culture story with consequences beyond the date itself.",
    ...
    "A useful starting source is Annie Hall.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Annie Hall",
      "href": "https://commons.wikimedia.org/w/index.php?search=Annie%20Hall%201977&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Annie Hall",
      "href": "https://www.si.edu/search?edan_q=Annie%20Hall%201977",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Annie Hall",
      "href": "https://archive.org/search?query=Annie%20Hall%201977",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Annie Hall",
      "href": "https://www.britannica.com/search?query=Annie%20Hall",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Annie Hall",
      "href": "https://www.nytimes.com/search?query=Annie%20Hall%201977",
  ...
  "article": [
    ...
    {
      "text": "March 30, 1977, is not just a date label for Annie Hall. It is the point where a larger culture story becomes visible enough to study. Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 30, 1977, Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. Why it mattered: Annie Hall marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Annie Hall as 1977 film by Woody Allen. Related subjects include Annie Hall (1977 film by Woody Allen), LA Film Festival (Annual film festival held in Los Angeles, California, U.S.), Writers Guild of America (US TV and film writer labor. The related trail points to Annie Hall, LA Film Festival, Writers Guild of America, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Annie Hall, the detail work starts with the nouns inside the event itself: Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of March 30 is easy: Annie Hall had its first screening at the LA Film Festival; it was voted the funniest screenplay ever by members of the Writers Guild of America. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Annie Hall is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-30");
