/* Detail payload for 04-20. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-20"] = {
  "date": "04-20",
  "displayDate": "April 20",
  "year": 1939,
  "title": "Billie Holiday",
  "topic": "Billie Holiday",
  "headline": "Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement.",
  "text": "Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement.",
  "source": "https://en.wikipedia.org/wiki/Billie_Holiday",
  "sourceLabel": "Wikipedia: Billie Holiday",
  "sourceDescription": "American jazz singer (1915–1959)",
  "visual": "music",
  "palette": "stage",
  "dek": "Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 20"
    ...
    {
      "label": "Source trail",
      "value": "American jazz singer (1915–1959)"
    }
  ],
  "summary": [
  ...
  "related": [
    ...
    {
      "title": "Strange Fruit",
      "source": "https://en.wikipedia.org/wiki/Strange_Fruit",
      "description": "1939 song recorded by Billie Holiday"
    },
    {
      "title": "Civil rights movement (1896–1954)",
      "source": "https://en.wikipedia.org/wiki/Civil_rights_movement_(1896%E2%80%931954)",
      "description": "Social movement in the United States"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Billie Holiday",
      "href": "https://commons.wikimedia.org/w/index.php?search=Billie%20Holiday%201939&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Billie Holiday",
      "href": "https://www.si.edu/search?edan_q=Billie%20Holiday%201939",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Billie Holiday",
      "href": "https://archive.org/search?query=Billie%20Holiday%201939",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Billie Holiday",
      "href": "https://www.britannica.com/search?query=Billie%20Holiday",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Billie Holiday",
      "href": "https://www.nytimes.com/search?query=Billie%20Holiday%201939",
  ...
  "article": [
    ...
    {
      "text": "April 20, 1939, is not just a date label for Billie Holiday. It is the point where a larger music and broadcast culture story becomes visible enough to study. Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Billie Holiday matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american jazz singer (1915–1959). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 20, 1939, Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement. Why it mattered: Billie Holiday matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies Billie Holiday as american jazz singer (1915–1959). Related subjects include Billie Holiday (American jazz singer (1915–1959)), Strange Fruit (1939 song recorded by Billie Holiday), Civil rights movement (1896–1954) (Social movement in the United States). The lasting consequence was cultural memory... The related trail points to Billie Holiday, Strange Fruit, Civil rights movement (1896–1954), which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Billie Holiday into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Billie Holiday is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Billie Holiday, the detail work starts with the nouns inside the event itself: Billie Holiday recorded the song \"Strange Fruit\", which later became an emblem of the civil rights movement. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-20");
