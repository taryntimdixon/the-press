...
window.PRESS_ON_THIS_DAY_DETAIL["02-28"] = {
  ...
  "summary": [
    ...
    "The strongest image for this entry is not a symbol floating in empty space. It is a field site, lab, observatory, instrument room, or announcement where evidence forced people to update the picture of reality. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. C. V. Raman belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1905,
  "related": [
    {
  ...
  "coolFacts": [
    ...
    "The central source trail begins with C. V. Raman.",
  ...
  "article": [
    ...
    {
      "text": "The short version of February 28 is easy: Indian physicist C. V. Raman and his colleagues discovered what is now known as Raman scattering, for which he later became the first Asian to win the Nobel Prize in Physics. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
