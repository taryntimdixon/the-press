/* Detail payload for 09-11. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-11"] = {
  "date": "09-11",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "Indian monk and philosopher (1863–1902)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Swami Vivekananda",
      "source": "https://en.wikipedia.org/wiki/Swami_Vivekananda",
      "description": "Indian monk and philosopher (1863–1902)"
    },
    {
      "title": "Hinduism",
      "source": "https://en.wikipedia.org/wiki/Hinduism",
      "description": "Range of Indian religious traditions"
    },
    {
      "title": "Parliament of the World's Religions",
      "source": "https://en.wikipedia.org/wiki/Parliament_of_the_World's_Religions",
      "description": "Series of meetings intended to create a global interfaith dialogue"
    }
  ],
  "coolFacts": [
    "September 11 places the reader in 1893, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Swami Vivekananda.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Swami Vivekananda",
      "href": "https://commons.wikimedia.org/w/index.php?search=Swami%20Vivekananda%201893&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Swami Vivekananda",
      "href": "https://catalog.archives.gov/search?q=Swami%20Vivekananda%201893",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Swami Vivekananda",
      "href": "https://archive.org/search?query=Swami%20Vivekananda%201893",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Swami Vivekananda",
      "href": "https://www.britannica.com/search?query=Swami%20Vivekananda",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Swami Vivekananda",
      "href": "https://www.nytimes.com/search?query=Swami%20Vivekananda%201893",
  ...
  "article": [
    ...
    {
      "text": "September 11, 1893, is not just a date label for Swami Vivekananda. It is the point where a larger government and civic power story becomes visible enough to study. Swami Vivekananda gave a speech introducing Hinduism on the opening day of the first Parliament of the World's Religions in Chicago. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Swami Vivekananda into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Swami Vivekananda is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Swami Vivekananda, the detail work starts with the nouns inside the event itself: Swami Vivekananda gave a speech introducing Hinduism on the opening day of the first Parliament of the World's Religions in Chicago. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-11");
