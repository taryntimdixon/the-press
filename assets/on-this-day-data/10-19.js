/* Detail payload for 10-19. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-19"] = {
  "date": "10-19",
  ...
  "related": [
    ...
    {
      "title": "Sidemen",
      "source": "https://en.wikipedia.org/wiki/Sidemen",
      "description": "British Internet celebrity group"
    },
    {
    ...
    },
    {
      ...
      "description": "2013 video game"
    }
  ],
  "coolFacts": [
    "October 19 places the reader in 2013, inside a technology story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=YouTube%202013&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=YouTube%202013",
  ...
  "article": [
    ...
    {
      "text": "October 19, 2013, is not just a date label for YouTube. It is the point where a larger technology story becomes visible enough to study. British YouTube collective the Sidemen were formed as a Rockstar Games Social Club group in Grand Theft Auto Online. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For YouTube, the detail work starts with the nouns inside the event itself: British YouTube collective the Sidemen were formed as a Rockstar Games Social Club group in Grand Theft Auto Online. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of October 19 is easy: British YouTube collective the Sidemen were formed as a Rockstar Games Social Club group in Grand Theft Auto Online. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-19");
