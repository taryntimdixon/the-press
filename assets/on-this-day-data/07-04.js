/* Detail payload for 07-04. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-04"] = {
  "date": "07-04",
  "displayDate": "July 4",
  "year": 2012,
  ...
  "visual": "science",
  "palette": "signal",
  "dek": "CERN announced the discovery of a new particle consistent with the Higgs boson. The deeper story is how this science moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 4"
    ...
    {
      "label": "Main event",
      "value": "Higgs Boson Discovery Announced"
    },
    {
      "label": "Scene",
    ...
    {
      "label": "Source trail",
      "value": "CERN account of the July 4, 2012 Higgs boson announcement"
    }
  ],
  "summary": [
  ...
  "sources": [
    {
      ...
      "href": "https://home.cern/science/physics/higgs-boson",
      "description": "CERN background on the Higgs field, boson, and discovery."
    },
    {
      "kind": "Experiment Context",
      "title": "ATLAS: Higgs boson discovery",
      "href": "https://atlas.cern/Discover/Physics/Higgs",
      "description": "ATLAS experiment explanation and visual context for the discovery."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Higgs Boson Discovery Announced",
      "href": "https://commons.wikimedia.org/w/index.php?search=Higgs%20Boson%20Discovery%20Announced%202012&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Research Institution",
      "title": "CERN search: Higgs Boson Discovery Announced",
      "href": "https://home.cern/search?query=Higgs%20Boson%20Discovery%20Announced%202012",
      "description": "Institutional background, images, explainers, and research context from CERN."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Higgs Boson Discovery Announced",
      "href": "https://archive.org/search?query=Higgs%20Boson%20Discovery%20Announced%202012",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Higgs Boson Discovery Announced",
      "href": "https://www.britannica.com/search?query=Higgs%20boson",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Higgs Boson Discovery Announced",
      "href": "https://www.nytimes.com/search?query=Higgs%20Boson%20Discovery%20Announced%202012",
  ...
  "article": [
    ...
    {
      "text": "July 4, 2012, is not just a date label for Higgs Boson Discovery Announced. It is the point where a larger science story becomes visible enough to study. CERN announced that ATLAS and CMS had discovered a new particle consistent with the Higgs boson, confirming a central piece of the Standard Model after decades of searching. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed what could be measured, proven, feared, predicted, or imagined. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Higgs Boson Discovery Announced matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as cERN account of the July 4, 2012 Higgs boson announcement. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On July 4, 2012, CERN announced that ATLAS and CMS had discovered a new particle consistent with the Higgs boson, confirming a central piece of the Standard Model after decades of searching. Why it mattered: A scientific discovery that completed a missing piece of particle physics and became a rare global celebration of fundamental science. In the wider science story, it changed what researchers could observe, prove, measure, or explain. The source record identifies CERN: The Higgs boson, ten years after its discovery as cERN account of the July 4, 2012 Higgs boson announcement. The lasting consequence was knowledge: evidence, instruments, observation, or theory changed what could be proven.  Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The Higgs announcement confirmed a central piece of the Standard Model and made particle physics briefly feel like front-page public drama. That is the specific turn inside Higgs Boson Discovery Announced. The event does not matter only because it appears on a timeline; it matters because it rearranged expectations around a particular institution, medium, body of law, machine, movement, audience, or landscape. The reader can follow that turn through the source trail: the official record, the images, the museum or institutional material, and later reporting that shows how the event kept changing after the first headlines passed.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Higgs Boson Discovery Announced into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Higgs Boson Discovery Announced is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Higgs Boson Discovery Announced, the detail work starts with the nouns inside the event itself: CERN announced that ATLAS and CMS had discovered a new particle consistent with the Higgs boson, confirming a central piece of the Standard Model after decades of searching. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-04");
