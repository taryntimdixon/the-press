/* Detail payload for 12-31. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-31"] = {
  "date": "12-31",
  ...
  "sourceDescription": "Puerto Rican baseball player (1934–1972)",
  "visual": "sports",
  "palette": "public-square",
  "dek": "Puerto Rican baseball player Roberto Clemente died in a plane crash en route to deliver aid to victims... The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 31"
  ...
  "related": [
    ...
    {
      "title": "1972 Puerto Rico DC-7 crash",
      "source": "https://en.wikipedia.org/wiki/1972_Puerto_Rico_DC-7_crash",
      "description": "Aviation accident"
    },
    {
      "title": "1972 Nicaragua earthquake",
      "source": "https://en.wikipedia.org/wiki/1972_Nicaragua_earthquake",
      "description": "Earthquake in Nicaragua"
    }
  ],
  "coolFacts": [
    "December 31 places the reader in 1972, inside a history story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Roberto Clemente.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Roberto Clemente",
      "href": "https://commons.wikimedia.org/w/index.php?search=Roberto%20Clemente%201972&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Roberto Clemente",
      "href": "https://www.si.edu/search?edan_q=Roberto%20Clemente%201972",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Roberto Clemente",
      "href": "https://archive.org/search?query=Roberto%20Clemente%201972",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Roberto Clemente",
      "href": "https://www.britannica.com/search?query=Roberto%20Clemente",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Roberto Clemente",
      "href": "https://www.nytimes.com/search?query=Roberto%20Clemente%201972",
  ...
  "article": [
    ...
    {
      "text": "December 31, 1972, is not just a date label for Roberto Clemente. It is the point where a larger history story becomes visible enough to study. Puerto Rican baseball player Roberto Clemente died in a plane crash en route to deliver aid to victims of that year's Nicaragua earthquake. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Puerto Rican baseball player Roberto Clemente died in a plane crash en route to deliver aid to victims... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Roberto Clemente matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as puerto Rican baseball player (1934–1972). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 31, 1972, Puerto Rican baseball player Roberto Clemente died in a plane crash en route to deliver aid to victims of that year's Nicaragua earthquake. Why it mattered: Roberto Clemente matters because it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own limits. The source record identifies Roberto Clemente as puerto Rican baseball player (1934–1972). Related subjects include Roberto Clemente (Puerto Rican baseball player (1934–1972)), 1972 Puerto Rico DC-7 crash (Aviation accident), 1972 Nicaragua earthquake (Earthquake in Nicaragua). The lasting consequence was public memory: a contest, athlete... The related trail points to Roberto Clemente, 1972 Puerto Rico DC-7 crash, 1972 Nicaragua earthquake, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Roberto Clemente into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Roberto Clemente is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-31");
