/* Detail payload for 09-29. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-29"] = {
  "date": "09-29",
  "displayDate": "September 29",
  "year": 1990,
  "title": "Lockheed YF-22",
  "topic": "Lockheed YF-22",
  "headline": "The Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight.",
  ...
  "sourceLabel": "Wikipedia: Lockheed YF-22",
  "sourceDescription": "American aircraft prototype",
  "visual": "transport",
  "palette": "voyage",
  "dek": "The Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight. The deeper story is how this transportation moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 29"
  ...
  "related": [
    {
      "title": "Lockheed YF-22",
      "source": "https://en.wikipedia.org/wiki/Lockheed_YF-22",
      "description": "American aircraft prototype"
    },
    {
      "title": "Lockheed Martin F-22 Raptor",
      "source": "https://en.wikipedia.org/wiki/Lockheed_Martin_F-22_Raptor",
      "description": "American stealth air superiority fighter"
    }
  ],
  "coolFacts": [
    "September 29 places the reader in 1990, inside a transportation story with consequences beyond the date itself.",
    "The Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight.",
    "The central source trail begins with Lockheed YF-22.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Lockheed YF-22",
      "href": "https://commons.wikimedia.org/w/index.php?search=Lockheed%20YF-22%201990&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Lockheed YF-22",
      "href": "https://www.si.edu/search?edan_q=Lockheed%20YF-22%201990",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Lockheed YF-22",
      "href": "https://archive.org/search?query=Lockheed%20YF-22%201990",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Lockheed YF-22",
      "href": "https://www.britannica.com/search?query=Lockheed%20YF-22",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Lockheed YF-22",
      "href": "https://www.nytimes.com/search?query=Lockheed%20YF-22%201990",
  ...
  "article": [
    ...
    {
      "text": "September 29, 1990, is not just a date label for Lockheed YF-22. It is the point where a larger transportation story becomes visible enough to study. The Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 29, 1990, the Lockheed YF-22, the prototype for the F-22 Raptor, made its first flight. Why it mattered: Lockheed YF-22 marked a first, and it changed how people, goods, risk, distance, or rescue moved across the world. In the wider transport story, it changed how people, goods, risk, distance, or rescue moved across the world. The source record identifies Lockheed YF-22 as american aircraft prototype. Related subjects include Lockheed YF-22 (American aircraft prototype), Lockheed Martin F-22 Raptor (American stealth air superiority fighter). The lasting consequence was movement: people, goods, danger, rescue, or infrastructure crossed distance in a new way. The related trail points to Lockheed YF-22, Lockheed Martin F-22 Raptor, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Lockheed YF-22 into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Lockheed YF-22 is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-29");
