/* Detail payload for 08-12. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-12"] = {
  "date": "08-12",
  ...
  "sourceDescription": "1985 aviation accident in Japan",
  "visual": "music",
  "palette": "stage",
  "dek": "Japan Air Lines Flight 123 crashed into Mount Takamagahara in Gunma Prefecture, killing 520 of 524 people on... The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 12"
    ...
    {
      "label": "Main event",
      "value": "Japan Air Lines Flight 123"
    },
    {
  ...
  "related": [
    {
      "title": "Japan Air Lines Flight 123",
      "source": "https://en.wikipedia.org/wiki/Japan_Air_Lines_Flight_123",
      "description": "1985 aviation accident in Japan"
    },
    {
      "title": "Mount Takamagahara",
      "source": "https://en.wikipedia.org/wiki/Mount_Takamagahara",
    ...
    {
      "title": "Kyu Sakamoto",
      "source": "https://en.wikipedia.org/wiki/Kyu_Sakamoto",
      "description": "Japanese singer and actor (1941–1985)"
    }
  ],
  "coolFacts": [
    "August 12 places the reader in 1985, inside a music and broadcast culture story with consequences beyond the date itself.",
    "Japan Air Lines Flight 123 crashed into Mount Takamagahara in Gunma Prefecture, killing 520 of 524 people on board, including singer Kyu Sakamoto, in the world's worst single-aircraft aviation disaster.",
    "The central source trail begins with Japan Air Lines Flight 123.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Japan Air Lines Flight 123",
      "href": "https://commons.wikimedia.org/w/index.php?search=Japan%20Air%20Lines%20Flight%20123%201985&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Japan Air Lines Flight 123",
      "href": "https://www.si.edu/search?edan_q=Japan%20Air%20Lines%20Flight%20123%201985",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Japan Air Lines Flight 123",
      "href": "https://archive.org/search?query=Japan%20Air%20Lines%20Flight%20123%201985",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Japan Air Lines Flight 123",
      "href": "https://www.britannica.com/search?query=Japan%20Air%20Lines%20Flight%20123",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Japan Air Lines Flight 123",
      "href": "https://www.nytimes.com/search?query=Japan%20Air%20Lines%20Flight%20123%201985",
  ...
  "article": [
    ...
    {
      "text": "August 12, 1985, is not just a date label for Japan Air Lines Flight 123. It is the point where a larger music and broadcast culture story becomes visible enough to study. Japan Air Lines Flight 123 crashed into Mount Takamagahara in Gunma Prefecture, killing 520 of 524 people on board, including singer Kyu Sakamoto, in the world's worst single-aircraft aviation disaster. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Japan Air Lines Flight 123 matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 1985 aviation accident in Japan. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 12, 1985, Japan Air Lines Flight 123 crashed into Mount Takamagahara in Gunma Prefecture, killing 520 of 524 people on board, including singer Kyu Sakamoto, in the world's worst single-aircraft aviation disaster. Why it mattered: Japan Air Lines Flight 123 matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies Japan Air Lines Flight 123 as 1985 aviation accident in Japan. Related subjects include Japan Air Lines Flight 123 (1985 aviation accident in Japan), Mount Takamagahara (Mountain in Japan), Gunma Prefecture (Prefecture of Japan), Kyu Sakamoto (Japanese singer and actor... The related trail points to Japan Air Lines Flight 123, Mount Takamagahara, Gunma Prefecture, Kyu Sakamoto, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Japan Air Lines Flight 123 into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Japan Air Lines Flight 123 is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-12");
