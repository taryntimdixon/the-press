/* Detail payload for 03-01. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-01"] = {
  "date": "03-01",
  "displayDate": "March 1",
  "year": 1973,
  "title": "Pink Floyd",
  "topic": "Pink Floyd",
  "headline": "Pink Floyd's critically acclaimed album The Dark Side of the Moon was released.",
  ...
  "sourceLabel": "Wikipedia: Pink Floyd",
  "sourceDescription": "English rock band",
  "visual": "music",
  "palette": "stage",
  "dek": "Pink Floyd's critically acclaimed album The Dark Side of the Moon was released. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 1"
  ...
  "coolFacts": [
    "March 1 places the reader in 1973, inside a music and broadcast culture story with consequences beyond the date itself.",
    "Pink Floyd's critically acclaimed album The Dark Side of the Moon was released.",
    "The central source trail begins with Pink Floyd.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Pink Floyd",
      "href": "https://commons.wikimedia.org/w/index.php?search=Pink%20Floyd%201973&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Pink Floyd",
      "href": "https://www.si.edu/search?edan_q=Pink%20Floyd%201973",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Pink Floyd",
      "href": "https://archive.org/search?query=Pink%20Floyd%201973",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Pink Floyd",
      "href": "https://www.britannica.com/search?query=Pink%20Floyd",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Pink Floyd",
      "href": "https://www.nytimes.com/search?query=Pink%20Floyd%201973",
  ...
  "article": [
    ...
    {
      "text": "March 1, 1973, is not just a date label for Pink Floyd. It is the point where a larger music and broadcast culture story becomes visible enough to study. Pink Floyd's critically acclaimed album The Dark Side of the Moon was released. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Pink Floyd's critically acclaimed album The Dark Side of the Moon was released. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Pink Floyd matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 1, 1973, Pink Floyd's critically acclaimed album The Dark Side of the Moon was released. Why it mattered: Pink Floyd matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies Pink Floyd as english rock band. Related subjects include Pink Floyd (English rock band), The Dark Side of the Moon (1973 studio album by Pink Floyd). The lasting consequence was cultural memory: a sound, performance, release, or audience moment became... The related trail points to Pink Floyd, The Dark Side of the Moon, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Pink Floyd into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Pink Floyd is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Pink Floyd, the detail work starts with the nouns inside the event itself: Pink Floyd's critically acclaimed album The Dark Side of the Moon was released. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-01");
