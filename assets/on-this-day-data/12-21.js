/* Detail payload for 12-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-21"] = {
  "date": "12-21",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 21"
  ...
  "coolFacts": [
    "December 21 places the reader in 1968, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Kennedy%20Space%20Center%201968&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://www.nasa.gov/search/?search=Kennedy%20Space%20Center%201968",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Kennedy%20Space%20Center%201968",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Kennedy%20Space%20Center%201968",
  ...
  "article": [
    ...
    {
      "text": "December 21, 1968, is not just a date label for Kennedy Space Center. It is the point where a larger space exploration story becomes visible enough to study. Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became the first humans to visit another celestial body. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For Kennedy Space Center, the detail work starts with the nouns inside the event itself: Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became the first humans to visit another celestial body. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of December 21 is easy: Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became the first humans to visit another celestial body. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-21");
