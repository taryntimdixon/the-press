...
window.PRESS_ON_THIS_DAY_DETAIL["12-21"] = {
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became the first humans to visit another celestial body. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 21"
  ...
  "article": [
    ...
    {
      "text": "The short version of December 21 is easy: Apollo 8 launched from Kennedy Space Center in Florida on a trajectory to the Moon; its crew became the first humans to visit another celestial body. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
