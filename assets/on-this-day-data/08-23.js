/* Detail payload for 08-23. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-23"] = {
  "date": "08-23",
  "displayDate": "August 23",
  "year": 1991,
  "title": "World Wide Web",
  "topic": "World Wide Web",
  "headline": "The World Wide Web was opened to the public.",
  "text": "The World Wide Web was opened to the public.",
  "source": "https://en.wikipedia.org/wiki/World_Wide_Web",
  "sourceLabel": "Wikipedia: World Wide Web",
  "sourceDescription": "Linked hypertext system on the Internet",
  "visual": "tech",
  "palette": "laboratory",
  "dek": "The World Wide Web was opened to the public. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 23"
  ...
  "related": [
    {
      "title": "World Wide Web",
      "source": "https://en.wikipedia.org/wiki/World_Wide_Web",
      "description": "Linked hypertext system on the Internet"
    }
  ],
  "coolFacts": [
    "August 23 places the reader in 1991, inside a technology story with consequences beyond the date itself.",
    "The World Wide Web was opened to the public.",
    "The central source trail begins with World Wide Web.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: World Wide Web",
      "href": "https://commons.wikimedia.org/w/index.php?search=World%20Wide%20Web%201991&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: World Wide Web",
      "href": "https://www.si.edu/search?edan_q=World%20Wide%20Web%201991",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: World Wide Web",
      "href": "https://archive.org/search?query=World%20Wide%20Web%201991",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: World Wide Web",
      "href": "https://www.britannica.com/search?query=World%20Wide%20Web",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: World Wide Web",
      "href": "https://www.nytimes.com/search?query=World%20Wide%20Web%201991",
  ...
  "article": [
    ...
    {
      "text": "August 23, 1991, is not just a date label for World Wide Web. It is the point where a larger technology story becomes visible enough to study. The World Wide Web was opened to the public. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. World Wide Web matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as linked hypertext system on the Internet. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 23, 1991, the World Wide Web was opened to the public. Why it mattered: World Wide Web opened a public doorway into a larger change, and it changed how people used machines, networks, media, or information in. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies World Wide Web as linked hypertext system on the Internet. Related subjects include World Wide Web (Linked hypertext system on the Internet). The lasting consequence was a faster information world: new tools changed how messages, images, money, work, or culture... The related trail points to World Wide Web, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten World Wide Web into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. World Wide Web is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-23");
