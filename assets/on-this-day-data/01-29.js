/* Detail payload for 01-29. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-29"] = {
  "date": "01-29",
  ...
  "sourceDescription": "Highest judiciary body in Egypt",
  "visual": "civic",
  "palette": "civic",
  "dek": "The Supreme Constitutional Court of Egypt ruled that people who did not adhere to one of the three... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 29"
    ...
    {
      "label": "Main event",
      "value": "Supreme Constitutional Court (Egypt)"
    },
    {
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Religion_in_Egypt",
      "description": ""
    },
    {
      "title": "Egyptian identification card controversy",
      "source": "https://en.wikipedia.org/wiki/Egyptian_identification_card_controversy",
      "description": "Egyptian ID card dispute"
    },
    {
      "title": "Identity document",
      "source": "https://en.wikipedia.org/wiki/Identity_document",
      "description": "Document used to identify a person"
    }
  ],
  "coolFacts": [
    "January 29 places the reader in 2009, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Supreme Constitutional Court (Egypt).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Supreme Constitutional Court (Egypt)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Supreme%20Constitutional%20Court%20(Egypt)%202009&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Supreme Constitutional Court (Egypt)",
      "href": "https://catalog.archives.gov/search?q=Supreme%20Constitutional%20Court%20(Egypt)%202009",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Supreme Constitutional Court (Egypt)",
      "href": "https://archive.org/search?query=Supreme%20Constitutional%20Court%20(Egypt)%202009",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Supreme Constitutional Court (Egypt)",
      "href": "https://www.britannica.com/search?query=Supreme%20Constitutional%20Court%20(Egypt)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Supreme Constitutional Court (Egypt)",
      "href": "https://www.nytimes.com/search?query=Supreme%20Constitutional%20Court%20(Egypt)%202009",
  ...
  "article": [
    ...
    {
      "text": "January 29, 2009, is not just a date label for Supreme Constitutional Court (Egypt). It is the point where a larger government and civic power story becomes visible enough to study. The Supreme Constitutional Court of Egypt ruled that people who did not adhere to one of the three government-recognised religions were also eligible to receive government identity documents. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Supreme Constitutional Court of Egypt ruled that people who did not adhere to one of the three... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On January 29, 2009, the Supreme Constitutional Court of Egypt ruled that people who did not adhere to one of the three government-recognised religions were also eligible to receive government identity documents. Why it mattered: Supreme Constitutional Court (Egypt) turned an argument into a formal rule, and it changed how an institution, law, government, treaty. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Supreme Constitutional Court (Egypt) as highest judiciary body in Egypt. Related subjects include Supreme Constitutional Court (Egypt) (Highest judiciary body in Egypt), Religion in Egypt, Egyptian identification card controversy (Egyptian ID card dispute), Identity document (Document used to identify a... The related trail points to Supreme Constitutional Court (Egypt), Religion in Egypt, Egyptian identification card controversy, Identity document, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Supreme Constitutional Court (Egypt) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Supreme Constitutional Court (Egypt) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Supreme Constitutional Court (Egypt), the detail work starts with the nouns inside the event itself: The Supreme Constitutional Court of Egypt ruled that people who did not adhere to one of the three government-recognised religions were also eligible to receive government identity documents. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-29");
