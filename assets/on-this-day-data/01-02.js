/* Detail payload for 01-02. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-02"] = {
  "date": "01-02",
  ...
  "sourceDescription": "Soviet spacecraft",
  "visual": "space",
  "palette": "lunar",
  "dek": "The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 2"
    ...
    {
      "label": "Source trail",
      "value": "Soviet spacecraft"
    }
  ],
  "summary": [
    "January 2, 1959, is not just a date label for Luna 1. It is the point where a larger space exploration story becomes visible enough to study. The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a Vostok rocket from the Baikonur Cosmodrome. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Luna 1 belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1875,
  "related": [
    {
      "title": "Luna 1",
      "source": "https://en.wikipedia.org/wiki/Luna_1",
      "description": "Soviet spacecraft"
    },
    {
      "title": "Vostok (rocket family)",
      "source": "https://en.wikipedia.org/wiki/Vostok_(rocket_family)",
      "description": "Series of six manned and unmanned Soviet orbiting spacecraft"
    },
    {
      "title": "Baikonur Cosmodrome",
      "source": "https://en.wikipedia.org/wiki/Baikonur_Cosmodrome",
      "description": "Spaceport in Kazakhstan leased to Russia"
    }
  ],
  "coolFacts": [
    "January 2 places the reader in 1959, inside a space exploration story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Luna 1.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Luna 1",
      "href": "https://commons.wikimedia.org/w/index.php?search=Luna%201%201959&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Luna 1",
      "href": "https://www.nasa.gov/search/?search=Luna%201%201959",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Luna 1",
      "href": "https://archive.org/search?query=Luna%201%201959",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Luna 1",
      "href": "https://www.britannica.com/search?query=Luna%201",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Luna 1",
      "href": "https://www.nytimes.com/search?query=Luna%201%201959",
  ...
  "article": [
    ...
    {
      "text": "January 2, 1959, is not just a date label for Luna 1. It is the point where a larger space exploration story becomes visible enough to study. The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a Vostok rocket from the Baikonur Cosmodrome. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On January 2, 1959, the Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a Vostok rocket from the Baikonur Cosmodrome. Why it mattered: Luna 1 marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and... The source record identifies Luna 1 as soviet spacecraft. Related subjects include Luna 1 (Soviet spacecraft), Vostok (rocket family) (Series of six manned and unmanned Soviet orbiting spacecraft), Baikonur Cosmodrome (Spaceport in Kazakhstan leased to Russia). The lasting consequence was a larger map of... The related trail points to Luna 1, Vostok (rocket family), Baikonur Cosmodrome, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Luna 1 is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Luna 1, the detail work starts with the nouns inside the event itself: The Soviet Luna 1, the first spacecraft to reach the vicinity of the Moon, was launched by a Vostok rocket from the Baikonur Cosmodrome. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-02");
