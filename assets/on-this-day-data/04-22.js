...
window.PRESS_ON_THIS_DAY_DETAIL["04-22"] = {
  ...
  "dek": "American climate activist Wynn Bruce set himself on fire outside the United States Supreme Court Building in an... The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 22"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with United States Supreme Court Building.",
  ...
  "article": [
    ...
    {
      "text": "The short version of April 22 is easy: American climate activist Wynn Bruce set himself on fire outside the United States Supreme Court Building in an apparent protest against the climate crisis. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
