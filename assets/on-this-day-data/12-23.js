...
window.PRESS_ON_THIS_DAY_DETAIL["12-23"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Jane Austen.",
  ...
  "article": [
    ...
    {
      "text": "The short version of December 23 is easy: Jane Austen's novel Emma was first published, the last novel released during her lifetime. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
