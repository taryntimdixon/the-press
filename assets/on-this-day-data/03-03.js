/* Detail payload for 03-03. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-03"] = {
  "date": "03-03",
  "displayDate": "March 3",
  "year": 1972,
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "1972 studio album by Jethro Tull"
    },
    {
      "title": "Concept album",
      "source": "https://en.wikipedia.org/wiki/Concept_album",
      "description": "Album that tells a self-contained story"
    },
    {
      "title": "Epic poetry",
      "source": "https://en.wikipedia.org/wiki/Epic_poetry",
      "description": "Lengthy poem dealing with supernatural forces"
    }
  ],
  "coolFacts": [
    "March 3 places the reader in 1972, inside a music and broadcast culture story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Jethro Tull (band).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Jethro Tull (band)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Jethro%20Tull%20(band)%201972&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Jethro Tull (band)",
      "href": "https://www.si.edu/search?edan_q=Jethro%20Tull%20(band)%201972",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Jethro Tull (band)",
      "href": "https://archive.org/search?query=Jethro%20Tull%20(band)%201972",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Jethro Tull (band)",
      "href": "https://www.britannica.com/search?query=Jethro%20Tull%20(band)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Jethro Tull (band)",
      "href": "https://www.nytimes.com/search?query=Jethro%20Tull%20(band)%201972",
  ...
  "article": [
    ...
    {
      "text": "March 3, 1972, is not just a date label for Jethro Tull (band). It is the point where a larger music and broadcast culture story becomes visible enough to study. The British rock band Jethro Tull released Thick as a Brick, a parody concept album allegedly adapted from an eight-year-old boy's epic poem. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Jethro Tull (band) matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as british rock band. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Jethro Tull (band) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "For Jethro Tull (band), the detail work starts with the nouns inside the event itself: The British rock band Jethro Tull released Thick as a Brick, a parody concept album allegedly adapted from an eight-year-old boy's epic poem. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-03");
