/* Detail payload for 12-09. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-09"] = {
  "date": "12-09",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "American incarcerated activist (born 1954)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Mumia Abu-Jamal",
      "source": "https://en.wikipedia.org/wiki/Mumia_Abu-Jamal",
      "description": "American incarcerated activist (born 1954)"
    },
    {
      "title": "Commonwealth v. Abu-Jamal",
      "source": "https://en.wikipedia.org/wiki/Commonwealth_v._Abu-Jamal",
      "description": "1982 murder trial in Pennsylvania"
    }
  ],
  "coolFacts": [
    "December 9 places the reader in 1981, inside a crime and accountability story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Mumia Abu-Jamal.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Mumia Abu-Jamal",
      "href": "https://commons.wikimedia.org/w/index.php?search=Mumia%20Abu-Jamal%201981&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Mumia Abu-Jamal",
      "href": "https://catalog.archives.gov/search?q=Mumia%20Abu-Jamal%201981",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Mumia Abu-Jamal",
      "href": "https://archive.org/search?query=Mumia%20Abu-Jamal%201981",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Mumia Abu-Jamal",
      "href": "https://www.britannica.com/search?query=Mumia%20Abu-Jamal",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Mumia Abu-Jamal",
      "href": "https://www.nytimes.com/search?query=Mumia%20Abu-Jamal%201981",
  ...
  "article": [
    ...
    {
      "text": "For Mumia Abu-Jamal, the detail work starts with the nouns inside the event itself: Mumia Abu-Jamal was arrested for the murder of Philadelphia police officer Daniel Faulkner; his subsequent conviction and death sentence generated controversy in the United States. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-09");
