/* Detail payload for 10-29. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-29"] = {
  "date": "10-29",
  "displayDate": "October 29",
  "year": 1991,
  "title": "Galileo (spacecraft)",
  "topic": "Galileo (spacecraft)",
  "headline": "Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra.",
  ...
  "sourceDescription": "First NASA mission to orbit Jupiter (1989–2003)",
  "visual": "space",
  "palette": "lunar",
  "dek": "Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 29"
    ...
    {
      "label": "Source trail",
      "value": "First NASA mission to orbit Jupiter (1989–2003)"
    }
  ],
  "summary": [
    "October 29, 1991, is not just a date label for Galileo (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Galileo (spacecraft) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1852,
  "related": [
    {
      "title": "Galileo (spacecraft)",
      "source": "https://en.wikipedia.org/wiki/Galileo_(spacecraft)",
      "description": "First NASA mission to orbit Jupiter (1989–2003)"
    },
    {
      "title": "Asteroid",
      "source": "https://en.wikipedia.org/wiki/Asteroid",
      "description": "Minor planet found within the inner Solar System"
    },
    {
      "title": "951 Gaspra",
      "source": "https://en.wikipedia.org/wiki/951_Gaspra",
      "description": "S-type asteroid in the inner asteroid belt with stony mineralogical composition"
    }
  ],
  "coolFacts": [
    "October 29 places the reader in 1991, inside a space exploration story with consequences beyond the date itself.",
    "Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra.",
    "The central source trail begins with Galileo (spacecraft).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Galileo (spacecraft)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Galileo%20(spacecraft)%201991&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Galileo (spacecraft)",
      "href": "https://www.nasa.gov/search/?search=Galileo%20(spacecraft)%201991",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Galileo (spacecraft)",
      "href": "https://archive.org/search?query=Galileo%20(spacecraft)%201991",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Galileo (spacecraft)",
      "href": "https://www.britannica.com/search?query=Galileo%20(spacecraft)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Galileo (spacecraft)",
      "href": "https://www.nytimes.com/search?query=Galileo%20(spacecraft)%201991",
  ...
  "article": [
    ...
    {
      "text": "October 29, 1991, is not just a date label for Galileo (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 29, 1991, Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. Why it mattered: Galileo (spacecraft) marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public... The source record identifies Galileo (spacecraft) as the first NASA mission to orbit Jupiter (1989–2003). Related subjects include Galileo (spacecraft) (First NASA mission to orbit Jupiter (1989–2003)), Asteroid (Minor planet found within the inner Solar System), 951 Gaspra (S-type asteroid in the inner asteroid... The related trail points to Galileo (spacecraft), Asteroid, 951 Gaspra, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Galileo (spacecraft) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Galileo (spacecraft) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Galileo (spacecraft), the detail work starts with the nouns inside the event itself: Galileo became the first spacecraft to visit an asteroid when it made a flyby of 951 Gaspra. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-29");
