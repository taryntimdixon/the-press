/* Detail payload for 11-30. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-30"] = {
  "date": "11-30",
  ...
  "sourceDescription": "U.S. state",
  "visual": "sports",
  "palette": "public-square",
  "dek": "A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 30"
  ...
  "summary": [
    "November 30, 1935, is not just a date label for Texas. It is the point where a larger history story becomes visible enough to study. A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      ...
      "description": "American college football game"
    },
    {
      "title": "SMU Mustangs football",
      "source": "https://en.wikipedia.org/wiki/SMU_Mustangs_football",
      "description": "SMU college football team"
    },
    {
      "title": "TCU Horned Frogs football",
      "source": "https://en.wikipedia.org/wiki/TCU_Horned_Frogs_football",
      "description": "American football team of Texas Christian University"
    },
    {
      "title": "Texas",
      "source": "https://en.wikipedia.org/wiki/Texas",
  ...
  "coolFacts": [
    "November 30 places the reader in 1935, inside a history story with consequences beyond the date itself.",
    ...
    "A useful starting source is Texas.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Texas",
      "href": "https://commons.wikimedia.org/w/index.php?search=Texas%201935&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Texas",
      "href": "https://www.si.edu/search?edan_q=Texas%201935",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Texas",
      "href": "https://archive.org/search?query=Texas%201935",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Texas",
      "href": "https://www.britannica.com/search?query=Texas",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Texas",
      "href": "https://www.nytimes.com/search?query=Texas%201935",
  ...
  "article": [
    ...
    {
      "text": "November 30, 1935, is not just a date label for Texas. It is the point where a larger history story becomes visible enough to study. A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Texas matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as u.S. state. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 30, 1935, a college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. Why it mattered: Texas marked a first, and it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own. The source record identifies Texas as u.S. state. Related subjects include 1935 SMU vs. TCU football game (American college football game), SMU Mustangs football (SMU college football team), TCU Horned Frogs football (American football team of Texas Christian University), Texas (U.S. state). The lasting. The related trail points to 1935 SMU vs. TCU football game, SMU Mustangs football, TCU Horned Frogs football, Texas, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Texas is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The short version of November 30 is easy: A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Texas is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-30");
