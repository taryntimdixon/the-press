...
window.PRESS_ON_THIS_DAY_DETAIL["11-30"] = {
  ...
  "dek": "A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in... The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 30"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Texas.",
  ...
  "article": [
    ...
    {
      "text": "A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The short version of November 30 is easy: A college football game between the SMU Mustangs and the TCU Horned Frogs became the first game in Texas to be broadcast nationally on radio. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
