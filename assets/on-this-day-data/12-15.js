/* Detail payload for 12-15. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-15"] = {
  "date": "12-15",
  ...
  "facts": [
    ...
    {
      "label": "Main event",
      "value": "Citizenship Amendment Act protests"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "2019–2020 protests in India"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Citizenship Amendment Act protests",
      "source": "https://en.wikipedia.org/wiki/Citizenship_Amendment_Act_protests",
      "description": "2019–2020 protests in India"
    },
    {
      "title": "Shaheen Bagh protest",
      "source": "https://en.wikipedia.org/wiki/Shaheen_Bagh_protest",
      "description": "2019–20 sit-in protest in Delhi, India"
    },
    {
      "title": "Delhi",
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Citizenship_(Amendment)_Act%2C_2019",
      "description": "Law regarding citizenship rights for migrants to India"
    }
  ],
  "coolFacts": [
    "December 15 places the reader in 2019, inside a rights and public power story with consequences beyond the date itself.",
    "Citizenship Amendment Act protests: 10 to 15 local women blockaded a major road in Delhi, India, to protest the exclusion of Muslims from the amended Citizenship Act.",
    "A useful starting source is Citizenship Amendment Act protests.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Citizenship Amendment Act protests",
      "href": "https://commons.wikimedia.org/w/index.php?search=Citizenship%20Amendment%20Act%20protests%202019&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Citizenship Amendment Act protests",
      "href": "https://catalog.archives.gov/search?q=Citizenship%20Amendment%20Act%20protests%202019",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Citizenship Amendment Act protests",
      "href": "https://archive.org/search?query=Citizenship%20Amendment%20Act%20protests%202019",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Citizenship Amendment Act protests",
      "href": "https://www.britannica.com/search?query=Citizenship%20Amendment%20Act%20protests",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Citizenship Amendment Act protests",
      "href": "https://www.nytimes.com/search?query=Citizenship%20Amendment%20Act%20protests%202019",
  ...
  "article": [
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who could claim safety, dignity, citizenship, visibility, or equal treatment. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Citizenship Amendment Act protests matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 2019–2020 protests in India. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Citizenship Amendment Act protests into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Citizenship Amendment Act protests is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Citizenship Amendment Act protests, the detail work starts with the nouns inside the event itself: Citizenship Amendment Act protests: 10 to 15 local women blockaded a major road in Delhi, India, to protest the exclusion of Muslims from the amended Citizenship Act. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of December 15 is easy: Citizenship Amendment Act protests: 10 to 15 local women blockaded a major road in Delhi, India, to protest the exclusion of Muslims from the amended Citizenship Act. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Citizenship Amendment Act protests is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-15");
