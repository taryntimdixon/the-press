...
window.PRESS_ON_THIS_DAY_DETAIL["05-13"] = {
  ...
  "visual": "music",
  "palette": "stage",
  "dek": "Eurovision Song Contest: Portugal won the contest for the first time, with the song \"Amar pelos dois,\" performed by Salvador Sobral. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 13"
  ...
  "coolFacts": [
    ...
    "A useful starting source is Amar pelos dois.",
  ...
  "article": [
    ...
    {
      "text": "The short version of May 13 is easy: Eurovision Song Contest: Portugal won the contest for the first time, with the song \"Amar pelos dois,\" performed by Salvador Sobral. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
