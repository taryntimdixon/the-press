/* Detail payload for 08-24. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-24"] = {
  "date": "08-24",
  ...
  "related": [
    ...
    {
      "title": "Aurora, Indiana",
      "source": "https://en.wikipedia.org/wiki/Aurora%2C_Indiana",
      "description": "City in Indiana, United States"
    },
    {
      "title": "Indigenous peoples of the Americas",
      "source": "https://en.wikipedia.org/wiki/Indigenous_peoples_of_the_Americas",
      "description": ""
    },
    {
      "title": "Joseph Brant",
      "source": "https://en.wikipedia.org/wiki/Joseph_Brant",
      "description": "Mohawk leader (1742–1807)"
    }
  ],
  "coolFacts": [
    "August 24 places the reader in 1781, inside a crime and accountability story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=American%20Revolutionary%20War%201781&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=American%20Revolutionary%20War%201781",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=American%20Revolutionary%20War%201781",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=American%20Revolutionary%20War%201781",
  ...
  "article": [
    ...
    {
      "text": "August 24, 1781, is not just a date label for American Revolutionary War. It is the point where a larger crime and accountability story becomes visible enough to study. American Revolutionary War: Near present-day Aurora, Indiana, American Indians led by Joseph Brant killed or captured all members of a Pennsylvania militia. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed public trust, institutions, law enforcement, media attention, or constitutional pressure. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. American Revolutionary War matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For American Revolutionary War, the detail work starts with the nouns inside the event itself: American Revolutionary War: Near present-day Aurora, Indiana, American Indians led by Joseph Brant killed or captured all members of a Pennsylvania militia. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of August 24 is easy: American Revolutionary War: Near present-day Aurora, Indiana, American Indians led by Joseph Brant killed or captured all members of a Pennsylvania militia. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-24");
