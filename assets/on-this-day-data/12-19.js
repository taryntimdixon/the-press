/* Detail payload for 12-19. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-19"] = {
  "date": "12-19",
  ...
  "sourceDescription": "1997 film by James Cameron",
  "visual": "culture",
  "palette": "stage",
  "dek": "Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released... The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 19"
    ...
    {
      "label": "Source trail",
      "value": "1997 film by James Cameron"
    }
  ],
  "summary": [
    "December 19, 1997, is not just a date label for Titanic (1997 film). It is the point where a larger culture story becomes visible enough to study. Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released in the United States. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a theater, shop, studio, page, screen, or public crowd where an idea moved from private work into mass imagination. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Titanic (1997 film) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1884,
  "related": [
    {
  ...
  "coolFacts": [
    "December 19 places the reader in 1997, inside a culture story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Titanic (1997 film).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Titanic (1997 film)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Titanic%20(1997%20film)%201997&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Titanic (1997 film)",
      "href": "https://www.si.edu/search?edan_q=Titanic%20(1997%20film)%201997",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Titanic (1997 film)",
      "href": "https://archive.org/search?query=Titanic%20(1997%20film)%201997",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Titanic (1997 film)",
      "href": "https://www.britannica.com/search?query=Titanic%20(1997%20film)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Titanic (1997 film)",
      "href": "https://www.nytimes.com/search?query=Titanic%20(1997%20film)%201997",
  ...
  "article": [
    ...
    {
      "text": "December 19, 1997, is not just a date label for Titanic (1997 film). It is the point where a larger culture story becomes visible enough to study. Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released in the United States. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it altered taste, language, fandom, entertainment, memory, or the way audiences recognized themselves. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Titanic (1997 film) matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 1997 film by James Cameron. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 19, 1997, Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released in the United States. Why it mattered: Titanic (1997 film) matters because it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Titanic (1997 film) as 1997 film by James Cameron. Related subjects include Titanic (1997 film) (1997 film by James Cameron), List of highest-grossing films. The lasting consequence was shared imagination: books, films, broadcasts, places, or performances changed what audiences expected... The related trail points to Titanic (1997 film), List of highest-grossing films, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Titanic (1997 film) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Titanic (1997 film) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Titanic (1997 film), the detail work starts with the nouns inside the event itself: Titanic, the fourth-highest-grossing film of all time with a worldwide total of more than US$2.2 billion, was released in the United States. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-19");
