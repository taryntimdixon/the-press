/* Detail payload for 02-08. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-08"] = {
  "date": "02-08",
  ...
  "sourceDescription": "Vice President of the United States from 1837 to 1841",
  "visual": "civic",
  "palette": "civic",
  "dek": "Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "February 8"
    ...
    {
      "label": "Source trail",
      "value": "Vice President of the United States from 1837 to 1841"
    }
  ],
  "summary": [
    "February 8, 1837, is not just a date label for Richard Mentor Johnson. It is the point where a larger government and civic power story becomes visible enough to study. Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by the Senate. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a formal place where documents, offices, ceremonies, laws, and public legitimacy became the center of the story. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Richard Mentor Johnson belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1881,
  "related": [
    {
      "title": "Richard Mentor Johnson",
      "source": "https://en.wikipedia.org/wiki/Richard_Mentor_Johnson",
      "description": "Vice President of the United States from 1837 to 1841"
    },
    {
      "title": "Vice President of the United States",
      "source": "https://en.wikipedia.org/wiki/Vice_President_of_the_United_States",
      "description": "Second-highest constitutional office in the United States"
    },
    {
      "title": "United States Senate",
      "source": "https://en.wikipedia.org/wiki/United_States_Senate",
      "description": "Upper house of the US Congress"
    }
  ],
  "coolFacts": [
    "February 8 places the reader in 1837, inside a government and civic power story with consequences beyond the date itself.",
    "Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by the Senate.",
    "The central source trail begins with Richard Mentor Johnson.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Richard Mentor Johnson",
      "href": "https://commons.wikimedia.org/w/index.php?search=Richard%20Mentor%20Johnson%201837&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Richard Mentor Johnson",
      "href": "https://catalog.archives.gov/search?q=Richard%20Mentor%20Johnson%201837",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Richard Mentor Johnson",
      "href": "https://archive.org/search?query=Richard%20Mentor%20Johnson%201837",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Richard Mentor Johnson",
      "href": "https://www.britannica.com/search?query=Richard%20Mentor%20Johnson",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Richard Mentor Johnson",
      "href": "https://www.nytimes.com/search?query=Richard%20Mentor%20Johnson%201837",
  ...
  "article": [
    ...
    {
      "text": "February 8, 1837, is not just a date label for Richard Mentor Johnson. It is the point where a larger government and civic power story becomes visible enough to study. Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by the Senate. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On February 8, 1837, Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by the Senate. Why it mattered: Richard Mentor Johnson matters because it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Richard Mentor Johnson as vice President of the United States from 1837 to 1841. Related subjects include Richard Mentor Johnson (Vice President of the United States from 1837 to 1841), Vice President of the United States (Second-highest constitutional office in... The related trail points to Richard Mentor Johnson, Vice President of the United States, United States Senate, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Richard Mentor Johnson into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Richard Mentor Johnson is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Richard Mentor Johnson, the detail work starts with the nouns inside the event itself: Richard Mentor Johnson became the only person ever to be elected Vice President of the United States by the Senate. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-08");
