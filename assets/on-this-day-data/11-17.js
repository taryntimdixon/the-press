...
window.PRESS_ON_THIS_DAY_DETAIL["11-17"] = {
  ...
  "dek": "NBC controversially cut away from an American football game between the Oakland Raiders and New York Jets to... The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 17"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with NBC.",
  ...
  "article": [
    ...
    {
      "text": "NBC controversially cut away from an American football game between the Oakland Raiders and New York Jets to... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
