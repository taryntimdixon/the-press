/* Detail payload for 12-24. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-24"] = {
  "date": "12-24",
  "displayDate": "December 24",
  "year": 1968,
  "title": "Jim Lovell",
  "topic": "Jim Lovell",
  "headline": "Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon.",
  ...
  "sourceDescription": "American astronaut (1928–2025)",
  "visual": "space",
  "palette": "lunar",
  "dek": "Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 24"
    ...
    {
      "label": "Source trail",
      "value": "American astronaut (1928–2025)"
    }
  ],
  "summary": [
    "December 24, 1968, is not just a date label for Jim Lovell. It is the point where a larger space exploration story becomes visible enough to study. Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Jim Lovell belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1850,
  "related": [
    {
      "title": "Jim Lovell",
      "source": "https://en.wikipedia.org/wiki/Jim_Lovell",
      "description": "American astronaut (1928–2025)"
    },
    {
      "title": "Apollo 8",
    ...
    {
      "title": "Earthrise",
      "source": "https://en.wikipedia.org/wiki/Earthrise",
      "description": "1968 photograph of Earth from lunar orbit"
    }
  ],
  "coolFacts": [
    "December 24 places the reader in 1968, inside a space exploration story with consequences beyond the date itself.",
    "Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon.",
    "The central source trail begins with Jim Lovell.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Jim Lovell",
      "href": "https://commons.wikimedia.org/w/index.php?search=Jim%20Lovell%201968&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Jim Lovell",
      "href": "https://www.nasa.gov/search/?search=Jim%20Lovell%201968",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Jim Lovell",
      "href": "https://archive.org/search?query=Jim%20Lovell%201968",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Jim Lovell",
      "href": "https://www.britannica.com/search?query=Jim%20Lovell",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Jim Lovell",
      "href": "https://www.nytimes.com/search?query=Jim%20Lovell%201968",
  ...
  "article": [
    ...
    {
      "text": "December 24, 1968, is not just a date label for Jim Lovell. It is the point where a larger space exploration story becomes visible enough to study. Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 24, 1968, Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. Why it mattered: Jim Lovell marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and... The source record identifies Jim Lovell as american astronaut (1928–2025). Related subjects include Jim Lovell (American astronaut (1928–2025)), Apollo 8 (First crewed space mission to orbit the Moon), Human spaceflight (Spaceflight with a crew or passengers), Earthrise (1968 photograph of Earth from lunar orbit).... The related trail points to Jim Lovell, Apollo 8, Human spaceflight, Earthrise, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Jim Lovell into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Jim Lovell is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Jim Lovell, the detail work starts with the nouns inside the event itself: Piloted by Jim Lovell, Apollo 8 became the first human spaceflight to reach and orbit the Moon. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-24");
