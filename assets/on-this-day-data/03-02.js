/* Detail payload for 03-02. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-02"] = {
  "date": "03-02",
  "displayDate": "March 2",
  "year": 1962,
  ...
  "sourceDescription": "American basketball player (1936–1999)",
  "visual": "sports",
  "palette": "public-square",
  "dek": "Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 2"
    ...
    {
      "label": "Source trail",
      "value": "American basketball player (1936–1999)"
    }
  ],
  "summary": [
    "March 2, 1962, is not just a date label for Wilt Chamberlain. It is the point where a larger history story becomes visible enough to study. Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Golden_State_Warriors",
      "description": "National Basketball Association team in San Francisco, California"
    },
    {
      "title": "Wilt Chamberlain",
      "source": "https://en.wikipedia.org/wiki/Wilt_Chamberlain",
      "description": "American basketball player (1936–1999)"
    },
    {
      "title": "Wilt Chamberlain's 100-point game",
      "source": "https://en.wikipedia.org/wiki/Wilt_Chamberlain's_100-point_game",
      "description": "1962 NBA record-setting basketball game"
    },
    {
      "title": "New York Knicks",
      "source": "https://en.wikipedia.org/wiki/New_York_Knicks",
      "description": "National Basketball Association team in New York City"
    }
  ],
  "coolFacts": [
    "March 2 places the reader in 1962, inside a history story with consequences beyond the date itself.",
    ...
    "A useful starting source is Wilt Chamberlain.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Wilt Chamberlain",
      "href": "https://commons.wikimedia.org/w/index.php?search=Wilt%20Chamberlain%201962&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Wilt Chamberlain",
      "href": "https://www.si.edu/search?edan_q=Wilt%20Chamberlain%201962",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Wilt Chamberlain",
      "href": "https://archive.org/search?query=Wilt%20Chamberlain%201962",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Wilt Chamberlain",
      "href": "https://www.britannica.com/search?query=Wilt%20Chamberlain",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Wilt Chamberlain",
      "href": "https://www.nytimes.com/search?query=Wilt%20Chamberlain%201962",
  ...
  "article": [
    ...
    {
      "text": "Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Wilt Chamberlain matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american basketball player (1936–1999). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 2, 1962, Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. Why it mattered: Wilt Chamberlain matters because it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own limits. The source record identifies Wilt Chamberlain as american basketball player (1936–1999). Related subjects include Golden State Warriors (National Basketball Association team in San Francisco, California), Wilt Chamberlain (American basketball player (1936–1999)), Wilt Chamberlain's 100-point game (1962 NBA record-setting basketball game), New York Knicks (National. The related trail points to Golden State Warriors, Wilt Chamberlain, Wilt Chamberlain's 100-point game, New York Knicks, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Wilt Chamberlain, the detail work starts with the nouns inside the event itself: Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of March 2 is easy: Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Wilt Chamberlain is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-02");
