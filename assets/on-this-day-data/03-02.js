...
window.PRESS_ON_THIS_DAY_DETAIL["03-02"] = {
  ...
  "dek": "Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the... The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 2"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Wilt Chamberlain.",
  ...
  "article": [
    ...
    {
      "text": "The short version of March 2 is easy: Playing for the Philadelphia Warriors, American basketball player Wilt Chamberlain scored 100 points in a game against the New York Knicks, which remains an NBA record. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
