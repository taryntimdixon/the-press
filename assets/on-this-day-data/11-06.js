/* Detail payload for 11-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-06"] = {
  "date": "11-06",
  ...
  "sourceDescription": "Leader of the Oglala Lakota (1822–1909)",
  "visual": "civic",
  "palette": "civic",
  "dek": "Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 6"
    ...
    {
      "label": "Source trail",
      "value": "Leader of the Oglala Lakota (1822–1909)"
    }
  ],
  "summary": [
    "November 6, 1868, is not just a date label for Red Cloud. It is the point where a larger government and civic power story becomes visible enough to study. Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Red Cloud",
      "source": "https://en.wikipedia.org/wiki/Red_Cloud",
      "description": "Leader of the Oglala Lakota (1822–1909)"
    },
    {
      "title": "Oglala",
      "source": "https://en.wikipedia.org/wiki/Oglala",
      "description": "Traditional tribal grouping within the Lakota people"
    },
    {
      "title": "Treaty of Fort Laramie (1868)",
      "source": "https://en.wikipedia.org/wiki/Treaty_of_Fort_Laramie_(1868)",
      "description": "US-Sioux treaty ending Red Cloud's War"
    },
    {
      "title": "Red Cloud's War",
      "source": "https://en.wikipedia.org/wiki/Red_Cloud's_War",
      "description": "Part of the Sioux Wars"
    }
  ],
  "coolFacts": [
    "November 6 places the reader in 1868, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "A useful starting source is Red Cloud.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Red Cloud",
      "href": "https://commons.wikimedia.org/w/index.php?search=Red%20Cloud%201868&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Red Cloud",
      "href": "https://catalog.archives.gov/search?q=Red%20Cloud%201868",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Red Cloud",
      "href": "https://archive.org/search?query=Red%20Cloud%201868",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Red Cloud",
      "href": "https://www.britannica.com/search?query=Red%20Cloud",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Red Cloud",
      "href": "https://www.nytimes.com/search?query=Red%20Cloud%201868",
  ...
  "article": [
    ...
    {
      "text": "November 6, 1868, is not just a date label for Red Cloud. It is the point where a larger government and civic power story becomes visible enough to study. Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 6, 1868, Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. Why it mattered: Red Cloud turned an argument into a formal rule, and it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Red Cloud as leader of the Oglala Lakota (1822–1909). Related subjects include Red Cloud (Leader of the Oglala Lakota (1822–1909)), Oglala (Traditional tribal grouping within the Lakota people), Treaty of Fort Laramie (1868) (US-Sioux treaty ending Red Cloud's War), Red. The related trail points to Red Cloud, Oglala, Treaty of Fort Laramie (1868), Red Cloud's War, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Red Cloud into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Red Cloud is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Red Cloud, the detail work starts with the nouns inside the event itself: Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of November 6 is easy: Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Red Cloud is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-06");
