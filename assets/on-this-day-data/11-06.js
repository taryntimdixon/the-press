...
window.PRESS_ON_THIS_DAY_DETAIL["11-06"] = {
  ...
  "visual": "civic",
  "palette": "civic",
  "dek": "Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 6"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Red Cloud.",
  ...
  "article": [
    ...
    {
      "text": "The short version of November 6 is easy: Red Cloud, a Native American leader of the Oglala Lakota tribe, signed the Treaty of Fort Laramie, ending Red Cloud's War and establishing the Great Sioux Reservation. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
