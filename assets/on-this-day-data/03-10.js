/* Detail payload for 03-10. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-10"] = {
  "date": "03-10",
  "displayDate": "March 10",
  "year": 2006,
  "title": "Mars Reconnaissance Orbiter",
  "topic": "Mars Reconnaissance Orbiter",
  "headline": "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars.",
  "text": "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars.",
  "source": "https://en.wikipedia.org/wiki/Mars_Reconnaissance_Orbiter",
  "sourceLabel": "Wikipedia: Mars Reconnaissance Orbiter",
  "sourceDescription": "NASA spacecraft active since 2005",
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 10"
    ...
    {
      "label": "Source trail",
      "value": "NASA spacecraft active since 2005"
    }
  ],
  "summary": [
    "March 10, 2006, is not just a date label for Mars Reconnaissance Orbiter. It is the point where a larger space exploration story becomes visible enough to study. NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Mars Reconnaissance Orbiter belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1824,
  "related": [
    {
    ...
    },
    {
      "title": "Mars Reconnaissance Orbiter",
      "source": "https://en.wikipedia.org/wiki/Mars_Reconnaissance_Orbiter",
      "description": "NASA spacecraft active since 2005"
    },
    {
      "title": "Orbit insertion",
      "source": "https://en.wikipedia.org/wiki/Orbit_insertion",
      "description": "Spaceflight operation"
    }
  ],
  "coolFacts": [
    "March 10 places the reader in 2006, inside a space exploration story with consequences beyond the date itself.",
    "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars.",
    "The central source trail begins with Mars Reconnaissance Orbiter.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Mars Reconnaissance Orbiter",
      "href": "https://commons.wikimedia.org/w/index.php?search=Mars%20Reconnaissance%20Orbiter%202006&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Mars Reconnaissance Orbiter",
      "href": "https://www.nasa.gov/search/?search=Mars%20Reconnaissance%20Orbiter%202006",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Mars Reconnaissance Orbiter",
      "href": "https://archive.org/search?query=Mars%20Reconnaissance%20Orbiter%202006",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Mars Reconnaissance Orbiter",
      "href": "https://www.britannica.com/search?query=Mars%20Reconnaissance%20Orbiter",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Mars Reconnaissance Orbiter",
      "href": "https://www.nytimes.com/search?query=Mars%20Reconnaissance%20Orbiter%202006",
  ...
  "article": [
    ...
    {
      "text": "March 10, 2006, is not just a date label for Mars Reconnaissance Orbiter. It is the point where a larger space exploration story becomes visible enough to study. NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 10, 2006, NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. Why it mattered: Mars Reconnaissance Orbiter matters because it pushed space exploration into a new technical or symbolic frontier, testing machines. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public imagination... The source record identifies Mars Reconnaissance Orbiter as nASA spacecraft active since 2005. Related subjects include NASA (American space and aeronautics agency), Mars Reconnaissance Orbiter (NASA spacecraft active since 2005), Orbit insertion (Spaceflight operation). The lasting consequence was a larger map of what humans... The related trail points to NASA, Mars Reconnaissance Orbiter, Orbit insertion, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Mars Reconnaissance Orbiter into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "For Mars Reconnaissance Orbiter, the detail work starts with the nouns inside the event itself: NASA's Mars Reconnaissance Orbiter reached and entered orbit around Mars. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-10");
