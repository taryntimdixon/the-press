/* Detail payload for 12-11. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-11"] = {
  "date": "12-11",
  ...
  "visual": "crime",
  "palette": "dispatch",
  "dek": "The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. The deeper story is how this crime and accountability moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 11"
  ...
  "summary": [
    "December 11, 2006, is not just a date label for Mexican drug war. It is the point where a larger crime and accountability story becomes visible enough to study. The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Felipe_Calder%C3%B3n",
      "description": "President of Mexico from 2006 to 2012"
    },
    {
      "title": "Operation Michoacán",
      "source": "https://en.wikipedia.org/wiki/Operation_Michoac%C3%A1n",
      "description": "Anti-drug effort in Mexico"
    },
    {
      "title": "Federal Police (Mexico)",
      "source": "https://en.wikipedia.org/wiki/Federal_Police_(Mexico)",
      "description": "Former Mexican federal police"
    }
  ],
  "coolFacts": [
    "December 11 places the reader in 2006, inside a crime and accountability story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Mexican%20drug%20war%202006&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=Mexican%20drug%20war%202006",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Mexican drug war",
      "href": "https://archive.org/search?query=Mexican%20drug%20war%202006",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Mexican%20drug%20war%202006",
  ...
  "article": [
    ...
    {
      "text": "December 11, 2006, is not just a date label for Mexican drug war. It is the point where a larger crime and accountability story becomes visible enough to study. The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed public trust, institutions, law enforcement, media attention, or constitutional pressure. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Mexican drug war matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For Mexican drug war, the detail work starts with the nouns inside the event itself: The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of December 11 is easy: The first action in the Mexican drug war began as President Felipe Calderón ordered Mexican soldiers and Federal Police units into the state of Michoacán. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-11");
