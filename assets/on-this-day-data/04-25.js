/* Detail payload for 04-25. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-25"] = {
  "date": "04-25",
  "displayDate": "April 25",
  "year": 1983,
  "title": "The Jakarta Post",
  "topic": "The Jakarta Post",
  "headline": "The first issue of The Jakarta Post was published in Indonesia.",
  "text": "The first issue of The Jakarta Post was published in Indonesia.",
  "source": "https://en.wikipedia.org/wiki/The_Jakarta_Post",
  "sourceLabel": "Wikipedia: The Jakarta Post",
  "sourceDescription": "Indonesian daily English language newspaper",
  "visual": "culture",
  "palette": "stage",
  "dek": "The first issue of The Jakarta Post was published in Indonesia. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 25"
  ...
  "related": [
    {
      "title": "The Jakarta Post",
      "source": "https://en.wikipedia.org/wiki/The_Jakarta_Post",
      "description": "Indonesian daily English language newspaper"
    }
  ],
  "coolFacts": [
    "April 25 places the reader in 1983, inside a culture story with consequences beyond the date itself.",
    "The first issue of The Jakarta Post was published in Indonesia.",
    "The central source trail begins with The Jakarta Post.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: The Jakarta Post",
      "href": "https://commons.wikimedia.org/w/index.php?search=The%20Jakarta%20Post%201983&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: The Jakarta Post",
      "href": "https://www.si.edu/search?edan_q=The%20Jakarta%20Post%201983",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: The Jakarta Post",
      "href": "https://archive.org/search?query=The%20Jakarta%20Post%201983",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: The Jakarta Post",
      "href": "https://www.britannica.com/search?query=The%20Jakarta%20Post",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: The Jakarta Post",
      "href": "https://www.nytimes.com/search?query=The%20Jakarta%20Post%201983",
  ...
  "article": [
    ...
    {
      "text": "April 25, 1983, is not just a date label for The Jakarta Post. It is the point where a larger culture story becomes visible enough to study. The first issue of The Jakarta Post was published in Indonesia. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it altered taste, language, fandom, entertainment, memory, or the way audiences recognized themselves. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. The Jakarta Post matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as indonesian daily English language newspaper. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 25, 1983, the first issue of The Jakarta Post was published in Indonesia. Why it mattered: The Jakarta Post marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies The Jakarta Post as indonesian daily English language newspaper. Related subjects include The Jakarta Post (Indonesian daily English language newspaper). The lasting consequence was shared imagination: books, films, broadcasts, places, or performances changed what audiences expected next. The related trail points to The Jakarta Post, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten The Jakarta Post into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. The Jakarta Post is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-25");
