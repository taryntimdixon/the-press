/* Detail payload for 12-27. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-27"] = {
  "date": "12-27",
  "displayDate": "December 27",
  "year": 2009,
  "title": "Tehran",
  "topic": "Tehran",
  "headline": "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators.",
  "text": "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators.",
  "source": "https://en.wikipedia.org/wiki/Tehran",
  "sourceLabel": "Wikipedia: Tehran",
  "sourceDescription": "Capital and largest city of Iran",
  "visual": "protest",
  "palette": "public-square",
  "dek": "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 27"
    ...
    {
      "label": "Source trail",
      "value": "Capital and largest city of Iran"
    }
  ],
  "summary": [
    "December 27, 2009, is not just a date label for Tehran. It is the point where a larger protest story becomes visible enough to study. During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a street, square, prison, factory gate, school, or public building where ordinary people made power answer back. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Tehran belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1832,
  "related": [
    {
      "title": "2009 Iranian presidential election protests",
      "source": "https://en.wikipedia.org/wiki/2009_Iranian_presidential_election_protests",
      "description": "Protests against Mahmoud Ahmadinejad"
    },
    {
      "title": "Tehran",
      "source": "https://en.wikipedia.org/wiki/Tehran",
      "description": "Capital and largest city of Iran"
    },
    {
      "title": "2009 Iranian presidential election",
      "source": "https://en.wikipedia.org/wiki/2009_Iranian_presidential_election",
      "description": ""
    },
    {
      "title": "Ashura protests",
      "source": "https://en.wikipedia.org/wiki/Ashura_protests",
      "description": "2009 protests in Iran against election"
    }
  ],
  "coolFacts": [
    "December 27 places the reader in 2009, inside a protest story with consequences beyond the date itself.",
    "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators.",
    "The central source trail begins with Tehran.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Tehran",
      "href": "https://commons.wikimedia.org/w/index.php?search=Tehran%202009&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Tehran",
      "href": "https://catalog.archives.gov/search?q=Tehran%202009",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Tehran",
      "href": "https://archive.org/search?query=Tehran%202009",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Tehran",
      "href": "https://www.britannica.com/search?query=Tehran",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Tehran",
      "href": "https://www.nytimes.com/search?query=Tehran%202009",
  ...
  "article": [
    ...
    {
      "text": "December 27, 2009, is not just a date label for Tehran. It is the point where a larger protest story becomes visible enough to study. During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 27, 2009, During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. Why it mattered: Tehran opened a public doorway into a larger change, and it showed public pressure becoming a political force rather than background noise. In the wider protest story, it showed public pressure becoming a political force rather than background noise. The source record identifies Tehran as capital and largest city of Iran. Related subjects include 2009 Iranian presidential election protests (Protests against Mahmoud Ahmadinejad), Tehran (Capital and largest city of Iran), 2009 Iranian presidential election, Ashura protests (2009 protests in Iran against election). The... The related trail points to 2009 Iranian presidential election protests, Tehran, 2009 Iranian presidential election, Ashura protests, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Tehran is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Tehran, the detail work starts with the nouns inside the event itself: During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-27");
