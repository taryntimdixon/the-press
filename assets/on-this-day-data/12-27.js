...
window.PRESS_ON_THIS_DAY_DETAIL["12-27"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Tehran.",
  ...
  "article": [
    ...
    {
      "text": "The short version of December 27 is easy: During protests in Tehran against the recent presidential election, Iranian security forces opened fire on demonstrators. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
