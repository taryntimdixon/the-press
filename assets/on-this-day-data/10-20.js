/* Detail payload for 10-20. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-20"] = {
  "date": "10-20",
  ...
  "sourceDescription": "1970s political scandal in the U.S.",
  "visual": "crime",
  "palette": "dispatch",
  "dek": "Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard... The deeper story is how this crime and accountability moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 20"
    ...
    {
      "label": "Source trail",
      "value": "1970s political scandal in the U.S."
    }
  ],
  "summary": [
    "October 20, 1973, is not just a date label for Watergate scandal. It is the point where a larger crime and accountability story becomes visible enough to study. Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard Nixon's order to have Archibald Cox fired. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a hallway, office, courtroom, evidence table, newsroom, or police setting where a case became bigger than the act itself. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Watergate scandal belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1880,
  "related": [
    {
      "title": "Watergate scandal",
      "source": "https://en.wikipedia.org/wiki/Watergate_scandal",
      "description": "1970s political scandal in the U.S."
    },
    {
      "title": "Elliot Richardson",
      "source": "https://en.wikipedia.org/wiki/Elliot_Richardson",
      "description": "American lawyer and politician (1920–1999)"
    },
    {
      "title": "William Ruckelshaus",
      "source": "https://en.wikipedia.org/wiki/William_Ruckelshaus",
      "description": "American attorney, EPA Administrator, acting FBI Director"
    },
    {
      "title": "Saturday Night Massacre",
      "source": "https://en.wikipedia.org/wiki/Saturday_Night_Massacre",
      "description": "Resignations during the Watergate scandal"
    }
  ],
  "coolFacts": [
    "October 20 places the reader in 1973, inside a crime and accountability story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Watergate scandal",
      "href": "https://commons.wikimedia.org/w/index.php?search=Watergate%20scandal%201973&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Watergate scandal",
      "href": "https://catalog.archives.gov/search?q=Watergate%20scandal%201973",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Watergate scandal",
      "href": "https://archive.org/search?query=Watergate%20scandal%201973",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Watergate scandal",
    ...
    },
    {
      ...
      "title": "The New York Times archive search: Watergate scandal",
      "href": "https://www.nytimes.com/search?query=Watergate%20scandal%201973",
  ...
  "article": [
    ...
    {
      "text": "October 20, 1973, is not just a date label for Watergate scandal. It is the point where a larger crime and accountability story becomes visible enough to study. Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard Nixon's order to have Archibald Cox fired. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 20, 1973, Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard Nixon's order to have Archibald Cox fired. Why it mattered: Watergate scandal matters because it exposed how law, evidence, fear, media attention, and state power collided in public. In the wider crime story, it exposed how law, evidence, fear, media attention, and state power collided in public. The source record identifies Watergate scandal as 1970s political scandal in the U.S.. Related subjects include Watergate scandal (1970s political scandal in the U.S.), Elliot Richardson (American lawyer and politician (1920–1999)), William Ruckelshaus (American attorney, EPA Administrator, acting FBI Director), Saturday Night Massacre (Resignations... The related trail points to Watergate scandal, Elliot Richardson, William Ruckelshaus, Saturday Night Massacre, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Watergate scandal into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Watergate scandal is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Watergate scandal, the detail work starts with the nouns inside the event itself: Watergate scandal: Attorney General Elliot Richardson and his deputy William Ruckelshaus resigned after refusing to obey President Richard Nixon's order to have Archibald Cox fired. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-20");
