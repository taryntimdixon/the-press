/* Detail payload for 05-30. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-30"] = {
  "date": "05-30",
  "displayDate": "May 30",
  "year": 1431,
  ...
  "dek": "Joan of Arc was executed in Rouen, becoming one of history’s most enduring symbols of faith, war, politics, and martyrdom. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 30"
    ...
    {
      "label": "Source trail",
      "value": "French military leader and Catholic saint"
    }
  ],
  "summary": [
  ...
  "sources": [
    {
      ...
      "title": "Britannica: Saint Joan of Arc",
      "href": "https://www.britannica.com/biography/Saint-Joan-of-Arc",
      "description": "Reference biography and historical context around Joan’s trial, execution, and later memory."
    },
    {
      "kind": "Manuscript Search",
      "title": "Gallica search: Jeanne d’Arc",
      "href": "https://gallica.bnf.fr/services/engine/search/sru?operation=searchRetrieve&query=dc.title%20all%20%22Jeanne%20d%27Arc%22",
      "description": "French national-library search lead for manuscripts, books, images, and public memory."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Joan of Arc Executed",
      "href": "https://commons.wikimedia.org/w/index.php?search=Joan%20of%20Arc%20Executed%201431&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Joan of Arc Executed",
      "href": "https://catalog.archives.gov/search?q=Joan%20of%20Arc%20Executed%201431",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Joan of Arc Executed",
      "href": "https://archive.org/search?query=Joan%20of%20Arc%20Executed%201431",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Joan of Arc Executed",
      "href": "https://www.britannica.com/search?query=Joan%20of%20Arc",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Joan of Arc Executed",
      "href": "https://www.nytimes.com/search?query=Joan%20of%20Arc%20Executed%201431",
  ...
  "article": [
    ...
    {
      "text": "May 30, 1431, is not just a date label for Joan of Arc Executed. It is the point where a larger government and civic power story becomes visible enough to study. Joan of Arc was executed in Rouen after a politically charged trial, transforming a young military and religious figure into a lasting symbol of martyrdom, nationalism, gender, and power. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 30, 1431, Joan of Arc was executed in Rouen after a politically charged trial, transforming a young military and religious figure into a lasting symbol of martyrdom, nationalism, gender, and power. Why it mattered: A terrifying public death that became one of the most famous stories in European history. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Joan of Arc as french military leader and Catholic saint. The lasting consequence was institutional: a rule, office, treaty, court, border, or public body worked differently afterward.  Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "Joan’s death became a trial record, a martyrdom story, a national symbol, and a recurring argument about sanctity, politics, youth, and power. That is the specific turn inside Joan of Arc Executed. The event does not matter only because it appears on a timeline; it matters because it rearranged expectations around a particular institution, medium, body of law, machine, movement, audience, or landscape. The reader can follow that turn through the source trail: the official record, the images, the museum or institutional material, and later reporting that shows how the event kept changing after the first headlines passed.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Joan of Arc Executed into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Joan of Arc Executed is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Joan of Arc Executed, the detail work starts with the nouns inside the event itself: Joan of Arc was executed in Rouen after a politically charged trial, transforming a young military and religious figure into a lasting symbol of martyrdom, nationalism, gender, and power. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-30");
