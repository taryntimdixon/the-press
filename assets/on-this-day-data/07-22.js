/* Detail payload for 07-22. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-22"] = {
  "date": "07-22",
  "displayDate": "July 22",
  "year": 1933,
  ...
  "visual": "transport",
  "palette": "voyage",
  "dek": "Wiley Post completed the first solo flight around the world. The deeper story is how this transportation moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 22"
    ...
    {
      "label": "Main event",
      "value": "First Solo Around-the-World Flight Completed"
    },
    {
      "label": "Scene",
    ...
    {
      "label": "Source trail",
      "value": "American aviator who completed the first solo flight around the world"
    }
  ],
  "summary": [
  ...
  "sources": [
    {
      "kind": "Aircraft Object",
      "title": "Smithsonian NASM search: Wiley Post Winnie Mae",
      "href": "https://airandspace.si.edu/search?search=Wiley%20Post%20Winnie%20Mae",
      "description": "Aircraft, object, image, and aviation-history leads."
    },
    {
      "kind": "Reference Biography",
      "title": "Britannica: Wiley Post",
      "href": "https://www.britannica.com/biography/Wiley-Post",
      "description": "Reference biography and aviation-history context."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: First Solo Around-the-World Flight Completed",
      "href": "https://commons.wikimedia.org/w/index.php?search=First%20Solo%20Around-the-World%20Flight%20Completed%201933&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: First Solo Around-the-World Flight Completed",
      "href": "https://www.si.edu/search?edan_q=First%20Solo%20Around-the-World%20Flight%20Completed%201933",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: First Solo Around-the-World Flight Completed",
      "href": "https://archive.org/search?query=First%20Solo%20Around-the-World%20Flight%20Completed%201933",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: First Solo Around-the-World Flight Completed",
      "href": "https://www.britannica.com/search?query=Wiley%20Post",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: First Solo Around-the-World Flight Completed",
      "href": "https://www.nytimes.com/search?query=First%20Solo%20Around-the-World%20Flight%20Completed%201933",
  ...
  "article": [
    ...
    {
      "text": "July 22, 1933, is not just a date label for First Solo Around-the-World Flight Completed. It is the point where a larger transportation story becomes visible enough to study. Wiley Post completed the first solo flight around the world, proving long-distance aviation, navigation, endurance, and global news spectacle could fit inside one aircraft journey. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how bodies, goods, news, armies, families, and ambition moved through the world. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. First Solo Around-the-World Flight Completed matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american aviator who completed the first solo flight around the world. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The flight made global aviation feel personally survivable and turned endurance, technology, route planning, and public spectacle into one story. That is the specific turn inside First Solo Around-the-World Flight Completed. The event does not matter only because it appears on a timeline; it matters because it rearranged expectations around a particular institution, medium, body of law, machine, movement, audience, or landscape. The reader can follow that turn through the source trail: the official record, the images, the museum or institutional material, and later reporting that shows how the event kept changing after the first headlines passed.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten First Solo Around-the-World Flight Completed into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. First Solo Around-the-World Flight Completed is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-22");
