/* Detail payload for 02-22. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-22"] = {
  "date": "02-22",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "Village in New York State, United States"
    }
  ],
  "summary": [
    ...
    "The strongest image for this entry is not a symbol floating in empty space. It is a recorded setting where documents, eyewitnesses, objects, and later memory keep pulling one date back into view. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Lake Placid, New York belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1937,
  "related": [
    {
      "title": "1980 Winter Olympics",
      "source": "https://en.wikipedia.org/wiki/1980_Winter_Olympics",
      "description": "Multi-sport event in Lake Placid, New York, US"
    },
    {
      "title": "Lake Placid, New York",
      "source": "https://en.wikipedia.org/wiki/Lake_Placid%2C_New_York",
      "description": "Village in New York State, United States"
    },
    {
      "title": "United States men's national ice hockey team",
      "source": "https://en.wikipedia.org/wiki/United_States_men's_national_ice_hockey_team",
      "description": "Men's national ice hockey team representing the United States"
    },
    {
      "title": "Soviet Union men's national ice hockey team",
      "source": "https://en.wikipedia.org/wiki/Soviet_Union_men's_national_ice_hockey_team",
      "description": "Former men's national ice hockey team representing the Soviet Union"
    }
  ],
  "coolFacts": [
    "February 22 places the reader in 1980, inside a history story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Lake Placid, New York.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Lake Placid, New York",
      "href": "https://commons.wikimedia.org/w/index.php?search=Lake%20Placid%2C%20New%20York%201980&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Lake Placid, New York",
      "href": "https://www.si.edu/search?edan_q=Lake%20Placid%2C%20New%20York%201980",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Lake Placid, New York",
      "href": "https://archive.org/search?query=Lake%20Placid%2C%20New%20York%201980",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Lake Placid, New York",
      "href": "https://www.britannica.com/search?query=Lake%20Placid%2C%20New%20York",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Lake Placid, New York",
      "href": "https://www.nytimes.com/search?query=Lake%20Placid%2C%20New%20York%201980",
  ...
  "article": [
    ...
    {
      "text": "February 22, 1980, is not just a date label for Lake Placid, New York. It is the point where a larger history story becomes visible enough to study. At the Winter Olympics in Lake Placid, New York, the United States ice hockey team defeated the Soviet team in an unlikely victory that became known as the Miracle on Ice. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Lake Placid, New York matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as village in New York State, United States. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Lake Placid, New York into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Lake Placid, New York is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Lake Placid, New York, the detail work starts with the nouns inside the event itself: At the Winter Olympics in Lake Placid, New York, the United States ice hockey team defeated the Soviet team in an unlikely victory that became known as the Miracle on Ice. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-22");
