/* Detail payload for 05-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-21"] = {
  "date": "05-21",
  "displayDate": "May 21",
  "year": 1927,
  ...
  "sourceDescription": "Monoplane flown solo by Charles Lindbergh",
  "visual": "transport",
  "palette": "voyage",
  "dek": "Aboard the Spirit of St. Louis, American aviator Charles Lindbergh completed the first solo non-stop transatlantic flight, flying from Roosevelt Field near New York City to Paris–Le Bourget Airport. The deeper story is how this transportation moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 21"
    ...
    {
      "label": "Source trail",
      "value": "Monoplane flown solo by Charles Lindbergh"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Spirit of St. Louis",
      "source": "https://en.wikipedia.org/wiki/Spirit_of_St._Louis",
      "description": "Monoplane flown solo by Charles Lindbergh"
    },
    {
      "title": "Charles Lindbergh",
      "source": "https://en.wikipedia.org/wiki/Charles_Lindbergh",
      "description": "American aviator (1902–1974)"
    },
    {
      "title": "Transatlantic flight",
      "source": "https://en.wikipedia.org/wiki/Transatlantic_flight",
      "description": "Flight of an aircraft across the Atlantic Ocean"
    },
    {
      "title": "Roosevelt Field (airport)",
      "source": "https://en.wikipedia.org/wiki/Roosevelt_Field_(airport)",
      "description": "Former commercial and naval airport in New York state"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Spirit of St. Louis",
      "href": "https://commons.wikimedia.org/w/index.php?search=Spirit%20of%20St.%20Louis%201927&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Spirit of St. Louis",
      "href": "https://www.si.edu/search?edan_q=Spirit%20of%20St.%20Louis%201927",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Spirit of St. Louis",
      "href": "https://archive.org/search?query=Spirit%20of%20St.%20Louis%201927",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Spirit of St. Louis",
      "href": "https://www.britannica.com/search?query=Spirit%20of%20St.%20Louis",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Spirit of St. Louis",
      "href": "https://www.nytimes.com/search?query=Spirit%20of%20St.%20Louis%201927",
  ...
  "article": [
    ...
    {
      "text": "May 21, 1927, is not just a date label for Spirit of St. Louis. It is the point where a larger transportation story becomes visible enough to study. Aboard the Spirit of St. Louis, American aviator Charles Lindbergh completed the first solo non-stop transatlantic flight, flying from Roosevelt Field near New York City to Paris–Le Bourget Airport. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how bodies, goods, news, armies, families, and ambition moved through the world. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Spirit of St. Louis matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as monoplane flown solo by Charles Lindbergh. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 21, 1927, Aboard the Spirit of St. Louis, American aviator Charles Lindbergh completed the first solo non-stop transatlantic flight, flying from Roosevelt Field near New York City to Paris–Le Bourget Airport. Why it mattered: Spirit of St. Louis marked a first, and it changed how people, goods, risk, distance, or rescue moved across the world. In the wider transport story, it changed how people, goods, risk, distance, or rescue moved across the world. The source record identifies Spirit of St. Louis as monoplane flown solo by Charles Lindbergh. Related subjects include Spirit of St. Louis (Monoplane flown solo by Charles Lindbergh), Charles Lindbergh (American aviator (1902–1974)), Transatlantic flight (Flight of an aircraft across the Atlantic Ocean), Roosevelt. The related trail points to Spirit of St. Louis, Charles Lindbergh, Transatlantic flight, Roosevelt Field (airport), which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Spirit of St. Louis into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Spirit of St. Louis is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Spirit of St. Louis, the detail work starts with the nouns inside the event itself: Aboard the Spirit of St. Louis, American aviator Charles Lindbergh completed the first solo non-stop transatlantic flight, flying from Roosevelt Field near New York City to Paris–Le Bourget Airport. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-21");
