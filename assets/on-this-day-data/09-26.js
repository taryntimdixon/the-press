/* Detail payload for 09-26. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-26"] = {
  "date": "09-26",
  ...
  "sourceDescription": "English rock band (1960–1970)",
  "visual": "music",
  "palette": "stage",
  "dek": "The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 26"
    ...
    {
      "label": "Source trail",
      "value": "English rock band (1960–1970)"
    }
  ],
  "summary": [
    "September 26, 1968, is not just a date label for The Beatles. It is the point where a larger music and broadcast culture story becomes visible enough to study. The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "English musician and activist (1940–1980)"
    },
    {
      "title": "Happiness Is a Warm Gun",
      "source": "https://en.wikipedia.org/wiki/Happiness_Is_a_Warm_Gun",
      "description": "1968 song by the Beatles"
    },
    {
      "title": "The Beatles (album)",
      "source": "https://en.wikipedia.org/wiki/The_Beatles_(album)",
      "description": "1968 studio album by the Beatles"
    }
  ],
  "coolFacts": [
    "September 26 places the reader in 1968, inside a music and broadcast culture story with consequences beyond the date itself.",
    ...
    "A useful starting source is The Beatles.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: The Beatles",
      "href": "https://commons.wikimedia.org/w/index.php?search=The%20Beatles%201968&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: The Beatles",
      "href": "https://www.si.edu/search?edan_q=The%20Beatles%201968",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: The Beatles",
      "href": "https://archive.org/search?query=The%20Beatles%201968",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: The Beatles",
      "href": "https://www.britannica.com/search?query=The%20Beatles",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: The Beatles",
      "href": "https://www.nytimes.com/search?query=The%20Beatles%201968",
  ...
  "article": [
    ...
    {
      "text": "September 26, 1968, is not just a date label for The Beatles. It is the point where a larger music and broadcast culture story becomes visible enough to study. The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. The Beatles matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as english rock band (1960–1970). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 26, 1968, the Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. Why it mattered: The Beatles matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies The Beatles as english rock band (1960–1970). Related subjects include The Beatles (English rock band (1960–1970)), John Lennon (English musician and activist (1940–1980)), Happiness Is a Warm Gun (1968 song by the Beatles), The Beatles (album) (1968 studio album by. The related trail points to The Beatles, John Lennon, Happiness Is a Warm Gun, The Beatles (album), which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten The Beatles into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. The Beatles is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For The Beatles, the detail work starts with the nouns inside the event itself: The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of September 26 is easy: The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the band members as their favourite on the album The Beatles. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. The Beatles is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-26");
