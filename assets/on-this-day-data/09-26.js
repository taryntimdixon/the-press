...
window.PRESS_ON_THIS_DAY_DETAIL["09-26"] = {
  ...
  "visual": "music",
  "palette": "stage",
  "dek": "The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the... The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 26"
  ...
  "article": [
    ...
    {
      "text": "The Beatles completed the recording of John Lennon's song \"Happiness Is a Warm Gun\", regarded by all the... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
