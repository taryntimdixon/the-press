...
window.PRESS_ON_THIS_DAY_DETAIL["08-01"] = {
  ...
  "visual": "music",
  "palette": "stage",
  "dek": "\"Video Killed the Radio Star\" by the Buggles became the first music video broadcast on the American cable television network MTV. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 1"
  ...
  "coolFacts": [
    ...
    "A useful starting source is Video Killed the Radio Star.",
  ...
  "article": [
    ...
    {
      "text": "The short version of August 1 is easy: \"Video Killed the Radio Star\" by the Buggles became the first music video broadcast on the American cable television network MTV. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
