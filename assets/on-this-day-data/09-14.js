/* Detail payload for 09-14. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-14"] = {
  "date": "09-14",
  "displayDate": "September 14",
  "year": 1992,
  "title": "Croatian Republic of Herzeg-Bosnia",
  "topic": "Croatian Republic of Herzeg-Bosnia",
  "headline": "The Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional.",
  ...
  "sourceLabel": "Wikipedia: Croatian Republic of Herzeg-Bosnia",
  "sourceDescription": "Unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina",
  "visual": "civic",
  "palette": "civic",
  "dek": "The Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 14"
    ...
    {
      "label": "Main event",
      "value": "Croatian Republic of Herzeg-Bosnia"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "Unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina"
    }
  ],
  "summary": [
    "September 14, 1992, is not just a date label for Croatian Republic of Herzeg-Bosnia. It is the point where a larger government and civic power story becomes visible enough to study. The Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
  ...
  "related": [
    {
      "title": "Croatian Republic of Herzeg-Bosnia",
      "source": "https://en.wikipedia.org/wiki/Croatian_Republic_of_Herzeg-Bosnia",
      "description": "Unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina"
    }
  ],
  "coolFacts": [
    "September 14 places the reader in 1992, inside a government and civic power story with consequences beyond the date itself.",
    "The Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional.",
    "The central source trail begins with Croatian Republic of Herzeg-Bosnia.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Croatian Republic of Herzeg-Bosnia",
      "href": "https://commons.wikimedia.org/w/index.php?search=Croatian%20Republic%20of%20Herzeg-Bosnia%201992&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Croatian Republic of Herzeg-Bosnia",
      "href": "https://catalog.archives.gov/search?q=Croatian%20Republic%20of%20Herzeg-Bosnia%201992",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Croatian Republic of Herzeg-Bosnia",
      "href": "https://archive.org/search?query=Croatian%20Republic%20of%20Herzeg-Bosnia%201992",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Croatian Republic of Herzeg-Bosnia",
      "href": "https://www.britannica.com/search?query=Croatian%20Republic%20of%20Herzeg-Bosnia",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Croatian Republic of Herzeg-Bosnia",
      "href": "https://www.nytimes.com/search?query=Croatian%20Republic%20of%20Herzeg-Bosnia%201992",
  ...
  "article": [
    ...
    {
      "text": "September 14, 1992, is not just a date label for Croatian Republic of Herzeg-Bosnia. It is the point where a larger government and civic power story becomes visible enough to study. The Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who held authority and how that authority could be justified, limited, celebrated, or challenged. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Croatian Republic of Herzeg-Bosnia matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 14, 1992, the Constitutional Court of Bosnia and Herzegovina declared the breakaway Croatian Republic of Herzeg-Bosnia to be unconstitutional. Why it mattered: Croatian Republic of Herzeg-Bosnia turned an argument into a formal rule, and it changed how an institution, law, government, treaty, or. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Croatian Republic of Herzeg-Bosnia as unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina. Related subjects include Croatian Republic of Herzeg-Bosnia (Unrecognized proto-state in the Balkans (1991–1996); now part of Bosnia and Herzegovina). The lasting consequence was... The related trail points to Croatian Republic of Herzeg-Bosnia, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Croatian Republic of Herzeg-Bosnia into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Croatian Republic of Herzeg-Bosnia is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-14");
