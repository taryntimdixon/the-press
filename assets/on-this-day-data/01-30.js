/* Detail payload for 01-30. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-30"] = {
  "date": "01-30",
  ...
  "facts": [
    ...
    {
      "label": "Main event",
      "value": "Korea Aerospace Research Institute"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "South Korean space agency"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Korea Aerospace Research Institute",
      "source": "https://en.wikipedia.org/wiki/Korea_Aerospace_Research_Institute",
      "description": "South Korean space agency"
    },
    {
      "title": "Naro-1",
      "source": "https://en.wikipedia.org/wiki/Naro-1",
      "description": "South Korea's first carrier rocket (2009–2013)"
    },
    {
      "title": "Launch vehicle",
      "source": "https://en.wikipedia.org/wiki/Launch_vehicle",
      "description": "Rocket used to carry a spacecraft into space"
    }
  ],
  "coolFacts": [
    "January 30 places the reader in 2013, inside a space exploration story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Korea Aerospace Research Institute.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Korea Aerospace Research Institute",
      "href": "https://commons.wikimedia.org/w/index.php?search=Korea%20Aerospace%20Research%20Institute%202013&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Korea Aerospace Research Institute",
      "href": "https://www.nasa.gov/search/?search=Korea%20Aerospace%20Research%20Institute%202013",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Korea Aerospace Research Institute",
      "href": "https://archive.org/search?query=Korea%20Aerospace%20Research%20Institute%202013",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Korea Aerospace Research Institute",
      "href": "https://www.britannica.com/search?query=Korea%20Aerospace%20Research%20Institute",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Korea Aerospace Research Institute",
      "href": "https://www.nytimes.com/search?query=Korea%20Aerospace%20Research%20Institute%202013",
  ...
  "article": [
    ...
    {
      "text": "January 30, 2013, is not just a date label for Korea Aerospace Research Institute. It is the point where a larger space exploration story becomes visible enough to study. The Korea Aerospace Research Institute launched Naro-1, South Korea's first carrier rocket and their first launch vehicle to achieve Earth orbit. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Korea Aerospace Research Institute matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as south Korean space agency. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Korea Aerospace Research Institute into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Korea Aerospace Research Institute is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Korea Aerospace Research Institute, the detail work starts with the nouns inside the event itself: The Korea Aerospace Research Institute launched Naro-1, South Korea's first carrier rocket and their first launch vehicle to achieve Earth orbit. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-30");
