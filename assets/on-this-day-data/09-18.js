/* Detail payload for 09-18. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-18"] = {
  "date": "09-18",
  ...
  "sourceDescription": "American explorer, businessman, historian and vigilante",
  "visual": "transport",
  "palette": "voyage",
  "dek": "Nathaniel P. Langford of the Washburn–Langford–Doane Expedition first observed a geyser in the Wyoming Territory erupting at regular... The deeper story is how this transportation moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 18"
  ...
  "related": [
    {
      "title": "Nathaniel P. Langford",
      "source": "https://en.wikipedia.org/wiki/Nathaniel_P._Langford",
      "description": "American explorer, businessman, historian and vigilante"
    },
    {
      "title": "Washburn–Langford–Doane Expedition",
      "source": "https://en.wikipedia.org/wiki/Washburn%E2%80%93Langford%E2%80%93Doane_Expedition",
      "description": "Research expedition in the US"
    },
    {
      "title": "Geyser",
      "source": "https://en.wikipedia.org/wiki/Geyser",
      "description": "Natural explosive eruption of hot water"
    },
    {
      "title": "Wyoming Territory",
      "source": "https://en.wikipedia.org/wiki/Wyoming_Territory",
      "description": "Former organized incorporated territory of the United States (1868–1890)"
    }
  ],
  "coolFacts": [
    "September 18 places the reader in 1870, inside a transportation story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Nathaniel P. Langford.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Nathaniel P. Langford",
      "href": "https://commons.wikimedia.org/w/index.php?search=Nathaniel%20P.%20Langford%201870&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Nathaniel P. Langford",
      "href": "https://www.si.edu/search?edan_q=Nathaniel%20P.%20Langford%201870",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Nathaniel P. Langford",
      "href": "https://archive.org/search?query=Nathaniel%20P.%20Langford%201870",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Nathaniel P. Langford",
      "href": "https://www.britannica.com/search?query=Nathaniel%20P.%20Langford",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Nathaniel P. Langford",
      "href": "https://www.nytimes.com/search?query=Nathaniel%20P.%20Langford%201870",
  ...
  "article": [
    ...
    {
      "text": "September 18, 1870, is not just a date label for Nathaniel P. Langford. It is the point where a larger transportation story becomes visible enough to study. Nathaniel P. Langford of the Washburn–Langford–Doane Expedition first observed a geyser in the Wyoming Territory erupting at regular intervals, naming it Old Faithful (video featured). The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Nathaniel P. Langford of the Washburn–Langford–Doane Expedition first observed a geyser in the Wyoming Territory erupting at regular... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how bodies, goods, news, armies, families, and ambition moved through the world. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Nathaniel P. Langford matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american explorer, businessman, historian and vigilante. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 18, 1870, Nathaniel P. Langford of the Washburn–Langford–Doane Expedition first observed a geyser in the Wyoming Territory erupting at regular intervals, naming it Old Faithful (video featured). Why it mattered: Nathaniel P. Langford marked a first, and it changed how people, goods, risk, distance, or rescue moved across the world. In the wider transport story, it changed how people, goods, risk, distance, or rescue moved across the world. The source record identifies Nathaniel P. Langford as american explorer, businessman, historian and vigilante. Related subjects include Nathaniel P. Langford (American explorer, businessman, historian and vigilante), Washburn–Langford–Doane Expedition (Research expedition in the US), Geyser (Natural explosive eruption of hot water), Wyoming Territory (Former organized... The related trail points to Nathaniel P. Langford, Washburn–Langford–Doane Expedition, Geyser, Wyoming Territory, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Nathaniel P. Langford into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Nathaniel P. Langford is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-18");
