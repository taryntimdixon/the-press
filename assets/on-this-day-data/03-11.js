...
window.PRESS_ON_THIS_DAY_DETAIL["03-11"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Sebastián Piñera.",
  ...
  "article": [
    ...
    {
      "text": "The short version of March 11 is easy: During the inauguration of Chilean president Sebastián Piñera, earthquakes registering 6.9 and 7.0.mw-parser-output.tooltip-dotted{border-bottom:1px dotted;cursor:help}Mw struck the O'Higgins Region near the city of Pichilemu, causing widespread damage. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
