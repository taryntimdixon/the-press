/* Detail payload for 07-18. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-18"] = {
  "date": "07-18",
  "displayDate": "July 18",
  "year": 1968,
  "title": "Intel Founded",
  ...
  "visual": "tech",
  "palette": "signal",
  "dek": "Intel was founded in California, helping build the semiconductor foundation of modern computing. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 18"
    ...
    {
      "label": "Source trail",
      "value": "Intel history page for the company founding"
    }
  ],
  "summary": [
  ...
  "sources": [
    {
      ...
      "title": "Intel: Intel’s founding",
      "href": "https://www.intel.com/content/www/us/en/history/virtual-vault/articles/intels-founding.html",
      "description": "Intel’s official history of the company’s 1968 founding."
    },
    {
      "kind": "Computer History",
      "title": "Computer History Museum search: Intel founding",
      "href": "https://www.computerhistory.org/search/?q=Intel%20founding",
      "description": "Collection and exhibit leads on Intel and semiconductor history."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Intel Founded",
      "href": "https://commons.wikimedia.org/w/index.php?search=Intel%20Founded%201968&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Intel Founded",
      "href": "https://www.si.edu/search?edan_q=Intel%20Founded%201968",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Intel Founded",
      "href": "https://archive.org/search?query=Intel%20Founded%201968",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Intel Founded",
      "href": "https://www.britannica.com/search?query=Intel",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Intel Founded",
      "href": "https://www.nytimes.com/search?query=Intel%20Founded%201968",
  ...
  "article": [
    ...
    {
      "text": "July 18, 1968, is not just a date label for Intel Founded. It is the point where a larger technology story becomes visible enough to study. Intel was founded in California, helping push memory chips, microprocessors, personal computers, data centers, and the semiconductor industry into the center of modern life. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Intel Founded matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as intel history page for the company founding. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On July 18, 1968, Intel was founded in California, helping push memory chips, microprocessors, personal computers, data centers, and the semiconductor industry into the center of modern life. Why it mattered: A chip-industry founding that fed personal computing, servers, software, mobile devices, and the digital economy. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies Intel: Intel’s Founding as intel history page for the company founding. The lasting consequence was a faster information world: new tools changed how messages, images, money, work, or culture moved through society.  Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Intel Founded, the detail work starts with the nouns inside the event itself: Intel was founded in California, helping push memory chips, microprocessors, personal computers, data centers, and the semiconductor industry into the center of modern life. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-18");
