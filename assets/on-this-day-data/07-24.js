/* Detail payload for 07-24. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-24"] = {
  "date": "07-24",
  "displayDate": "July 24",
  "year": 1969,
  ...
  "visual": "space",
  "palette": "voyage",
  "dek": "Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 24"
    ...
    {
      "label": "Main event",
      "value": "Apollo 11 Returns to Earth"
    },
    {
      "label": "Scene",
  ...
  "summary": [
    "July 24, 1969, is not just a date label for Apollo 11 Returns to Earth. It is the point where a larger space exploration story becomes visible enough to study. Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission as recovery crews, quarantine procedures, and global television turned triumph into return. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is Apollo 11’s Pacific splashdown, where astronauts, quarantine procedures, Navy divers, helicopters, cameras, and recovery ships completed the lunar mission. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Apollo 11 Returns to Earth belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1986,
  "related": [],
  "coolFacts": [
    "July 24 places the reader in 1969, inside a space exploration story with consequences beyond the date itself.",
    "Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission as recovery crews, quarantine procedures, and global television turned triumph into return.",
  ...
  "sources": [
    ...
    {
      "kind": "Image Archive",
      "title": "NASA Images search: Apollo 11 splashdown",
      "href": "https://images.nasa.gov/search-results?q=Apollo%2011%20splashdown",
      "description": "Recovery photographs, video, and mission media."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Apollo 11 Returns to Earth",
      "href": "https://commons.wikimedia.org/w/index.php?search=Apollo%2011%20Returns%20to%20Earth%201969&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Apollo 11 Returns to Earth",
      "href": "https://www.nasa.gov/search/?search=Apollo%2011%20Returns%20to%20Earth%201969",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Apollo 11 Returns to Earth",
      "href": "https://archive.org/search?query=Apollo%2011%20Returns%20to%20Earth%201969",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Apollo 11 Returns to Earth",
    ...
    },
    {
      ...
      "title": "The New York Times archive search: Apollo 11 Returns to Earth",
      "href": "https://www.nytimes.com/search?query=Apollo%2011%20Returns%20to%20Earth%201969",
  ...
  "article": [
    ...
    {
      "text": "July 24, 1969, is not just a date label for Apollo 11 Returns to Earth. It is the point where a larger space exploration story becomes visible enough to study. Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission as recovery crews, quarantine procedures, and global television turned triumph into return. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Apollo 11 Returns to Earth matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The return turned triumph into procedure: survival, contamination fears, debriefing, global television, and the beginning of lunar memory. That is the specific turn inside Apollo 11 Returns to Earth. The event does not matter only because it appears on a timeline; it matters because it rearranged expectations around a particular institution, medium, body of law, machine, movement, audience, or landscape. The reader can follow that turn through the source trail: the official record, the images, the museum or institutional material, and later reporting that shows how the event kept changing after the first headlines passed.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Apollo 11 Returns to Earth into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Apollo 11 Returns to Earth is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Apollo 11 Returns to Earth, the detail work starts with the nouns inside the event itself: Apollo 11 splashed down safely in the Pacific Ocean, completing the first Moon landing mission as recovery crews, quarantine procedures, and global television turned triumph into return. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-24");
