/* Detail payload for 07-30. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-30"] = {
  "date": "07-30",
  "displayDate": "July 30",
  "year": 1724,
  "title": "Psalm 124",
  ...
  "sourceDescription": "124th psalm of the book of psalms",
  "visual": "culture",
  "palette": "stage",
  "dek": "Bach's chorale cantata Wo Gott der Herr nicht bei uns hält, a paraphrase of Psalm 124 based on a 1524 hymn by Justus Jonas, was first performed in Leipzig. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 30"
    ...
    {
      "label": "Source trail",
      "value": "124th psalm of the book of psalms"
    }
  ],
  "summary": [
  ...
  "related": [
    ...
    {
      "title": "Chorale cantata cycle",
      "source": "https://en.wikipedia.org/wiki/Chorale_cantata_cycle",
      "description": "Set of compositions by J. S. Bach"
    },
    {
      "title": "Wo Gott der Herr nicht bei uns hält, BWV 178",
      "source": "https://en.wikipedia.org/wiki/Wo_Gott_der_Herr_nicht_bei_uns_h%C3%A4lt%2C_BWV_178",
      "description": "1724 church cantata by J.S. Bach"
    },
    {
      "title": "Psalm 124",
      "source": "https://en.wikipedia.org/wiki/Psalm_124",
      "description": "124th psalm of the book of psalms"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Psalm 124",
      "href": "https://commons.wikimedia.org/w/index.php?search=Psalm%20124%201724&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Psalm 124",
      "href": "https://www.si.edu/search?edan_q=Psalm%20124%201724",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Psalm 124",
      "href": "https://archive.org/search?query=Psalm%20124%201724",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Psalm 124",
      "href": "https://www.britannica.com/search?query=Psalm%20124",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Psalm 124",
      "href": "https://www.nytimes.com/search?query=Psalm%20124%201724",
  ...
  "article": [
    ...
    {
      "text": "July 30, 1724, is not just a date label for Psalm 124. It is the point where a larger culture story becomes visible enough to study. Bach's chorale cantata Wo Gott der Herr nicht bei uns hält, a paraphrase of Psalm 124 based on a 1524 hymn by Justus Jonas, was first performed in Leipzig. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it altered taste, language, fandom, entertainment, memory, or the way audiences recognized themselves. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Psalm 124 matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 124th psalm of the book of psalms. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On July 30, 1724, Bach's chorale cantata Wo Gott der Herr nicht bei uns hält, a paraphrase of Psalm 124 based on a 1524 hymn by Justus Jonas, was first performed in Leipzig. Why it mattered: Psalm 124 marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Psalm 124 as 124th psalm of the book of psalms. Related subjects include Johann Sebastian Bach (German composer (1685–1750)), Chorale cantata cycle (Set of compositions by J. S. Bach), Wo Gott der Herr nicht bei uns hält, BWV 178 (1724. The related trail points to Johann Sebastian Bach, Chorale cantata cycle, Wo Gott der Herr nicht bei uns hält, BWV 178, Psalm 124, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Psalm 124 into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Psalm 124 is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Psalm 124, the detail work starts with the nouns inside the event itself: Bach's chorale cantata Wo Gott der Herr nicht bei uns hält, a paraphrase of Psalm 124 based on a 1524 hymn by Justus Jonas, was first performed in Leipzig. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-30");
