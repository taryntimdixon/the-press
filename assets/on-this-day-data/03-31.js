/* Detail payload for 03-31. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-31"] = {
  "date": "03-31",
  ...
  "sourceDescription": "City in Illinois, US",
  "visual": "music",
  "palette": "stage",
  "dek": "A tornado caused the collapse of a venue hosting a sold-out concert in Belvidere, Illinois, United States, resulting... The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 31"
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Belvidere, Illinois",
      "href": "https://commons.wikimedia.org/w/index.php?search=Belvidere%2C%20Illinois%202023&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Belvidere, Illinois",
      "href": "https://www.si.edu/search?edan_q=Belvidere%2C%20Illinois%202023",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Belvidere, Illinois",
      "href": "https://archive.org/search?query=Belvidere%2C%20Illinois%202023",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Belvidere, Illinois",
      "href": "https://www.britannica.com/search?query=Belvidere%2C%20Illinois",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Belvidere, Illinois",
      "href": "https://www.nytimes.com/search?query=Belvidere%2C%20Illinois%202023",
  ...
  "article": [
    ...
    {
      "text": "March 31, 2023, is not just a date label for Belvidere, Illinois. It is the point where a larger music and broadcast culture story becomes visible enough to study. A tornado caused the collapse of a venue hosting a sold-out concert in Belvidere, Illinois, United States, resulting in one death and 48 injuries. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "A tornado caused the collapse of a venue hosting a sold-out concert in Belvidere, Illinois, United States, resulting... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Belvidere, Illinois matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as city in Illinois, US. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 31, 2023, a tornado caused the collapse of a venue hosting a sold-out concert in Belvidere, Illinois, United States, resulting in one death and 48 injuries. Why it mattered: Belvidere, Illinois matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies Belvidere, Illinois as city in Illinois, US. Related subjects include Belvidere Apollo Theatre collapse (2023 building collapse in Belvidere, Illinois), Belvidere, Illinois (City in Illinois, US). The lasting consequence was cultural memory: a sound, performance, release, or audience moment became... The related trail points to Belvidere Apollo Theatre collapse, Belvidere, Illinois, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Belvidere, Illinois into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Belvidere, Illinois is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-31");
