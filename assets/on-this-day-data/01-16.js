...
window.PRESS_ON_THIS_DAY_DETAIL["01-16"] = {
  ...
  "visual": "culture",
  "palette": "stage",
  "dek": "The musical Hello, Dolly! opened at the St. James Theatre on Broadway, and went on to win ten... The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 16"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Hello, Dolly! (musical).",
  ...
  "article": [
    ...
    {
      "text": "The short version of January 16 is easy: The musical Hello, Dolly! opened at the St. James Theatre on Broadway, and went on to win ten Tony Awards, a record that stood for 37 years. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
