/* Detail payload for 04-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-06"] = {
  "date": "04-06",
  "displayDate": "April 6",
  "year": 2011,
  ...
  "visual": "crime",
  "palette": "dispatch",
  "dek": "Mexican drug war: Authorities discovered 59 bodies in clandestine mass graves linked to earlier bus hijackings in San Fernando, Tamaulipas. The deeper story is how this crime and accountability moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 6"
  ...
  "related": [
    ...
    {
      "title": "2011 San Fernando massacre",
      "source": "https://en.wikipedia.org/wiki/2011_San_Fernando_massacre",
      "description": "Mass murder in San Fernando"
    },
    {
      "title": "Mass grave",
      "source": "https://en.wikipedia.org/wiki/Mass_grave",
      "description": "Grave containing a number of human corpses"
    },
    {
      "title": "San Fernando, Tamaulipas",
      "source": "https://en.wikipedia.org/wiki/San_Fernando%2C_Tamaulipas",
      "description": "City and municipality in Tamaulipas, Mexico"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Mexican%20drug%20war%202011&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=Mexican%20drug%20war%202011",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Mexican drug war",
      "href": "https://archive.org/search?query=Mexican%20drug%20war%202011",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Mexican%20drug%20war%202011",
  ...
  "article": [
    ...
    {
      "text": "Mexican drug war: Authorities discovered 59 bodies in clandestine mass graves linked to earlier bus hijackings in San Fernando, Tamaulipas. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 6, 2011, Mexican drug war: Authorities discovered 59 bodies in clandestine mass graves linked to earlier bus hijackings in San Fernando, Tamaulipas. Why it mattered: Mexican drug war changed what could be known or verified, and it exposed how law, evidence, fear, media attention, and state power. In the wider crime story, it exposed how law, evidence, fear, media attention, and state power collided in public. The source record identifies Mexican drug war as war between Mexico's government and various drug trafficking syndicates. Related subjects include Mexican drug war (War between Mexico's government and various drug trafficking syndicates), 2011 San Fernando massacre (Mass murder in San Fernando), Mass grave (Grave. The related trail points to Mexican drug war, 2011 San Fernando massacre, Mass grave, San Fernando, Tamaulipas, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Mexican drug war, the detail work starts with the nouns inside the event itself: Mexican drug war: Authorities discovered 59 bodies in clandestine mass graves linked to earlier bus hijackings in San Fernando, Tamaulipas. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-06");
