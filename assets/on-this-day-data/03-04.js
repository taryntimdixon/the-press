/* Detail payload for 03-04. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-04"] = {
  "date": "03-04",
  "displayDate": "March 4",
  "year": 1979,
  "title": "Voyager 1",
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Rings_of_Saturn",
      "description": ""
    },
    {
      "title": "Rings of Uranus",
      "source": "https://en.wikipedia.org/wiki/Rings_of_Uranus",
      "description": ""
    }
  ],
  "coolFacts": [
    "March 4 places the reader in 1979, inside a space exploration story with consequences beyond the date itself.",
  ...
  "article": [
    ...
    {
      "text": "March 4, 1979, is not just a date label for Voyager 1. It is the point where a larger space exploration story becomes visible enough to study. The space probe Voyager 1 discovered the rings of Jupiter, the third ring system to be discovered in the Solar System, after those of Saturn and Uranus. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-04");
