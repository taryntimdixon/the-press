/* Detail payload for 03-29. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-29"] = {
  "date": "03-29",
  "displayDate": "March 29",
  "year": 1974,
  "title": "NASA",
  "topic": "NASA",
  "headline": "NASA's Mariner 10 became the first space probe to make a flyby of Mercury.",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA's Mariner 10 became the first space probe to make a flyby of Mercury. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 29"
  ...
  "summary": [
    "March 29, 1974, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA's Mariner 10 became the first space probe to make a flyby of Mercury. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "NASA's Mariner 10 became the first space probe to make a flyby of Mercury. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "First spacecraft to visit Mercury (1973–1975)"
    },
    {
    ...
    {
      "title": "Planetary flyby",
      "source": "https://en.wikipedia.org/wiki/Planetary_flyby",
      "description": "Sending a space probe past a planet or dwarf planet"
    }
  ],
  "coolFacts": [
    "March 29 places the reader in 1974, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%201974&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%201974",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=NASA%201974",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=NASA%201974",
  ...
  "article": [
    ...
    {
      "text": "March 29, 1974, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA's Mariner 10 became the first space probe to make a flyby of Mercury. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "NASA's Mariner 10 became the first space probe to make a flyby of Mercury. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 29, 1974, NASA's Mariner 10 became the first space probe to make a flyby of Mercury. Why it mattered: NASA marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public... The source record identifies NASA as american space and aeronautics agency. Related subjects include NASA (American space and aeronautics agency), Mariner 10 (First spacecraft to visit Mercury (1973–1975)), Uncrewed spacecraft (Spacecraft without people on board), Planetary flyby (Sending a space probe past a planet... The related trail points to NASA, Mariner 10, Uncrewed spacecraft, Planetary flyby, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For NASA, the detail work starts with the nouns inside the event itself: NASA's Mariner 10 became the first space probe to make a flyby of Mercury. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of March 29 is easy: NASA's Mariner 10 became the first space probe to make a flyby of Mercury. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-29");
