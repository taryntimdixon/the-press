...
window.PRESS_ON_THIS_DAY_DETAIL["01-18"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Sting operation.",
  ...
  "article": [
    ...
    {
      "text": "The short version of January 18 is easy: In a sting operation conducted by the FBI, Marion Barry, the mayor of Washington, D.C., was arrested for possession of crack cocaine. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
