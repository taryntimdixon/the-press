/* Detail payload for 01-14. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-14"] = {
  "date": "01-14",
  "displayDate": "January 14",
  "year": 2011,
  "title": "Arab Spring",
  "topic": "Arab Spring",
  "headline": "Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests.",
  "text": "Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests.",
  ...
  "dek": "Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 14"
  ...
  "summary": [
    "January 14, 2011, is not just a date label for Arab Spring. It is the point where a larger protest story becomes visible enough to study. Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Zine_El_Abidine_Ben_Ali",
      "description": "President of Tunisia from 1987 to 2011"
    },
    {
      "title": "Tunisian revolution",
      "source": "https://en.wikipedia.org/wiki/Tunisian_revolution",
      "description": "2010–2011 campaign of civil resistance"
    }
  ],
  "coolFacts": [
    "January 14 places the reader in 2011, inside a protest story with consequences beyond the date itself.",
  ...
  "article": [
    ...
    {
      "text": "January 14, 2011, is not just a date label for Arab Spring. It is the point where a larger protest story becomes visible enough to study. Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For Arab Spring, the detail work starts with the nouns inside the event itself: Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of January 14 is easy: Arab Spring: Tunisian president Zine El Abidine Ben Ali fled the country after several violent protests. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-14");
