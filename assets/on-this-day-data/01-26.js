...
window.PRESS_ON_THIS_DAY_DETAIL["01-26"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Apollo Theater.",
  ...
  "article": [
    ...
    {
      "text": "The short version of January 26 is easy: Hurtig & Seamon's New Burlesque Theater in New York City reopened as the Apollo Theater, becoming one of the nation's premier venues for African-American performers. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
