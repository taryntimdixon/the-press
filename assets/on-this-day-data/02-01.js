/* Detail payload for 02-01. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-01"] = {
  "date": "02-01",
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "1960 nonviolent protests in the United States"
    },
    {
      "title": "Woolworth",
      "source": "https://en.wikipedia.org/wiki/Woolworth",
      "description": "Retail company"
    },
    {
      "title": "Greensboro, North Carolina",
      "source": "https://en.wikipedia.org/wiki/Greensboro%2C_North_Carolina",
      "description": "City in North Carolina, United States"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Civil%20rights%20movement%201960&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=Civil%20rights%20movement%201960",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Civil%20rights%20movement%201960",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Civil%20rights%20movement%201960",
  ...
  "article": [
    ...
    {
      "text": "February 1, 1960, is not just a date label for Civil rights movement. It is the point where a larger rights and public power story becomes visible enough to study. Civil rights movement: Four African-American students staged the first of more than five months of sit-ins at an F. W. Woolworth lunch counter in Greensboro, North Carolina, to protest the company's policy of racial segregation. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-01");
