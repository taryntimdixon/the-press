/* Detail payload for 05-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-06"] = {
  "date": "05-06",
  "displayDate": "May 6",
  "year": 1998,
  "title": "Steve Jobs",
  "topic": "Steve Jobs",
  "headline": "Steve Jobs unveiled the iMac G3' personal computer.",
  ...
  "visual": "tech",
  "palette": "laboratory",
  "dek": "Steve Jobs unveiled the iMac G3' personal computer. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 6"
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "All-in-one computer by Apple"
    }
  ],
  "coolFacts": [
    "May 6 places the reader in 1998, inside a technology story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Steve%20Jobs%201998&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://www.si.edu/search?edan_q=Steve%20Jobs%201998",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Steve%20Jobs%201998",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Steve%20Jobs%201998",
  ...
  "article": [
    ...
    {
      "text": "May 6, 1998, is not just a date label for Steve Jobs. It is the point where a larger technology story becomes visible enough to study. Steve Jobs unveiled the iMac G3' personal computer. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Steve Jobs unveiled the iMac G3' personal computer. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 6, 1998, Steve Jobs unveiled the iMac G3' personal computer. Why it mattered: Steve Jobs matters because it changed how people used machines, networks, media, or information in everyday life. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies Steve Jobs as american businessman and inventor (1955–2011). Related subjects include Steve Jobs (American businessman and inventor (1955–2011)), IMac G3 (All-in-one computer by Apple). The lasting consequence was a faster information world: new tools changed how messages, images, money, work... The related trail points to Steve Jobs, IMac G3, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Steve Jobs, the detail work starts with the nouns inside the event itself: Steve Jobs unveiled the iMac G3' personal computer. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-06");
