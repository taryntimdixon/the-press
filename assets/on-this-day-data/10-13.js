/* Detail payload for 10-13. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-13"] = {
  "date": "10-13",
  ...
  "sourceDescription": "Kenyan long-distance runner",
  "visual": "rights",
  "palette": "public-square",
  "dek": "At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in... The deeper story is how this rights and public power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 13"
    ...
    {
      "label": "Source trail",
      "value": "Kenyan long-distance runner"
    }
  ],
  "summary": [
    "October 13, 2019, is not just a date label for Brigid Kosgei. It is the point where a larger rights and public power story becomes visible enough to study. At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a public institution or street-level confrontation where law, identity, courage, and pressure met in the open. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Brigid Kosgei belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1861,
  "related": [
    {
      "title": "2019 Chicago Marathon",
      "source": "https://en.wikipedia.org/wiki/2019_Chicago_Marathon",
      "description": "42nd edition of the event"
    },
    {
      "title": "Brigid Kosgei",
      "source": "https://en.wikipedia.org/wiki/Brigid_Kosgei",
      "description": "Kenyan long-distance runner"
    },
    {
      "title": "Marathon world record progression",
      "source": "https://en.wikipedia.org/wiki/Marathon_world_record_progression",
      "description": ""
    }
  ],
  "coolFacts": [
    "October 13 places the reader in 2019, inside a rights and public power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Brigid Kosgei.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Brigid Kosgei",
      "href": "https://commons.wikimedia.org/w/index.php?search=Brigid%20Kosgei%202019&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Brigid Kosgei",
      "href": "https://catalog.archives.gov/search?q=Brigid%20Kosgei%202019",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Brigid Kosgei",
      "href": "https://archive.org/search?query=Brigid%20Kosgei%202019",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Brigid Kosgei",
      "href": "https://www.britannica.com/search?query=Brigid%20Kosgei",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Brigid Kosgei",
      "href": "https://www.nytimes.com/search?query=Brigid%20Kosgei%202019",
  ...
  "article": [
    ...
    {
      "text": "October 13, 2019, is not just a date label for Brigid Kosgei. It is the point where a larger rights and public power story becomes visible enough to study. At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who could claim safety, dignity, citizenship, visibility, or equal treatment. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Brigid Kosgei matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as kenyan long-distance runner. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 13, 2019, At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. Why it mattered: Brigid Kosgei matters because it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. In the wider rights story, it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. The source record identifies Brigid Kosgei as kenyan long-distance runner. Related subjects include 2019 Chicago Marathon (42nd edition of the event), Brigid Kosgei (Kenyan long-distance runner), Marathon world record progression. The lasting consequence was a shift in who could claim protection, recognition, participation, or... The related trail points to 2019 Chicago Marathon, Brigid Kosgei, Marathon world record progression, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Brigid Kosgei into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Brigid Kosgei is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Brigid Kosgei, the detail work starts with the nouns inside the event itself: At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-13");
