...
window.PRESS_ON_THIS_DAY_DETAIL["10-13"] = {
  ...
  "dek": "At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. The deeper story is how this rights and public power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 13"
  ...
  "coolFacts": [
    ...
    "A useful starting source is Brigid Kosgei.",
  ...
  "article": [
    ...
    {
      "text": "The short version of October 13 is easy: At the Chicago Marathon, Kenyan runner Brigid Kosgei set the current marathon world record for women running in a mixed-sex race. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
