/* Detail payload for 10-14. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-14"] = {
  "date": "10-14",
  "displayDate": "October 14",
  "year": 1926,
  "title": "Winnie-the-Pooh (book)",
  "topic": "Winnie-the-Pooh (book)",
  "headline": "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published.",
  "text": "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published.",
  "source": "https://en.wikipedia.org/wiki/Winnie-the-Pooh_(book)",
  "sourceLabel": "Wikipedia: Winnie-the-Pooh (book)",
  "sourceDescription": "1926 book by A. A. Milne",
  "visual": "culture",
  "palette": "stage",
  "dek": "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 14"
    ...
    {
      "label": "Source trail",
      "value": "1926 book by A. A. Milne"
    }
  ],
  "summary": [
    "October 14, 1926, is not just a date label for Winnie-the-Pooh (book). It is the point where a larger culture story becomes visible enough to study. The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a theater, shop, studio, page, screen, or public crowd where an idea moved from private work into mass imagination. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Winnie-the-Pooh (book) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1829,
  "related": [
    {
      "title": "Winnie-the-Pooh (book)",
      "source": "https://en.wikipedia.org/wiki/Winnie-the-Pooh_(book)",
      "description": "1926 book by A. A. Milne"
    },
    {
      "title": "A. A. Milne",
      "source": "https://en.wikipedia.org/wiki/A._A._Milne",
      "description": "English writer (1882–1956)"
    },
    {
      "title": "Winnie-the-Pooh",
      "source": "https://en.wikipedia.org/wiki/Winnie-the-Pooh",
      "description": "Fictional character by A. A. Milne"
    }
  ],
  "coolFacts": [
    "October 14 places the reader in 1926, inside a culture story with consequences beyond the date itself.",
    "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published.",
    "The central source trail begins with Winnie-the-Pooh (book).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Winnie-the-Pooh (book)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Winnie-the-Pooh%20(book)%201926&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Winnie-the-Pooh (book)",
      "href": "https://www.si.edu/search?edan_q=Winnie-the-Pooh%20(book)%201926",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Winnie-the-Pooh (book)",
      "href": "https://archive.org/search?query=Winnie-the-Pooh%20(book)%201926",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Winnie-the-Pooh (book)",
      "href": "https://www.britannica.com/search?query=Winnie-the-Pooh%20(book)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Winnie-the-Pooh (book)",
      "href": "https://www.nytimes.com/search?query=Winnie-the-Pooh%20(book)%201926",
  ...
  "article": [
    ...
    {
      "text": "October 14, 1926, is not just a date label for Winnie-the-Pooh (book). It is the point where a larger culture story becomes visible enough to study. The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 14, 1926, the first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. Why it mattered: Winnie-the-Pooh (book) marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Winnie-the-Pooh (book) as 1926 book by A. A. Milne. Related subjects include Winnie-the-Pooh (book) (1926 book by A. A. Milne), A. A. Milne (English writer (1882–1956)), Winnie-the-Pooh (Fictional character by A. A. Milne). The lasting consequence was shared imagination: books... The related trail points to Winnie-the-Pooh (book), A. A. Milne, Winnie-the-Pooh, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Winnie-the-Pooh (book) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Winnie-the-Pooh (book) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Winnie-the-Pooh (book), the detail work starts with the nouns inside the event itself: The first book featuring English author A. A. Milne's fictional bear Winnie-the-Pooh was published. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-14");
