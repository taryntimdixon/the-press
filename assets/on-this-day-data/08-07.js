/* Detail payload for 08-07. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-07"] = {
  "date": "08-07",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "Principal railway route in Great Britain"
    }
  ],
  "summary": [
    ...
    "The strongest image for this entry is not a symbol floating in empty space. It is a route, vehicle, station, bridge, port, or horizon where distance started to feel different. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. East Coast Main Line belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1891,
  "related": [
    {
      "title": "Great Northern Railway (Great Britain)",
      "source": "https://en.wikipedia.org/wiki/Great_Northern_Railway_(Great_Britain)",
      "description": "British railway company, 1846 to 1922"
    },
    {
      "title": "East Coast Main Line",
      "source": "https://en.wikipedia.org/wiki/East_Coast_Main_Line",
      "description": "Principal railway route in Great Britain"
    }
  ],
  "coolFacts": [
    "August 7 places the reader in 1850, inside a transportation story with consequences beyond the date itself.",
    ...
    "The central source trail begins with East Coast Main Line.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: East Coast Main Line",
      "href": "https://commons.wikimedia.org/w/index.php?search=East%20Coast%20Main%20Line%201850&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: East Coast Main Line",
      "href": "https://www.si.edu/search?edan_q=East%20Coast%20Main%20Line%201850",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: East Coast Main Line",
      "href": "https://archive.org/search?query=East%20Coast%20Main%20Line%201850",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: East Coast Main Line",
      "href": "https://www.britannica.com/search?query=East%20Coast%20Main%20Line",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: East Coast Main Line",
      "href": "https://www.nytimes.com/search?query=East%20Coast%20Main%20Line%201850",
  ...
  "article": [
    ...
    {
      "text": "August 7, 1850, is not just a date label for East Coast Main Line. It is the point where a larger transportation story becomes visible enough to study. The first section of the Great Northern Railway, now the southern section of the East Coast Main Line, opened between London and Peterborough. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how bodies, goods, news, armies, families, and ambition moved through the world. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. East Coast Main Line matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as principal railway route in Great Britain. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten East Coast Main Line into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. East Coast Main Line is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-07");
