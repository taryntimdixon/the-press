/* Detail payload for 10-08. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-08"] = {
  "date": "10-08",
  "displayDate": "October 8",
  "year": 1967,
  "title": "Che Guevara",
  "topic": "Che Guevara",
  "headline": "Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia.",
  ...
  "sourceLabel": "Wikipedia: Che Guevara",
  "sourceDescription": "Argentine revolutionary (1928–1967)",
  "visual": "crime",
  "palette": "dispatch",
  "dek": "Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. The deeper story is how this crime and accountability moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 8"
    ...
    {
      "label": "Source trail",
      "value": "Argentine revolutionary (1928–1967)"
    }
  ],
  "summary": [
    "October 8, 1967, is not just a date label for Che Guevara. It is the point where a larger crime and accountability story becomes visible enough to study. Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a hallway, office, courtroom, evidence table, newsroom, or police setting where a case became bigger than the act itself. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Che Guevara belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1821,
  "related": [
    {
      "title": "Marxism",
      "source": "https://en.wikipedia.org/wiki/Marxism",
      "description": "Political philosophy"
    },
    {
      "title": "Guerrilla warfare",
      "source": "https://en.wikipedia.org/wiki/Guerrilla_warfare",
      "description": "Warfare by small groups against regular forces"
    },
    {
      "title": "Che Guevara",
      "source": "https://en.wikipedia.org/wiki/Che_Guevara",
      "description": "Argentine revolutionary (1928–1967)"
    },
    {
      "title": "La Higuera",
      "source": "https://en.wikipedia.org/wiki/La_Higuera",
      "description": "Place in Santa Cruz, Bolivia"
    }
  ],
  "coolFacts": [
    "October 8 places the reader in 1967, inside a crime and accountability story with consequences beyond the date itself.",
    "Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia.",
    "The central source trail begins with Che Guevara.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Che Guevara",
      "href": "https://commons.wikimedia.org/w/index.php?search=Che%20Guevara%201967&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Che Guevara",
      "href": "https://catalog.archives.gov/search?q=Che%20Guevara%201967",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Che Guevara",
      "href": "https://archive.org/search?query=Che%20Guevara%201967",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Che Guevara",
      "href": "https://www.britannica.com/search?query=Che%20Guevara",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Che Guevara",
      "href": "https://www.nytimes.com/search?query=Che%20Guevara%201967",
  ...
  "article": [
    ...
    {
      "text": "October 8, 1967, is not just a date label for Che Guevara. It is the point where a larger crime and accountability story becomes visible enough to study. Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 8, 1967, Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. Why it mattered: Che Guevara matters because it exposed how law, evidence, fear, media attention, and state power collided in public. In the wider crime story, it exposed how law, evidence, fear, media attention, and state power collided in public. The source record identifies Che Guevara as argentine revolutionary (1928–1967). Related subjects include Marxism (Political philosophy), Guerrilla warfare (Warfare by small groups against regular forces), Che Guevara (Argentine revolutionary (1928–1967)), La Higuera (Place in Santa Cruz, Bolivia). The lasting consequence was a public test... The related trail points to Marxism, Guerrilla warfare, Che Guevara, La Higuera, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Che Guevara into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Che Guevara is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Che Guevara, the detail work starts with the nouns inside the event itself: Marxist revolutionary and guerrilla leader Che Guevara was captured near La Higuera, Bolivia. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-08");
