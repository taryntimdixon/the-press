/* Detail payload for 10-18. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-18"] = {
  "date": "10-18",
  "displayDate": "October 18",
  "year": 1873,
  "title": "Renton F.C.",
  "topic": "Renton F.C.",
  "headline": "Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup.",
  "text": "Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup.",
  "source": "https://en.wikipedia.org/wiki/Renton_F.C.",
  "sourceLabel": "Wikipedia: Renton F.C.",
  "sourceDescription": "Former association football club in Scotland",
  "visual": "sports",
  "palette": "public-square",
  "dek": "Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 18"
  ...
  "related": [
    {
      "title": "Renton F.C.",
      "source": "https://en.wikipedia.org/wiki/Renton_F.C.",
      "description": "Former association football club in Scotland"
    },
    {
      "title": "Kilmarnock F.C.",
      "source": "https://en.wikipedia.org/wiki/Kilmarnock_F.C.",
      "description": "Association football club in Kilmarnock, Scotland"
    },
    {
      "title": "1873–74 Scottish Cup",
      "source": "https://en.wikipedia.org/wiki/1873%E2%80%9374_Scottish_Cup",
      "description": "Inaugural Scottish Cup football competition"
    }
  ],
  "coolFacts": [
    "October 18 places the reader in 1873, inside a history story with consequences beyond the date itself.",
    "Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup.",
    "The central source trail begins with Renton F.C..",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Renton F.C.",
      "href": "https://commons.wikimedia.org/w/index.php?search=Renton%20F.C.%201873&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Renton F.C.",
      "href": "https://www.si.edu/search?edan_q=Renton%20F.C.%201873",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Renton F.C.",
      "href": "https://archive.org/search?query=Renton%20F.C.%201873",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Renton F.C.",
      "href": "https://www.britannica.com/search?query=Renton%20F.C.",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Renton F.C.",
      "href": "https://www.nytimes.com/search?query=Renton%20F.C.%201873",
  ...
  "article": [
    ...
    {
      "text": "October 18, 1873, is not just a date label for Renton F.C.. It is the point where a larger history story becomes visible enough to study. Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Renton F.C. matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as former association football club in Scotland. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 18, 1873, Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup. Why it mattered: Renton F.C. matters because it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own limits. The source record identifies Renton F.C. as former association football club in Scotland. Related subjects include Renton F.C. (Former association football club in Scotland), Kilmarnock F.C. (Association football club in Kilmarnock, Scotland), 1873–74 Scottish Cup (Inaugural Scottish Cup football competition). The lasting consequence was... The related trail points to Renton F.C., Kilmarnock F.C., 1873–74 Scottish Cup, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Renton F.C., the detail work starts with the nouns inside the event itself: Renton defeated Kilmarnock 2–0 in the opening match of the inaugural Scottish Cup. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-18");
