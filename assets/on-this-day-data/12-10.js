/* Detail payload for 12-10. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-10"] = {
  "date": "12-10",
  "displayDate": "December 10",
  "year": 1993,
  "title": "First-person shooter",
  "topic": "First-person shooter",
  "headline": "The video game Doom, later considered the \"father\" of the first-person shooter genre, is released.",
  "text": "The video game Doom, later considered the \"father\" of the first-person shooter genre, is released.",
  "source": "https://en.wikipedia.org/wiki/First-person_shooter",
  "sourceLabel": "Wikipedia: First-person shooter",
  "sourceDescription": "Video game genre",
  "visual": "tech",
  "palette": "laboratory",
  "dek": "The video game Doom, later considered the \"father\" of the first-person shooter genre, is released. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 10"
  ...
  "coolFacts": [
    "December 10 places the reader in 1993, inside a technology story with consequences beyond the date itself.",
    "The video game Doom, later considered the \"father\" of the first-person shooter genre, is released.",
    "The central source trail begins with First-person shooter.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: First-person shooter",
      "href": "https://commons.wikimedia.org/w/index.php?search=First-person%20shooter%201993&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: First-person shooter",
      "href": "https://www.si.edu/search?edan_q=First-person%20shooter%201993",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: First-person shooter",
      "href": "https://archive.org/search?query=First-person%20shooter%201993",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: First-person shooter",
      "href": "https://www.britannica.com/search?query=First-person%20shooter",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: First-person shooter",
      "href": "https://www.nytimes.com/search?query=First-person%20shooter%201993",
  ...
  "article": [
    ...
    {
      "text": "December 10, 1993, is not just a date label for First-person shooter. It is the point where a larger technology story becomes visible enough to study. The video game Doom, later considered the \"father\" of the first-person shooter genre, is released. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The video game Doom, later considered the \"father\" of the first-person shooter genre, is released. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. First-person shooter matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as video game genre. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 10, 1993, the video game Doom, later considered the \"father\" of the first-person shooter genre, is released. Why it mattered: First-person shooter marked a first, and it changed how people used machines, networks, media, or information in everyday life. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies First-person shooter as video game genre. Related subjects include Doom (1993 video game) (First-person shooter), First-person shooter (Video game genre). The lasting consequence was a faster information world: new tools changed how messages, images, money, work, or culture moved through... The related trail points to Doom (1993 video game), First-person shooter, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten First-person shooter into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. First-person shooter is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For First-person shooter, the detail work starts with the nouns inside the event itself: The video game Doom, later considered the \"father\" of the first-person shooter genre, is released. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-10");
