...
window.PRESS_ON_THIS_DAY_DETAIL["11-21"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Valemount.",
  ...
  "article": [
    ...
    {
      "text": "The short version of November 21 is easy: Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker to greater political attention. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
