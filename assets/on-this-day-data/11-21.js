/* Detail payload for 11-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-21"] = {
  "date": "11-21",
  ...
  "sourceDescription": "Village in British Columbia, Canada",
  "visual": "crime",
  "palette": "dispatch",
  "dek": "Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker... The deeper story is how this crime and accountability moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 21"
    ...
    {
      "label": "Source trail",
      "value": "Village in British Columbia, Canada"
    }
  ],
  "summary": [
    "November 21, 1950, is not just a date label for Valemount. It is the point where a larger crime and accountability story becomes visible enough to study. Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker to greater political attention. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a hallway, office, courtroom, evidence table, newsroom, or police setting where a case became bigger than the act itself. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Valemount belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1849,
  "related": [
    {
      "title": "Canoe River train crash",
      "source": "https://en.wikipedia.org/wiki/Canoe_River_train_crash",
      "description": "1950 train crash in British Columbia, Canada"
    },
    {
      "title": "Valemount",
      "source": "https://en.wikipedia.org/wiki/Valemount",
    ...
    },
    {
      ...
      "description": "Prime Minister of Canada from 1957 to 1963"
    }
  ],
  "coolFacts": [
    "November 21 places the reader in 1950, inside a crime and accountability story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Valemount.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Valemount",
      "href": "https://commons.wikimedia.org/w/index.php?search=Valemount%201950&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Valemount",
      "href": "https://catalog.archives.gov/search?q=Valemount%201950",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Valemount",
      "href": "https://archive.org/search?query=Valemount%201950",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Valemount",
      "href": "https://www.britannica.com/search?query=Valemount",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Valemount",
      "href": "https://www.nytimes.com/search?query=Valemount%201950",
  ...
  "article": [
    ...
    {
      "text": "November 21, 1950, is not just a date label for Valemount. It is the point where a larger crime and accountability story becomes visible enough to study. Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker to greater political attention. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed public trust, institutions, law enforcement, media attention, or constitutional pressure. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Valemount matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as village in British Columbia, Canada. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 21, 1950, Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker to greater political attention. Why it mattered: Valemount matters because it exposed how law, evidence, fear, media attention, and state power collided in public. In the wider crime story, it exposed how law, evidence, fear, media attention, and state power collided in public. The source record identifies Valemount as village in British Columbia, Canada. Related subjects include Canoe River train crash (1950 train crash in British Columbia, Canada), Valemount (Village in British Columbia, Canada), John Diefenbaker (Prime Minister of Canada from 1957 to 1963). The lasting consequence... The related trail points to Canoe River train crash, Valemount, John Diefenbaker, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Valemount into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "For Valemount, the detail work starts with the nouns inside the event itself: Two trains collided near Valemount, Canada, killing 21 people; the subsequent trial brought future prime minister John Diefenbaker to greater political attention. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-21");
