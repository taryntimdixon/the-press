/* Detail payload for 11-23. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-23"] = {
  "date": "11-23",
  "displayDate": "November 23",
  "year": 2003,
  "title": "Rose Revolution",
  "topic": "Rose Revolution",
  "headline": "Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results.",
  "text": "Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results.",
  "source": "https://en.wikipedia.org/wiki/Rose_Revolution",
  "sourceLabel": "Wikipedia: Rose Revolution",
  "sourceDescription": "2003 popular uprising in Georgia",
  "visual": "protest",
  "palette": "public-square",
  "dek": "Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results. The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 23"
  ...
  "related": [
    {
      "title": "Rose Revolution",
      "source": "https://en.wikipedia.org/wiki/Rose_Revolution",
      "description": "2003 popular uprising in Georgia"
    },
    {
      "title": "Eduard Shevardnadze",
      "source": "https://en.wikipedia.org/wiki/Eduard_Shevardnadze",
      "description": "Georgian politician and diplomat (1928–2014)"
    },
    {
      "title": "President of Georgia",
      "source": "https://en.wikipedia.org/wiki/President_of_Georgia",
      "description": "Head of state of Georgia"
    },
    {
      "title": "2003 Georgian parliamentary election",
      "source": "https://en.wikipedia.org/wiki/2003_Georgian_parliamentary_election",
      "description": ""
    }
  ],
  "coolFacts": [
    "November 23 places the reader in 2003, inside a protest story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Rose Revolution.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Rose Revolution",
      "href": "https://commons.wikimedia.org/w/index.php?search=Rose%20Revolution%202003&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Rose Revolution",
      "href": "https://catalog.archives.gov/search?q=Rose%20Revolution%202003",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Rose Revolution",
      "href": "https://archive.org/search?query=Rose%20Revolution%202003",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Rose Revolution",
      "href": "https://www.britannica.com/search?query=Rose%20Revolution",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Rose Revolution",
      "href": "https://www.nytimes.com/search?query=Rose%20Revolution%202003",
  ...
  "article": [
    ...
    {
      "text": "November 23, 2003, is not just a date label for Rose Revolution. It is the point where a larger protest story becomes visible enough to study. Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed the emotional temperature of politics and showed what pressure from below could do. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Rose Revolution matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 2003 popular uprising in Georgia. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 23, 2003, Rose Revolution: Eduard Shevardnadze resigned as President of Georgia following weeks of mass protests over disputed election results. Why it mattered: Rose Revolution matters because it showed public pressure becoming a political force rather than background noise. In the wider protest story, it showed public pressure becoming a political force rather than background noise. The source record identifies Rose Revolution as 2003 popular uprising in Georgia. Related subjects include Rose Revolution (2003 popular uprising in Georgia), Eduard Shevardnadze (Georgian politician and diplomat (1928–2014)), President of Georgia (Head of state of Georgia), 2003 Georgian parliamentary election. The lasting consequence... The related trail points to Rose Revolution, Eduard Shevardnadze, President of Georgia, 2003 Georgian parliamentary election, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Rose Revolution into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Rose Revolution is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-23");
