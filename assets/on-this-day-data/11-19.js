/* Detail payload for 11-19. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-19"] = {
  "date": "11-19",
  "displayDate": "November 19",
  "year": 1969,
  "title": "Pelé",
  "topic": "Pelé",
  "headline": "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal.",
  "text": "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal.",
  "source": "https://en.wikipedia.org/wiki/Pel%C3%A9",
  "sourceLabel": "Wikipedia: Pelé",
  "sourceDescription": "Brazilian footballer (1940–2022)",
  "visual": "sports",
  "palette": "public-square",
  "dek": "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 19"
    ...
    {
      "label": "Source trail",
      "value": "Brazilian footballer (1940–2022)"
    }
  ],
  "summary": [
    "November 19, 1969, is not just a date label for Pelé. It is the point where a larger history story becomes visible enough to study. Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a recorded setting where documents, eyewitnesses, objects, and later memory keep pulling one date back into view. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Pelé belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1836,
  "related": [
    {
      ...
      "description": "Association football club in Brazil"
    },
    {
      "title": "CR Vasco da Gama",
      "source": "https://en.wikipedia.org/wiki/CR_Vasco_da_Gama",
      "description": "Brazilian football club"
    },
    {
      "title": "Pelé",
      "source": "https://en.wikipedia.org/wiki/Pel%C3%A9",
  ...
  "coolFacts": [
    "November 19 places the reader in 1969, inside a history story with consequences beyond the date itself.",
    "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal.",
    "The central source trail begins with Pelé.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Pelé",
      "href": "https://commons.wikimedia.org/w/index.php?search=Pel%C3%A9%201969&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Pelé",
      "href": "https://www.si.edu/search?edan_q=Pel%C3%A9%201969",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Pelé",
      "href": "https://archive.org/search?query=Pel%C3%A9%201969",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Pelé",
      "href": "https://www.britannica.com/search?query=Pel%C3%A9",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Pelé",
      "href": "https://www.nytimes.com/search?query=Pel%C3%A9%201969",
  ...
  "article": [
    ...
    {
      "text": "November 19, 1969, is not just a date label for Pelé. It is the point where a larger history story becomes visible enough to study. Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Pelé matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as brazilian footballer (1940–2022). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 19, 1969, Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. Why it mattered: Pelé matters because it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own limits. The source record identifies Pelé as brazilian footballer (1940–2022). Related subjects include Santos FC (Association football club in Brazil), CR Vasco da Gama (Brazilian football club), Pelé (Brazilian footballer (1940–2022)). The lasting consequence was public memory: a contest, athlete, record, or spectacle gave fans... The related trail points to Santos FC, CR Vasco da Gama, Pelé, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Pelé is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Pelé, the detail work starts with the nouns inside the event itself: Playing for Santos against Vasco da Gama in Rio de Janeiro, Brazilian footballer Pelé scored his thousandth goal. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-19");
