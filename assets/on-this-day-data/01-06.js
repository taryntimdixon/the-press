/* Detail payload for 01-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-06"] = {
  "date": "01-06",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "Italian physician and educator (1870–1952)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Maria Montessori",
      "source": "https://en.wikipedia.org/wiki/Maria_Montessori",
      "description": "Italian physician and educator (1870–1952)"
    },
    {
      "title": "Montessori education",
      "source": "https://en.wikipedia.org/wiki/Montessori_education",
      "description": "Teaching method encouraging autodidacticism"
    }
  ],
  "coolFacts": [
    "January 6 places the reader in 1907, inside a history story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Maria Montessori.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Maria Montessori",
      "href": "https://commons.wikimedia.org/w/index.php?search=Maria%20Montessori%201907&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Maria Montessori",
      "href": "https://www.si.edu/search?edan_q=Maria%20Montessori%201907",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Maria Montessori",
      "href": "https://archive.org/search?query=Maria%20Montessori%201907",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Maria Montessori",
      "href": "https://www.britannica.com/search?query=Maria%20Montessori",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Maria Montessori",
      "href": "https://www.nytimes.com/search?query=Maria%20Montessori%201907",
  ...
  "article": [
    ...
    {
      "text": "January 6, 1907, is not just a date label for Maria Montessori. It is the point where a larger history story becomes visible enough to study. Italian educator Maria Montessori opened her first school and day-care centre for working-class children in Rome, employing a philosophy of education that now bears her name. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Maria Montessori matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as italian physician and educator (1870–1952). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Maria Montessori is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Maria Montessori, the detail work starts with the nouns inside the event itself: Italian educator Maria Montessori opened her first school and day-care centre for working-class children in Rome, employing a philosophy of education that now bears her name. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-06");
