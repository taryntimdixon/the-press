/* Detail payload for 11-27. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-27"] = {
  "date": "11-27",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "Former Colombian drug cartel"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Medellín Cartel",
      "source": "https://en.wikipedia.org/wiki/Medell%C3%ADn_Cartel",
      "description": "Former Colombian drug cartel"
    },
    {
      "title": "César Gaviria",
      "source": "https://en.wikipedia.org/wiki/C%C3%A9sar_Gaviria",
      "description": "Colombian economist and politician (born 1947)"
    },
    {
      "title": "Avianca Flight 203",
      "source": "https://en.wikipedia.org/wiki/Avianca_Flight_203",
      "description": "1989 airliner bombing in Colombia"
    }
  ],
  "coolFacts": [
    "November 27 places the reader in 1989, inside a crime and accountability story with consequences beyond the date itself.",
    "A bomb placed by the Medellín Cartel in an attempt to kill Colombian presidential candidate César Gaviria destroyed Avianca Flight 203, killing all 107 people on board, excluding Gaviria, who was not on the flight.",
    "The central source trail begins with Medellín Cartel.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Medellín Cartel",
      "href": "https://commons.wikimedia.org/w/index.php?search=Medell%C3%ADn%20Cartel%201989&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Medellín Cartel",
      "href": "https://catalog.archives.gov/search?q=Medell%C3%ADn%20Cartel%201989",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Medellín Cartel",
      "href": "https://archive.org/search?query=Medell%C3%ADn%20Cartel%201989",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Medellín Cartel",
      "href": "https://www.britannica.com/search?query=Medell%C3%ADn%20Cartel",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Medellín Cartel",
      "href": "https://www.nytimes.com/search?query=Medell%C3%ADn%20Cartel%201989",
  ...
  "article": [
    ...
    {
      "text": "November 27, 1989, is not just a date label for Medellín Cartel. It is the point where a larger crime and accountability story becomes visible enough to study. A bomb placed by the Medellín Cartel in an attempt to kill Colombian presidential candidate César Gaviria destroyed Avianca Flight 203, killing all 107 people on board, excluding Gaviria, who was not on the flight. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-27");
