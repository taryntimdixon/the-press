/* Detail payload for 12-12. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-12"] = {
  "date": "12-12",
  ...
  "sourceDescription": "Military rulers of Greece, 1967–1974",
  "visual": "rights",
  "palette": "public-square",
  "dek": "The Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of... The deeper story is how this rights and public power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 12"
    ...
    {
      "label": "Source trail",
      "value": "Military rulers of Greece, 1967–1974"
    }
  ],
  "summary": [
    "December 12, 1969, is not just a date label for Greek junta. It is the point where a larger rights and public power story becomes visible enough to study. The Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of torture and other human-rights violations by the European Commission of Human Rights. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a public institution or street-level confrontation where law, identity, courage, and pressure met in the open. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Greek junta belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1908,
  "related": [
    {
      "title": "Greek junta",
      "source": "https://en.wikipedia.org/wiki/Greek_junta",
      "description": "Military rulers of Greece, 1967–1974"
    },
    {
      "title": "Greece in the Council of Europe",
      "source": "https://en.wikipedia.org/wiki/Greece_in_the_Council_of_Europe",
      "description": ""
    },
    {
      "title": "Greek case",
      "source": "https://en.wikipedia.org/wiki/Greek_case",
      "description": "1967 human rights case against Greece"
    },
    {
      "title": "European Commission of Human Rights",
      "source": "https://en.wikipedia.org/wiki/European_Commission_of_Human_Rights",
      "description": "Former body of the Council of Europe"
    }
  ],
  "coolFacts": [
    "December 12 places the reader in 1969, inside a rights and public power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Greek junta.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Greek junta",
      "href": "https://commons.wikimedia.org/w/index.php?search=Greek%20junta%201969&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Greek junta",
      "href": "https://catalog.archives.gov/search?q=Greek%20junta%201969",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Greek junta",
      "href": "https://archive.org/search?query=Greek%20junta%201969",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Greek junta",
      "href": "https://www.britannica.com/search?query=Greek%20junta",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Greek junta",
      "href": "https://www.nytimes.com/search?query=Greek%20junta%201969",
  ...
  "article": [
    ...
    {
      "text": "December 12, 1969, is not just a date label for Greek junta. It is the point where a larger rights and public power story becomes visible enough to study. The Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of torture and other human-rights violations by the European Commission of Human Rights. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who could claim safety, dignity, citizenship, visibility, or equal treatment. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Greek junta matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as military rulers of Greece, 1967–1974. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 12, 1969, the Greek junta announced its withdrawal from the Council of Europe after the junta was found guilty of torture and other human-rights violations by the European Commission of Human Rights. Why it mattered: Greek junta matters because it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. In the wider rights story, it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. The source record identifies Greek junta as military rulers of Greece, 1967–1974. Related subjects include Greek junta (Military rulers of Greece, 1967–1974), Greece in the Council of Europe, Greek case (1967 human rights case against Greece), European Commission of Human Rights (Former body of... The related trail points to Greek junta, Greece in the Council of Europe, Greek case, European Commission of Human Rights, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Greek junta into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-12");
