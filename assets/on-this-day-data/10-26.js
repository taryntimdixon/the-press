/* Detail payload for 10-26. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-26"] = {
  "date": "10-26",
  ...
  "related": [
    ...
    {
      "title": "List of video games listed among the best",
      "source": "https://en.wikipedia.org/wiki/List_of_video_games_listed_among_the_best",
      "description": ""
    }
  ],
  "coolFacts": [
    "October 26 places the reader in 2004, inside a technology story with consequences beyond the date itself.",
    "Rockstar Games released Grand Theft Auto: San Andreas, considered one of the best video games ever made, in North America.",
    "The central source trail begins with Grand Theft Auto: San Andreas.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Grand Theft Auto: San Andreas",
      "href": "https://commons.wikimedia.org/w/index.php?search=Grand%20Theft%20Auto%3A%20San%20Andreas%202004&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Grand Theft Auto: San Andreas",
      "href": "https://www.si.edu/search?edan_q=Grand%20Theft%20Auto%3A%20San%20Andreas%202004",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Grand Theft Auto: San Andreas",
      "href": "https://archive.org/search?query=Grand%20Theft%20Auto%3A%20San%20Andreas%202004",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Grand Theft Auto: San Andreas",
      "href": "https://www.britannica.com/search?query=Grand%20Theft%20Auto%3A%20San%20Andreas",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Grand Theft Auto: San Andreas",
      "href": "https://www.nytimes.com/search?query=Grand%20Theft%20Auto%3A%20San%20Andreas%202004",
  ...
  "article": [
    ...
    {
      "text": "October 26, 2004, is not just a date label for Grand Theft Auto: San Andreas. It is the point where a larger technology story becomes visible enough to study. Rockstar Games released Grand Theft Auto: San Andreas, considered one of the best video games ever made, in North America. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Grand Theft Auto: San Andreas matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as 2004 video game. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-26");
