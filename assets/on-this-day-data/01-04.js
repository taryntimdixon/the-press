/* Detail payload for 01-04. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-04"] = {
  "date": "01-04",
  "displayDate": "January 4",
  "year": 2004,
  "title": "Spirit (rover)",
  "topic": "Spirit (rover)",
  "headline": "Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars.",
  ...
  "sourceDescription": "Former NASA Mars rover, active from 2004 to 2010",
  "visual": "space",
  "palette": "lunar",
  "dek": "Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 4"
    ...
    {
      "label": "Source trail",
      "value": "Former NASA Mars rover, active from 2004 to 2010"
    }
  ],
  "summary": [
    "January 4, 2004, is not just a date label for Spirit (rover). It is the point where a larger space exploration story becomes visible enough to study. Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Spirit (rover) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1850,
  "related": [
    {
      "title": "Spirit (rover)",
      "source": "https://en.wikipedia.org/wiki/Spirit_(rover)",
      "description": "Former NASA Mars rover, active from 2004 to 2010"
    },
    {
      "title": "Rover (space exploration)",
      "source": "https://en.wikipedia.org/wiki/Rover_(space_exploration)",
      "description": "Planetary surface exploration vehicle"
    },
    {
      "title": "NASA",
  ...
  "coolFacts": [
    "January 4 places the reader in 2004, inside a space exploration story with consequences beyond the date itself.",
    "Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars.",
    "The central source trail begins with Spirit (rover).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Spirit (rover)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Spirit%20(rover)%202004&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Spirit (rover)",
      "href": "https://www.nasa.gov/search/?search=Spirit%20(rover)%202004",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Spirit (rover)",
      "href": "https://archive.org/search?query=Spirit%20(rover)%202004",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Spirit (rover)",
      "href": "https://www.britannica.com/search?query=Spirit%20(rover)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Spirit (rover)",
      "href": "https://www.nytimes.com/search?query=Spirit%20(rover)%202004",
  ...
  "article": [
    ...
    {
      "text": "January 4, 2004, is not just a date label for Spirit (rover). It is the point where a larger space exploration story becomes visible enough to study. Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Spirit (rover) matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as former NASA Mars rover, active from 2004 to 2010. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Spirit (rover) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Spirit (rover) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Spirit (rover), the detail work starts with the nouns inside the event itself: Spirit, the first of two rovers of NASA's Mars Exploration Rover mission, successfully landed on Mars. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-04");
