/* Detail payload for 11-14. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-14"] = {
  "date": "11-14",
  ...
  "sourceDescription": "NASA launch facility in Florida",
  "visual": "space",
  "palette": "lunar",
  "dek": "Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 14"
    ...
    {
      "label": "Source trail",
      "value": "NASA launch facility in Florida"
    }
  ],
  "summary": [
    "November 14, 1969, is not just a date label for Kennedy Space Center. It is the point where a larger space exploration story becomes visible enough to study. Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the Moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Kennedy Space Center belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1867,
  "related": [
    {
    ...
    },
    {
      "title": "Kennedy Space Center",
      "source": "https://en.wikipedia.org/wiki/Kennedy_Space_Center",
      "description": "NASA launch facility in Florida"
    }
  ],
  "coolFacts": [
    "November 14 places the reader in 1969, inside a space exploration story with consequences beyond the date itself.",
    "Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the Moon.",
    "The central source trail begins with Kennedy Space Center.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Kennedy Space Center",
      "href": "https://commons.wikimedia.org/w/index.php?search=Kennedy%20Space%20Center%201969&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Kennedy Space Center",
      "href": "https://www.nasa.gov/search/?search=Kennedy%20Space%20Center%201969",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Kennedy Space Center",
      "href": "https://archive.org/search?query=Kennedy%20Space%20Center%201969",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Kennedy Space Center",
      "href": "https://www.britannica.com/search?query=Kennedy%20Space%20Center",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Kennedy Space Center",
      "href": "https://www.nytimes.com/search?query=Kennedy%20Space%20Center%201969",
  ...
  "article": [
    ...
    {
      "text": "November 14, 1969, is not just a date label for Kennedy Space Center. It is the point where a larger space exploration story becomes visible enough to study. Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the Moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Kennedy Space Center matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as nASA launch facility in Florida. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 14, 1969, Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the Moon. Why it mattered: Kennedy Space Center put a new mission, institution, product, or public force into motion, and it pushed space exploration into a new. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation... The source record identifies Kennedy Space Center as nASA launch facility in Florida. Related subjects include Apollo 12 (Second crewed Moon landing), Kennedy Space Center (NASA launch facility in Florida). The lasting consequence was a larger map of what humans and their machines could... The related trail points to Apollo 12, Kennedy Space Center, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Kennedy Space Center into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Kennedy Space Center is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Kennedy Space Center, the detail work starts with the nouns inside the event itself: Apollo 12 launched from the Kennedy Space Center, later becoming the second crewed flight to land on the Moon. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-14");
