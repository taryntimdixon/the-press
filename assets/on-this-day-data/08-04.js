/* Detail payload for 08-04. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-04"] = {
  "date": "08-04",
  "displayDate": "August 4",
  "year": 1830,
  "title": "James Thompson (surveyor)",
  "topic": "James Thompson (surveyor)",
  "headline": "American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners.",
  ...
  "sourceLabel": "Wikipedia: James Thompson (surveyor)",
  "sourceDescription": "American surveyor (1789–1872)",
  "visual": "transport",
  "palette": "voyage",
  "dek": "American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. The deeper story is how this transportation moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 4"
    ...
    {
      "label": "Source trail",
      "value": "American surveyor (1789–1872)"
    }
  ],
  "summary": [
    "August 4, 1830, is not just a date label for James Thompson (surveyor). It is the point where a larger transportation story becomes visible enough to study. American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a route, vehicle, station, bridge, port, or horizon where distance started to feel different. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. James Thompson (surveyor) belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1849,
  "related": [
    {
      "title": "James Thompson (surveyor)",
      "source": "https://en.wikipedia.org/wiki/James_Thompson_(surveyor)",
      "description": "American surveyor (1789–1872)"
    },
    {
      "title": "Plat",
      "source": "https://en.wikipedia.org/wiki/Plat",
      "description": "Map showing divisions of a piece of land in the US"
    }
  ],
  "coolFacts": [
    "August 4 places the reader in 1830, inside a transportation story with consequences beyond the date itself.",
    "American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners.",
    "The central source trail begins with James Thompson (surveyor).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: James Thompson (surveyor)",
      "href": "https://commons.wikimedia.org/w/index.php?search=James%20Thompson%20(surveyor)%201830&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: James Thompson (surveyor)",
      "href": "https://www.si.edu/search?edan_q=James%20Thompson%20(surveyor)%201830",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: James Thompson (surveyor)",
      "href": "https://archive.org/search?query=James%20Thompson%20(surveyor)%201830",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: James Thompson (surveyor)",
      "href": "https://www.britannica.com/search?query=James%20Thompson%20(surveyor)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: James Thompson (surveyor)",
      "href": "https://www.nytimes.com/search?query=James%20Thompson%20(surveyor)%201830",
  ...
  "article": [
    ...
    {
      "text": "August 4, 1830, is not just a date label for James Thompson (surveyor). It is the point where a larger transportation story becomes visible enough to study. American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 4, 1830, American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. Why it mattered: James Thompson (surveyor) marked a first, and it changed how people, goods, risk, distance, or rescue moved across the world. In the wider transport story, it changed how people, goods, risk, distance, or rescue moved across the world. The source record identifies James Thompson (surveyor) as american surveyor (1789–1872). Related subjects include James Thompson (surveyor) (American surveyor (1789–1872)), Plat (Map showing divisions of a piece of land in the US). The lasting consequence was movement: people, goods, danger, rescue, or infrastructure crossed... The related trail points to James Thompson (surveyor), Plat, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For James Thompson (surveyor), the detail work starts with the nouns inside the event itself: American surveyor James Thompson produced the first plat of Chicago for the Illinois and Michigan Canal Commissioners. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-04");
