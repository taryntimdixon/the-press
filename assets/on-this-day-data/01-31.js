/* Detail payload for 01-31. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-31"] = {
  "date": "01-31",
  "displayDate": "January 31",
  "year": 1961,
  "title": "NASA",
  "topic": "NASA",
  "headline": "Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space.",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 31"
    ...
    {
      "label": "Source trail",
      "value": "American space and aeronautics agency"
    }
  ],
  "summary": [
    "January 31, 1961, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a mission environment where hardware, risk, mathematics, weather, and public imagination had to line up. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. NASA belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1838,
  "related": [
    {
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Mercury-Redstone_2",
      "description": "1961 American space flight"
    },
    {
      "title": "Ham (chimpanzee)",
      "source": "https://en.wikipedia.org/wiki/Ham_(chimpanzee)",
      "description": "First great ape launched into space (1957–1983)"
    },
    {
      "title": "Hominidae",
      "source": "https://en.wikipedia.org/wiki/Hominidae",
      "description": "Family of primates"
    }
  ],
  "coolFacts": [
    "January 31 places the reader in 1961, inside a space exploration story with consequences beyond the date itself.",
    "Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space.",
    "The central source trail begins with NASA.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: NASA",
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%201961&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%201961",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: NASA",
      "href": "https://archive.org/search?query=NASA%201961",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: NASA",
      "href": "https://www.britannica.com/search?query=NASA",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: NASA",
      "href": "https://www.nytimes.com/search?query=NASA%201961",
  ...
  "article": [
    ...
    {
      "text": "January 31, 1961, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On January 31, 1961, Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. Why it mattered: NASA marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public... The source record identifies NASA as american space and aeronautics agency. Related subjects include NASA (American space and aeronautics agency), Mercury-Redstone 2 (1961 American space flight), Ham (chimpanzee) (First great ape launched into space (1957–1983)), Hominidae (Family of primates). The lasting consequence was a... The related trail points to NASA, Mercury-Redstone 2, Ham (chimpanzee), Hominidae, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. NASA is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For NASA, the detail work starts with the nouns inside the event itself: Aboard NASA's Mercury-Redstone 2, the chimpanzee Ham became the first hominid to be launched into outer space. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-31");
