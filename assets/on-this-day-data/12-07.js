/* Detail payload for 12-07. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-07"] = {
  "date": "12-07",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 7"
  ...
  "summary": [
    "December 7, 1995, is not just a date label for Galileo (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space Shuttle Atlantis during Mission STS-34. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "Space Shuttle orbiter (1985–2011)"
    },
    {
      "title": "STS-34",
      "source": "https://en.wikipedia.org/wiki/STS-34",
      "description": "1989 American crewed spaceflight to deploy Galileo"
    }
  ],
  "coolFacts": [
    "December 7 places the reader in 1995, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Galileo%20(spacecraft)%201995&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://www.nasa.gov/search/?search=Galileo%20(spacecraft)%201995",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Galileo%20(spacecraft)%201995",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Galileo%20(spacecraft)%201995",
  ...
  "article": [
    ...
    {
      "text": "December 7, 1995, is not just a date label for Galileo (spacecraft). It is the point where a larger space exploration story becomes visible enough to study. The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space Shuttle Atlantis during Mission STS-34. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 7, 1995, the Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space Shuttle Atlantis during Mission STS-34. Why it mattered: Galileo (spacecraft) put a new mission, institution, product, or public force into motion, and it pushed space exploration into a new. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications... The source record identifies Galileo (spacecraft) as the first NASA mission to orbit Jupiter (1989–2003). Related subjects include Galileo (spacecraft) (First NASA mission to orbit Jupiter (1989–2003)), Jupiter (Fifth planet from the Sun), Space Shuttle Atlantis (Space Shuttle orbiter (1985–2011)), STS-34 (1989 American crewed... The related trail points to Galileo (spacecraft), Jupiter, Space Shuttle Atlantis, STS-34, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Galileo (spacecraft), the detail work starts with the nouns inside the event itself: The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space Shuttle Atlantis during Mission STS-34. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of December 7 is easy: The Galileo spacecraft arrived at Jupiter, a little more than six years after it was launched by Space Shuttle Atlantis during Mission STS-34. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-07");
