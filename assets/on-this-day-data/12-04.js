/* Detail payload for 12-04. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-04"] = {
  "date": "12-04",
  ...
  "sourceDescription": "American political organization (1966–1982)",
  "visual": "rights",
  "palette": "public-square",
  "dek": "Fred Hampton, the leader of the Illinois chapter of the Black Panther Party, and Mark Clark were killed in a raid by Chicago police officers in what many scholars consider an illegal assassination. The deeper story is how this rights and public power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 4"
    ...
    {
      "label": "Source trail",
      "value": "American political organization (1966–1982)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Fred Hampton",
      "source": "https://en.wikipedia.org/wiki/Fred_Hampton",
      "description": "African-American activist (1948–1969)"
    },
    {
      "title": "Black Panther Party",
      "source": "https://en.wikipedia.org/wiki/Black_Panther_Party",
      "description": "American political organization (1966–1982)"
    },
    {
      "title": "Mark Clark (activist)",
      "source": "https://en.wikipedia.org/wiki/Mark_Clark_(activist)",
      "description": "African-American activist (1947–1969)"
    },
    {
      "title": "Chicago Police Department",
      "source": "https://en.wikipedia.org/wiki/Chicago_Police_Department",
      "description": "Principal law enforcement agency of Chicago, Illinois, US"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Black Panther Party",
      "href": "https://commons.wikimedia.org/w/index.php?search=Black%20Panther%20Party%201969&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Black Panther Party",
      "href": "https://catalog.archives.gov/search?q=Black%20Panther%20Party%201969",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Black Panther Party",
      "href": "https://archive.org/search?query=Black%20Panther%20Party%201969",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Black Panther Party",
      "href": "https://www.britannica.com/search?query=Black%20Panther%20Party",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Black Panther Party",
      "href": "https://www.nytimes.com/search?query=Black%20Panther%20Party%201969",
  ...
  "article": [
    ...
    {
      "text": "December 4, 1969, is not just a date label for Black Panther Party. It is the point where a larger rights and public power story becomes visible enough to study. Fred Hampton, the leader of the Illinois chapter of the Black Panther Party, and Mark Clark were killed in a raid by Chicago police officers in what many scholars consider an illegal assassination. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Fred Hampton, the leader of the Illinois chapter of the Black Panther Party, and Mark Clark were killed in a raid by Chicago police officers in what many scholars consider an illegal assassination. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who could claim safety, dignity, citizenship, visibility, or equal treatment. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Black Panther Party matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american political organization (1966–1982). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 4, 1969, Fred Hampton, the leader of the Illinois chapter of the Black Panther Party, and Mark Clark were killed in a raid by Chicago police officers in what many scholars consider an illegal assassination. Why it mattered: Black Panther Party matters because it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. In the wider rights story, it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. The source record identifies Black Panther Party as american political organization (1966–1982). Related subjects include Fred Hampton (African-American activist (1948–1969)), Black Panther Party (American political organization (1966–1982)), Mark Clark (activist) (African-American activist (1947–1969)), Chicago Police Department (Principal law enforcement agency of Chicago, Illinois, US).. The related trail points to Fred Hampton, Black Panther Party, Mark Clark (activist), Chicago Police Department, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Black Panther Party into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Black Panther Party is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Black Panther Party, the detail work starts with the nouns inside the event itself: Fred Hampton, the leader of the Illinois chapter of the Black Panther Party, and Mark Clark were killed in a raid by Chicago police officers in what many scholars consider an illegal assassination. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-04");
