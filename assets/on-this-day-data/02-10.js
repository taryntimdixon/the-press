/* Detail payload for 02-10. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-10"] = {
  "date": "02-10",
  ...
  "sourceDescription": "American pop artist (1923–1997)",
  "visual": "culture",
  "palette": "stage",
  "dek": "The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "February 10"
    ...
    {
      "label": "Source trail",
      "value": "American pop artist (1923–1997)"
    }
  ],
  "summary": [
    "February 10, 1962, is not just a date label for Roy Lichtenstein. It is the point where a larger culture story becomes visible enough to study. The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Roy Lichtenstein",
      "source": "https://en.wikipedia.org/wiki/Roy_Lichtenstein",
      "description": "American pop artist (1923–1997)"
    },
    {
      "title": "Look Mickey",
      "source": "https://en.wikipedia.org/wiki/Look_Mickey",
      "description": "1961 painting by Roy Lichtenstein"
    },
    {
      "title": "Ben Day process",
      "source": "https://en.wikipedia.org/wiki/Ben_Day_process",
      "description": "Printing and photoengraving technique (1879)"
    },
    {
      "title": "Speech balloon",
      "source": "https://en.wikipedia.org/wiki/Speech_balloon",
      "description": "Graphic convention in comics to show speech"
    }
  ],
  "coolFacts": [
    "February 10 places the reader in 1962, inside a culture story with consequences beyond the date itself.",
    ...
    "A useful starting source is Roy Lichtenstein.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Roy Lichtenstein",
      "href": "https://commons.wikimedia.org/w/index.php?search=Roy%20Lichtenstein%201962&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Roy Lichtenstein",
      "href": "https://www.si.edu/search?edan_q=Roy%20Lichtenstein%201962",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Roy Lichtenstein",
      "href": "https://archive.org/search?query=Roy%20Lichtenstein%201962",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Roy Lichtenstein",
      "href": "https://www.britannica.com/search?query=Roy%20Lichtenstein",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Roy Lichtenstein",
      "href": "https://www.nytimes.com/search?query=Roy%20Lichtenstein%201962",
  ...
  "article": [
    ...
    {
      "text": "February 10, 1962, is not just a date label for Roy Lichtenstein. It is the point where a larger culture story becomes visible enough to study. The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On February 10, 1962, the first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. Why it mattered: Roy Lichtenstein marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Roy Lichtenstein as american pop artist (1923–1997). Related subjects include Roy Lichtenstein (American pop artist (1923–1997)), Look Mickey (1961 painting by Roy Lichtenstein), Ben Day process (Printing and photoengraving technique (1879)), Speech balloon (Graphic convention in comics to show speech).. The related trail points to Roy Lichtenstein, Look Mickey, Ben Day process, Speech balloon, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Roy Lichtenstein, the detail work starts with the nouns inside the event itself: The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of February 10 is easy: The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Roy Lichtenstein is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-10");
