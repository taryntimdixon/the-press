...
window.PRESS_ON_THIS_DAY_DETAIL["02-10"] = {
  ...
  "visual": "culture",
  "palette": "stage",
  "dek": "The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use... The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "February 10"
  ...
  "coolFacts": [
    ...
    "The central source trail begins with Roy Lichtenstein.",
  ...
  "article": [
    ...
    {
      "text": "The short version of February 10 is easy: The first solo exhibition by Roy Lichtenstein opened, including the painting Look Mickey, which featured his first use of Ben Day dots, speech balloons, and comic imagery sourcing. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
