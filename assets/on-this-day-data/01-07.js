/* Detail payload for 01-07. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-07"] = {
  "date": "01-07",
  ...
  "sourceDescription": "American bank established in 1781",
  "visual": "chronicle",
  "palette": "archive",
  "dek": "The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "January 7"
    ...
    {
      "label": "Source trail",
      "value": "American bank established in 1781"
    }
  ],
  "summary": [
    "January 7, 1782, is not just a date label for Bank of North America. It is the point where a larger history story becomes visible enough to study. The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Bank of North America",
      "source": "https://en.wikipedia.org/wiki/Bank_of_North_America",
      "description": "American bank established in 1781"
    },
    {
      "title": "Central bank",
      "source": "https://en.wikipedia.org/wiki/Central_bank",
      "description": "Government body that manages currency and monetary policy"
    }
  ],
  "coolFacts": [
    "January 7 places the reader in 1782, inside a history story with consequences beyond the date itself.",
    "The Bank of North America opened in Philadelphia as the de facto first central bank of the United States.",
    "A useful starting source is Bank of North America.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Bank of North America",
      "href": "https://commons.wikimedia.org/w/index.php?search=Bank%20of%20North%20America%201782&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Bank of North America",
      "href": "https://www.si.edu/search?edan_q=Bank%20of%20North%20America%201782",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Bank of North America",
      "href": "https://archive.org/search?query=Bank%20of%20North%20America%201782",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Bank of North America",
      "href": "https://www.britannica.com/search?query=Bank%20of%20North%20America",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Bank of North America",
      "href": "https://www.nytimes.com/search?query=Bank%20of%20North%20America%201782",
  ...
  "article": [
    ...
    {
      "text": "January 7, 1782, is not just a date label for Bank of North America. It is the point where a larger history story becomes visible enough to study. The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Bank of North America matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american bank established in 1781. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Bank of North America, the detail work starts with the nouns inside the event itself: The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of January 7 is easy: The Bank of North America opened in Philadelphia as the de facto first central bank of the United States. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Bank of North America is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-07");
