/* Detail payload for 02-18. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-18"] = {
  "date": "02-18",
  "displayDate": "February 18",
  "year": 1977,
  "title": "NASA",
  "topic": "NASA",
  "headline": "NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft.",
  "text": "NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft.",
  "source": "https://en.wikipedia.org/wiki/NASA",
  "sourceLabel": "Wikipedia: NASA",
  "sourceDescription": "American space and aeronautics agency",
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "February 18"
  ...
  "summary": [
    "February 18, 1977, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "Space Shuttle test vehicle, used for glide tests"
    },
    {
      "title": "Shuttle Carrier Aircraft",
      "source": "https://en.wikipedia.org/wiki/Shuttle_Carrier_Aircraft",
      "description": "Modified Boeing 747 airliners used to transport Space Shuttle orbiters"
    }
  ],
  "coolFacts": [
    "February 18 places the reader in 1977, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%201977&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%201977",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=NASA%201977",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=NASA%201977",
  ...
  "article": [
    ...
    {
      "text": "February 18, 1977, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On February 18, 1977, NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. Why it mattered: NASA marked a first, and it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public... The source record identifies NASA as american space and aeronautics agency. Related subjects include NASA (American space and aeronautics agency), Space Shuttle program (1972–2011 United States human spaceflight program), Space Shuttle Enterprise (Space Shuttle test vehicle, used for glide tests), Shuttle Carrier Aircraft (Modified... The related trail points to NASA, Space Shuttle program, Space Shuttle Enterprise, Shuttle Carrier Aircraft, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The short version of February 18 is easy: NASA's first Space Shuttle, Enterprise, made its first test flight on top of the Shuttle Carrier Aircraft. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-18");
