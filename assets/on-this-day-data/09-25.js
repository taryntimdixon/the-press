/* Detail payload for 09-25. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-25"] = {
  "date": "09-25",
  "displayDate": "September 25",
  "year": 1981,
  "title": "Sandra Day O'Connor",
  "topic": "Sandra Day O'Connor",
  "headline": "Sandra Day O'Connor became the first female justice of the Supreme Court of the United States.",
  "text": "Sandra Day O'Connor became the first female justice of the Supreme Court of the United States.",
  "source": "https://en.wikipedia.org/wiki/Sandra_Day_O'Connor",
  "sourceLabel": "Wikipedia: Sandra Day O'Connor",
  "sourceDescription": "American lawyer, politician and judge (1930–2023)",
  "visual": "civic",
  "palette": "civic",
  "dek": "Sandra Day O'Connor became the first female justice of the Supreme Court of the United States. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 25"
    ...
    {
      "label": "Source trail",
      "value": "American lawyer, politician and judge (1930–2023)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Sandra Day O'Connor",
      "source": "https://en.wikipedia.org/wiki/Sandra_Day_O'Connor",
      "description": "American lawyer, politician and judge (1930–2023)"
    },
    {
      "title": "Associate Justice of the Supreme Court of the United States",
      "source": "https://en.wikipedia.org/wiki/Associate_Justice_of_the_Supreme_Court_of_the_United_States",
      "description": "United States federal judge position"
    }
  ],
  "coolFacts": [
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Sandra Day O'Connor",
      "href": "https://commons.wikimedia.org/w/index.php?search=Sandra%20Day%20O'Connor%201981&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Sandra Day O'Connor",
      "href": "https://catalog.archives.gov/search?q=Sandra%20Day%20O'Connor%201981",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Sandra Day O'Connor",
      "href": "https://archive.org/search?query=Sandra%20Day%20O'Connor%201981",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Sandra Day O'Connor",
      "href": "https://www.britannica.com/search?query=Sandra%20Day%20O'Connor",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Sandra Day O'Connor",
      "href": "https://www.nytimes.com/search?query=Sandra%20Day%20O'Connor%201981",
  ...
  "article": [
    ...
    {
      "text": "September 25, 1981, is not just a date label for Sandra Day O'Connor. It is the point where a larger government and civic power story becomes visible enough to study. Sandra Day O'Connor became the first female justice of the Supreme Court of the United States. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 25, 1981, Sandra Day O'Connor became the first female justice of the Supreme Court of the United States. Why it mattered: Sandra Day O'Connor marked a first, and it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Sandra Day O'Connor as american lawyer, politician and judge (1930–2023). Related subjects include Sandra Day O'Connor (American lawyer, politician and judge (1930–2023)), Associate Justice of the Supreme Court of the United States (United States federal judge position). The lasting consequence. The related trail points to Sandra Day O'Connor, Associate Justice of the Supreme Court of the United States, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Sandra Day O'Connor into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Sandra Day O'Connor is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Sandra Day O'Connor, the detail work starts with the nouns inside the event itself: Sandra Day O'Connor became the first female justice of the Supreme Court of the United States. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-25");
