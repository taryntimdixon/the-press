...
window.PRESS_ON_THIS_DAY_DETAIL["07-27"] = {
  ...
  "visual": "music",
  "palette": "stage",
  "dek": "American musician Madonna released her self-titled debut album, which set the standard for the genre of dance-pop for decades. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 27"
  ...
  "coolFacts": [
    ...
    "A useful starting source is Madonna.",
  ...
  "article": [
    ...
    {
      "text": "The short version of July 27 is easy: American musician Madonna released her self-titled debut album, which set the standard for the genre of dance-pop for decades. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
