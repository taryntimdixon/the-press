/* Detail payload for 05-17. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-17"] = {
  "date": "05-17",
  "displayDate": "May 17",
  "year": 2000,
  ...
  "facts": [
    ...
    {
      "label": "Main event",
      "value": "2000 UEFA Cup semi-final violence"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "Fights between English and Turkish football fans"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "2000 UEFA Cup semi-final violence",
      "source": "https://en.wikipedia.org/wiki/2000_UEFA_Cup_semi-final_violence",
      "description": "Fights between English and Turkish football fans"
    },
    {
      "title": "Galatasaray S.K. (football)",
      "source": "https://en.wikipedia.org/wiki/Galatasaray_S.K._(football)",
      "description": "Turkish professional football club"
    },
    {
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/2000_UEFA_Cup_final_riots",
      "description": "Football riots in City Hall Square, Copenhagen, Denmark (May 2000)"
    }
  ],
  "coolFacts": [
    "May 17 places the reader in 2000, inside a history story with consequences beyond the date itself.",
    ...
    "The central source trail begins with 2000 UEFA Cup semi-final violence.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: 2000 UEFA Cup semi-final violence",
      "href": "https://commons.wikimedia.org/w/index.php?search=2000%20UEFA%20Cup%20semi-final%20violence%202000&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: 2000 UEFA Cup semi-final violence",
      "href": "https://www.si.edu/search?edan_q=2000%20UEFA%20Cup%20semi-final%20violence%202000",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: 2000 UEFA Cup semi-final violence",
      "href": "https://archive.org/search?query=2000%20UEFA%20Cup%20semi-final%20violence%202000",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: 2000 UEFA Cup semi-final violence",
      "href": "https://www.britannica.com/search?query=2000%20UEFA%20Cup%20semi-final%20violence",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: 2000 UEFA Cup semi-final violence",
      "href": "https://www.nytimes.com/search?query=2000%20UEFA%20Cup%20semi-final%20violence%202000",
  ...
  "article": [
    ...
    {
      "text": "May 17, 2000, is not just a date label for 2000 UEFA Cup semi-final violence. It is the point where a larger history story becomes visible enough to study. Following the killing of two English football fans by Galatasaray supporters in the previous month, British and Turkish hooligans rioted on the day of the UEFA Cup Final in Copenhagen, Denmark. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. 2000 UEFA Cup semi-final violence matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as fights between English and Turkish football fans. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten 2000 UEFA Cup semi-final violence into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. 2000 UEFA Cup semi-final violence is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For 2000 UEFA Cup semi-final violence, the detail work starts with the nouns inside the event itself: Following the killing of two English football fans by Galatasaray supporters in the previous month, British and Turkish hooligans rioted on the day of the UEFA Cup Final in Copenhagen, Denmark. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of May 17 is easy: Following the killing of two English football fans by Galatasaray supporters in the previous month, British and Turkish hooligans rioted on the day of the UEFA Cup Final in Copenhagen, Denmark. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. 2000 UEFA Cup semi-final violence is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-17");
