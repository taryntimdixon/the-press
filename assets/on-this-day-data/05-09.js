/* Detail payload for 05-09. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-09"] = {
  "date": "05-09",
  "displayDate": "May 9",
  "year": 1960,
  ...
  "visual": "medicine",
  "palette": "laboratory",
  "dek": "The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. The deeper story is how this medicine and public health moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "May 9"
  ...
  "summary": [
    "May 9, 1960, is not just a date label for Food and Drug Administration. It is the point where a larger medicine and public health story becomes visible enough to study. The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    {
      "title": "G. D. Searle & Company",
      "source": "https://en.wikipedia.org/wiki/G._D._Searle_%26_Company",
      "description": "Trademark and subsidiary of Pfizer Inc"
    },
    {
      "title": "Mestranol/noretynodrel",
      "source": "https://en.wikipedia.org/wiki/Mestranol%2Fnoretynodrel",
      "description": "Combined oral contraceptive medication"
    },
    {
      "title": "Combined oral contraceptive pill",
      "source": "https://en.wikipedia.org/wiki/Combined_oral_contraceptive_pill",
      "description": "Birth control method taken orally"
    }
  ],
  "coolFacts": [
    "May 9 places the reader in 1960, inside a medicine and public health story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Food%20and%20Drug%20Administration%201960&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://pubmed.ncbi.nlm.nih.gov/?term=Food%20and%20Drug%20Administration%201960",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=Food%20and%20Drug%20Administration%201960",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Food%20and%20Drug%20Administration%201960",
  ...
  "article": [
    ...
    {
      "text": "May 9, 1960, is not just a date label for Food and Drug Administration. It is the point where a larger medicine and public health story becomes visible enough to study. The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On May 9, 1960, the U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. Why it mattered: Food and Drug Administration marked a first, and it changed how doctors, patients, public-health officials, or researchers understood. In the wider medicine story, it changed how doctors, patients, public-health officials, or researchers understood disease and treatment. The source record identifies Food and Drug Administration as federal agency of the United States Department of Health and Human Services. Related subjects include Food and Drug Administration (Federal agency of the United States Department of Health and Human Services), G. D. Searle &. The related trail points to Food and Drug Administration, G. D. Searle & Company, Mestranol/noretynodrel, Combined oral contraceptive pill, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Food and Drug Administration, the detail work starts with the nouns inside the event itself: The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of May 9 is easy: The U.S. Food and Drug Administration announced that it would approve the use of Searle's Enovid, the first combined oral contraceptive pill. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-09");
