...
window.PRESS_ON_THIS_DAY_DETAIL["09-23"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Richard Nixon.",
  ...
  "article": [
    ...
    {
      "text": "The short version of September 23 is easy: U.S. vice-presidential candidate Richard Nixon delivered the Checkers speech, one of the first political uses of television to appeal directly to the populace. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
