/* Detail payload for 09-23. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-23"] = {
  "date": "09-23",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "President of the United States from 1969 to 1974"
    }
  ],
  "summary": [
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Checkers_speech",
      "description": "1952 television address by Richard Nixon"
    }
  ],
  "coolFacts": [
    "September 23 places the reader in 1952, inside a culture story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Richard Nixon.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Richard Nixon",
      "href": "https://commons.wikimedia.org/w/index.php?search=Richard%20Nixon%201952&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Richard Nixon",
      "href": "https://www.si.edu/search?edan_q=Richard%20Nixon%201952",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Richard Nixon",
      "href": "https://archive.org/search?query=Richard%20Nixon%201952",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Richard Nixon",
      "href": "https://www.britannica.com/search?query=Richard%20Nixon",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Richard Nixon",
      "href": "https://www.nytimes.com/search?query=Richard%20Nixon%201952",
  ...
  "article": [
    ...
    {
      "text": "September 23, 1952, is not just a date label for Richard Nixon. It is the point where a larger culture story becomes visible enough to study. U.S. vice-presidential candidate Richard Nixon delivered the Checkers speech, one of the first political uses of television to appeal directly to the populace. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it altered taste, language, fandom, entertainment, memory, or the way audiences recognized themselves. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Richard Nixon matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as president of the United States from 1969 to 1974. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Richard Nixon into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Richard Nixon is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Richard Nixon, the detail work starts with the nouns inside the event itself: U.S. vice-presidential candidate Richard Nixon delivered the Checkers speech, one of the first political uses of television to appeal directly to the populace. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-23");
