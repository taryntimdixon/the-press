/* Detail payload for 04-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-21"] = {
  "date": "04-21",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "U.S. Founding Father, president from 1789 to 1797"
    }
  ],
  "summary": [
    ...
    "The strongest image for this entry is not a symbol floating in empty space. It is a formal place where documents, offices, ceremonies, laws, and public legitimacy became the center of the story. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. George Washington belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1888,
  "related": [
    {
      "title": "George Washington's reception at Trenton",
      "source": "https://en.wikipedia.org/wiki/George_Washington's_reception_at_Trenton",
      "description": "Event on April 21, 1789"
    },
    {
      "title": "George Washington",
      "source": "https://en.wikipedia.org/wiki/George_Washington",
      "description": "U.S. Founding Father, president from 1789 to 1797"
    },
    {
      "title": "First inauguration of George Washington",
      "source": "https://en.wikipedia.org/wiki/First_inauguration_of_George_Washington",
      "description": "1st United States presidential inauguration"
    }
  ],
  "coolFacts": [
    "April 21 places the reader in 1789, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with George Washington.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: George Washington",
      "href": "https://commons.wikimedia.org/w/index.php?search=George%20Washington%201789&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: George Washington",
      "href": "https://catalog.archives.gov/search?q=George%20Washington%201789",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: George Washington",
      "href": "https://archive.org/search?query=George%20Washington%201789",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: George Washington",
      "href": "https://www.britannica.com/search?query=George%20Washington",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: George Washington",
      "href": "https://www.nytimes.com/search?query=George%20Washington%201789",
  ...
  "article": [
    ...
    {
      "text": "April 21, 1789, is not just a date label for George Washington. It is the point where a larger government and civic power story becomes visible enough to study. The Ladies of Trenton social club hosted a reception for President-elect George Washington as he journeyed to New York City for his first inauguration. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten George Washington into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. George Washington is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For George Washington, the detail work starts with the nouns inside the event itself: The Ladies of Trenton social club hosted a reception for President-elect George Washington as he journeyed to New York City for his first inauguration. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-21");
