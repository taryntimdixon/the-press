/* Detail payload for 12-03. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-03"] = {
  "date": "12-03",
  "displayDate": "December 3",
  "year": 1994,
  "title": "Sony Interactive Entertainment",
  "topic": "Sony Interactive Entertainment",
  "headline": "Sony released the PlayStation, the first computer entertainment platform to ship 100 million units.",
  ...
  "sourceLabel": "Wikipedia: Sony Interactive Entertainment",
  "sourceDescription": "American digital entertainment company owned by Sony",
  "visual": "tech",
  "palette": "laboratory",
  "dek": "Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 3"
    ...
    {
      "label": "Source trail",
      "value": "American digital entertainment company owned by Sony"
    }
  ],
  "summary": [
    "December 3, 1994, is not just a date label for Sony Interactive Entertainment. It is the point where a larger technology story becomes visible enough to study. Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Sony Interactive Entertainment",
      "source": "https://en.wikipedia.org/wiki/Sony_Interactive_Entertainment",
      "description": "American digital entertainment company owned by Sony"
    },
    {
      "title": "PlayStation (console)",
      "source": "https://en.wikipedia.org/wiki/PlayStation_(console)",
      "description": "Home video game console by Sony"
    }
  ],
  "coolFacts": [
    "December 3 places the reader in 1994, inside a technology story with consequences beyond the date itself.",
    "Sony released the PlayStation, the first computer entertainment platform to ship 100 million units.",
    "The central source trail begins with Sony Interactive Entertainment.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Sony Interactive Entertainment",
      "href": "https://commons.wikimedia.org/w/index.php?search=Sony%20Interactive%20Entertainment%201994&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Sony Interactive Entertainment",
      "href": "https://www.si.edu/search?edan_q=Sony%20Interactive%20Entertainment%201994",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Sony Interactive Entertainment",
      "href": "https://archive.org/search?query=Sony%20Interactive%20Entertainment%201994",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Sony Interactive Entertainment",
      "href": "https://www.britannica.com/search?query=Sony%20Interactive%20Entertainment",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Sony Interactive Entertainment",
      "href": "https://www.nytimes.com/search?query=Sony%20Interactive%20Entertainment%201994",
  ...
  "article": [
    ...
    {
      "text": "December 3, 1994, is not just a date label for Sony Interactive Entertainment. It is the point where a larger technology story becomes visible enough to study. Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Sony Interactive Entertainment matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american digital entertainment company owned by Sony. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 3, 1994, Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. Why it mattered: Sony Interactive Entertainment marked a first, and it changed how people used machines, networks, media, or information in everyday life. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies Sony Interactive Entertainment as american digital entertainment company owned by Sony. Related subjects include Sony Interactive Entertainment (American digital entertainment company owned by Sony), PlayStation (console) (Home video game console by Sony). The lasting consequence was a faster information world... The related trail points to Sony Interactive Entertainment, PlayStation (console), which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Sony Interactive Entertainment, the detail work starts with the nouns inside the event itself: Sony released the PlayStation, the first computer entertainment platform to ship 100 million units. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-03");
