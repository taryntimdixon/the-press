/* Detail payload for 02-20. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-20"] = {
  "date": "02-20",
  ...
  "sourceDescription": "Empire in Europe from 1804 to 1867",
  "visual": "protest",
  "palette": "public-square",
  "dek": "Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. The deeper story is how this protest moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "February 20"
    ...
    {
      "label": "Source trail",
      "value": "Empire in Europe from 1804 to 1867"
    }
  ],
  "summary": [
    "February 20, 1846, is not just a date label for Austrian Empire. It is the point where a larger protest story becomes visible enough to study. Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      "title": "Free City of Cracow",
      "source": "https://en.wikipedia.org/wiki/Free_City_of_Cracow",
      "description": "Polish city state (1815–1846)"
    },
    {
      "title": "Kraków Uprising",
      "source": "https://en.wikipedia.org/wiki/Krak%C3%B3w_Uprising",
      "description": "1846 attempt at Polish independence"
    },
    {
      "title": "Austrian Empire",
      "source": "https://en.wikipedia.org/wiki/Austrian_Empire",
      "description": "Empire in Europe from 1804 to 1867"
    }
  ],
  "coolFacts": [
    "February 20 places the reader in 1846, inside a protest story with consequences beyond the date itself.",
    ...
    "A useful starting source is Austrian Empire.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Austrian Empire",
      "href": "https://commons.wikimedia.org/w/index.php?search=Austrian%20Empire%201846&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Austrian Empire",
      "href": "https://catalog.archives.gov/search?q=Austrian%20Empire%201846",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Austrian Empire",
      "href": "https://archive.org/search?query=Austrian%20Empire%201846",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Austrian Empire",
      "href": "https://www.britannica.com/search?query=Austrian%20Empire",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Austrian Empire",
      "href": "https://www.nytimes.com/search?query=Austrian%20Empire%201846",
  ...
  "article": [
    ...
    {
      "text": "February 20, 1846, is not just a date label for Austrian Empire. It is the point where a larger protest story becomes visible enough to study. Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed the emotional temperature of politics and showed what pressure from below could do. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Austrian Empire matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as empire in Europe from 1804 to 1867. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On February 20, 1846, Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. Why it mattered: Austrian Empire matters because it showed public pressure becoming a political force rather than background noise. In the wider protest story, it showed public pressure becoming a political force rather than background noise. The source record identifies Austrian Empire as empire in Europe from 1804 to 1867. Related subjects include Free City of Cracow (Polish city state (1815–1846)), Kraków Uprising (1846 attempt at Polish independence), Austrian Empire (Empire in Europe from 1804 to 1867). The lasting consequence. The related trail points to Free City of Cracow, Kraków Uprising, Austrian Empire, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Austrian Empire into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Austrian Empire is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Austrian Empire, the detail work starts with the nouns inside the event itself: Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of February 20 is easy: Polish insurgents in the Free City of Kraków led an uprising attempting to incite a fight for national independence that was put down by the Austrian Empire nine days later. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
    {
      "text": "The answer is not always neat. Some consequences were immediate, some took years, and some are still argued over. But that is what makes the date worth keeping. Austrian Empire is not just a memory marker; it is a pressure point where evidence, emotion, institutions, and public meaning meet. A reader arriving on this date should come away with more than a fact. They should feel why the fact had weight, what kind of world produced it, and where to go next if they want to keep digging.",
      "sources": [
        1,
        4,
        6
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-20");
