...
window.PRESS_ON_THIS_DAY_DETAIL["03-06"] = {
  ...
  "visual": "culture",
  "palette": "stage",
  "dek": "In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 6"
  ...
  "coolFacts": [
    ...
    "A useful starting source is Nation of Islam.",
  ...
  "article": [
    ...
    {
      "text": "The short version of March 6 is easy: In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
