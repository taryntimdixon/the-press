/* Detail payload for 03-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-06"] = {
  "date": "03-06",
  "displayDate": "March 6",
  "year": 1964,
  ...
  "sourceDescription": "African American new religious organization",
  "visual": "culture",
  "palette": "stage",
  "dek": "In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change... The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 6"
    ...
    {
      "label": "Source trail",
      "value": "African American new religious organization"
    }
  ],
  "summary": [
    "March 6, 1964, is not just a date label for Nation of Islam. It is the point where a larger culture story becomes visible enough to study. In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a theater, shop, studio, page, screen, or public crowd where an idea moved from private work into mass imagination. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Nation of Islam belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1881,
  "related": [
    {
      "title": "Nation of Islam",
      "source": "https://en.wikipedia.org/wiki/Nation_of_Islam",
      "description": "African American new religious organization"
    },
    {
      "title": "Elijah Muhammad",
      "source": "https://en.wikipedia.org/wiki/Elijah_Muhammad",
      "description": "African American religious leader (1897–1975)"
    },
    {
      "title": "Boxing",
      "source": "https://en.wikipedia.org/wiki/Boxing",
      "description": "Combat sport and martial art"
    },
    {
      "title": "Muhammad Ali",
      "source": "https://en.wikipedia.org/wiki/Muhammad_Ali",
      "description": "American boxer and activist (1942–2016)"
    }
  ],
  "coolFacts": [
    "March 6 places the reader in 1964, inside a culture story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Nation of Islam.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Nation of Islam",
      "href": "https://commons.wikimedia.org/w/index.php?search=Nation%20of%20Islam%201964&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Nation of Islam",
      "href": "https://www.si.edu/search?edan_q=Nation%20of%20Islam%201964",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Nation of Islam",
      "href": "https://archive.org/search?query=Nation%20of%20Islam%201964",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Nation of Islam",
      "href": "https://www.britannica.com/search?query=Nation%20of%20Islam",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Nation of Islam",
      "href": "https://www.nytimes.com/search?query=Nation%20of%20Islam%201964",
  ...
  "article": [
    ...
    {
      "text": "March 6, 1964, is not just a date label for Nation of Islam. It is the point where a larger culture story becomes visible enough to study. In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 6, 1964, In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. Why it mattered: Nation of Islam matters because it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Nation of Islam as african American new religious organization. Related subjects include Nation of Islam (African American new religious organization), Elijah Muhammad (African American religious leader (1897–1975)), Boxing (Combat sport and martial art), Muhammad Ali (American boxer and activist (1942–2016)).... The related trail points to Nation of Islam, Elijah Muhammad, Boxing, Muhammad Ali, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For Nation of Islam, the detail work starts with the nouns inside the event itself: In a radio broadcast, Nation of Islam leader Elijah Muhammad announced that American boxer Cassius Clay would change his name to Muhammad Ali. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-06");
