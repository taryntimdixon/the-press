/* Detail payload for 05-08. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["05-08"] = {
  "date": "05-08",
  "displayDate": "May 8",
  "year": 1927,
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "French fighter ace and adventurer (1892–1927)"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Charles Nungesser",
      "source": "https://en.wikipedia.org/wiki/Charles_Nungesser",
      "description": "French fighter ace and adventurer (1892–1927)"
    },
    {
      "title": "François Coli",
      "source": "https://en.wikipedia.org/wiki/Fran%C3%A7ois_Coli",
      "description": "French aviator (1881–1927)"
    },
    {
      "title": "Biplane",
      "source": "https://en.wikipedia.org/wiki/Biplane",
      "description": "Airplane wing configuration with two vertically stacked main flying surfaces"
    },
    {
      "title": "L'Oiseau Blanc",
      "source": "https://en.wikipedia.org/wiki/L'Oiseau_Blanc",
      "description": "French biplane that disappeared in 1927"
    }
  ],
  "coolFacts": [
    "May 8 places the reader in 1927, inside a transportation story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Charles Nungesser.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Charles Nungesser",
      "href": "https://commons.wikimedia.org/w/index.php?search=Charles%20Nungesser%201927&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Charles Nungesser",
      "href": "https://www.si.edu/search?edan_q=Charles%20Nungesser%201927",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Charles Nungesser",
      "href": "https://archive.org/search?query=Charles%20Nungesser%201927",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Charles Nungesser",
      "href": "https://www.britannica.com/search?query=Charles%20Nungesser",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Charles Nungesser",
      "href": "https://www.nytimes.com/search?query=Charles%20Nungesser%201927",
  ...
  "article": [
    ...
    {
      "text": "May 8, 1927, is not just a date label for Charles Nungesser. It is the point where a larger transportation story becomes visible enough to study. French aviators Charles Nungesser and François Coli aboard the biplane L'Oiseau Blanc took off from Paris, attempting to make the first non-stop flight to New York, only to disappear before arrival. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how bodies, goods, news, armies, families, and ambition moved through the world. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Charles Nungesser matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as french fighter ace and adventurer (1892–1927). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Charles Nungesser into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Charles Nungesser is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Charles Nungesser, the detail work starts with the nouns inside the event itself: French aviators Charles Nungesser and François Coli aboard the biplane L'Oiseau Blanc took off from Paris, attempting to make the first non-stop flight to New York, only to disappear before arrival. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("05-08");
