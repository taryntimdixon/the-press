...
window.PRESS_ON_THIS_DAY_DETAIL["05-08"] = {
  ...
  "coolFacts": [
    ...
    "A useful starting source is Charles Nungesser.",
  ...
  "article": [
    ...
    {
      "text": "The short version of May 8 is easy: French aviators Charles Nungesser and François Coli aboard the biplane L'Oiseau Blanc took off from Paris, attempting to make the first non-stop flight to New York, only to disappear before arrival. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
