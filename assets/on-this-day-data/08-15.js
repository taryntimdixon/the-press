/* Detail payload for 08-15. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-15"] = {
  "date": "08-15",
  "displayDate": "August 15",
  "year": 1948,
  "title": "Syngman Rhee",
  "topic": "Syngman Rhee",
  "headline": "The Republic of Korea was established with Syngman Rhee as its first president.",
  ...
  "sourceLabel": "Wikipedia: Syngman Rhee",
  "sourceDescription": "President of South Korea from 1948 to 1960",
  "visual": "civic",
  "palette": "civic",
  "dek": "The Republic of Korea was established with Syngman Rhee as its first president. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 15"
  ...
  "related": [
    ...
    },
    {
      "title": "Syngman Rhee",
      "source": "https://en.wikipedia.org/wiki/Syngman_Rhee",
      "description": "President of South Korea from 1948 to 1960"
    }
  ],
  "coolFacts": [
    "August 15 places the reader in 1948, inside a government and civic power story with consequences beyond the date itself.",
    "The Republic of Korea was established with Syngman Rhee as its first president.",
    "The central source trail begins with Syngman Rhee.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Syngman Rhee",
      "href": "https://commons.wikimedia.org/w/index.php?search=Syngman%20Rhee%201948&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Syngman Rhee",
      "href": "https://catalog.archives.gov/search?q=Syngman%20Rhee%201948",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Syngman Rhee",
      "href": "https://archive.org/search?query=Syngman%20Rhee%201948",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Syngman Rhee",
      "href": "https://www.britannica.com/search?query=Syngman%20Rhee",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Syngman Rhee",
      "href": "https://www.nytimes.com/search?query=Syngman%20Rhee%201948",
  ...
  "article": [
    ...
    {
      "text": "August 15, 1948, is not just a date label for Syngman Rhee. It is the point where a larger government and civic power story becomes visible enough to study. The Republic of Korea was established with Syngman Rhee as its first president. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The Republic of Korea was established with Syngman Rhee as its first president. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 15, 1948, the Republic of Korea was established with Syngman Rhee as its first president. Why it mattered: Syngman Rhee marked a first, and it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Syngman Rhee as president of South Korea from 1948 to 1960. Related subjects include History of South Korea, Syngman Rhee (President of South Korea from 1948 to 1960). The lasting consequence was institutional: a rule, office, treaty, court, border, or... The related trail points to History of South Korea, Syngman Rhee, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Syngman Rhee into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Syngman Rhee is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Syngman Rhee, the detail work starts with the nouns inside the event itself: The Republic of Korea was established with Syngman Rhee as its first president. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-15");
