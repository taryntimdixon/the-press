/* Detail payload for 10-28. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-28"] = {
  "date": "10-28",
  ...
  "visual": "civic",
  "palette": "civic",
  "dek": "In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 28"
  ...
  "summary": [
    "October 28, 1886, is not just a date label for United States Declaration of Independence. It is the point where a larger government and civic power story becomes visible enough to study. In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    {
      ...
      "description": "Harbor in New York and New Jersey"
    },
    {
      "title": "Grover Cleveland",
      "source": "https://en.wikipedia.org/wiki/Grover_Cleveland",
      "description": "President of the United States (1885–1889; 1893–1897)"
    },
    {
  ...
  "coolFacts": [
    "October 28 places the reader in 1886, inside a government and civic power story with consequences beyond the date itself.",
    "In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=United%20States%20Declaration%20of%20Independence%201886&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=United%20States%20Declaration%20of%20Independence%201886",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=United%20States%20Declaration%20of%20Independence%201886",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=United%20States%20Declaration%20of%20Independence%201886",
  ...
  "article": [
    ...
    {
      "text": "October 28, 1886, is not just a date label for United States Declaration of Independence. It is the point where a larger government and civic power story becomes visible enough to study. In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 28, 1886, In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. Why it mattered: United States Declaration of Independence matters because it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies United States Declaration of Independence as 1776 American national founding document. Related subjects include New York Harbor (Harbor in New York and New Jersey), Grover Cleveland (President of the United States (1885–1889; 1893–1897)), Statue of Liberty (Colossal sculpture in New. The related trail points to New York Harbor, Grover Cleveland, Statue of Liberty, United States Declaration of Independence, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For United States Declaration of Independence, the detail work starts with the nouns inside the event itself: In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of October 28 is easy: In New York Harbor, U.S. president Grover Cleveland dedicated the Statue of Liberty, a gift from France commemorating the Declaration of Independence. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this moment belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-28");
