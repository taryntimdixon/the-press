/* Detail payload for 11-02. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["11-02"] = {
  "date": "11-02",
  ...
  "sourceDescription": "President of the United States in 1881",
  "visual": "rights",
  "palette": "public-square",
  "dek": "James A. Garfield was elected as president of the United States; the election is the closest to date... The deeper story is how this rights and public power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "November 2"
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/1880_United_States_presidential_election",
      "description": ""
    },
    {
  ...
  "coolFacts": [
    "November 2 places the reader in 1880, inside a rights and public power story with consequences beyond the date itself.",
    "James A. Garfield was elected as president of the United States; the election is the closest to date by popular vote margin.",
    "The central source trail begins with James A. Garfield.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: James A. Garfield",
      "href": "https://commons.wikimedia.org/w/index.php?search=James%20A.%20Garfield%201880&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: James A. Garfield",
      "href": "https://catalog.archives.gov/search?q=James%20A.%20Garfield%201880",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: James A. Garfield",
      "href": "https://archive.org/search?query=James%20A.%20Garfield%201880",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: James A. Garfield",
      "href": "https://www.britannica.com/search?query=James%20A.%20Garfield",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: James A. Garfield",
      "href": "https://www.nytimes.com/search?query=James%20A.%20Garfield%201880",
  ...
  "article": [
    ...
    {
      "text": "November 2, 1880, is not just a date label for James A. Garfield. It is the point where a larger rights and public power story becomes visible enough to study. James A. Garfield was elected as president of the United States; the election is the closest to date by popular vote margin. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "James A. Garfield was elected as president of the United States; the election is the closest to date... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed who could claim safety, dignity, citizenship, visibility, or equal treatment. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. James A. Garfield matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as president of the United States in 1881. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On November 2, 1880, James A. Garfield was elected as president of the United States; the election is the closest to date by popular vote margin. Why it mattered: James A. Garfield matters because it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. In the wider rights story, it changed the legal or public meaning of citizenship, equality, personal freedom, or human dignity. The source record identifies James A. Garfield as president of the United States in 1881. Related subjects include James A. Garfield (President of the United States in 1881), 1880 United States presidential election, List of United States presidential elections by popular vote margin. The... The related trail points to James A. Garfield, 1880 United States presidential election, List of United States presidential elections by popular vote margin, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten James A. Garfield into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. James A. Garfield is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("11-02");
