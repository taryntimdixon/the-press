/* Detail payload for 04-07. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-07"] = {
  "date": "04-07",
  "displayDate": "April 7",
  "year": 2001,
  "title": "NASA",
  ...
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA's 2001 Mars Odyssey, the longest-surviving continually active spacecraft in orbit around a planet other than Earth, launched... The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 7"
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/2001_Mars_Odyssey",
      "description": "NASA orbiter for geology and hydrology"
    },
    {
  ...
  "coolFacts": [
    "April 7 places the reader in 2001, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%202001&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%202001",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=NASA%202001",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=NASA%202001",
  ...
  "article": [
    ...
    {
      "text": "April 7, 2001, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA's 2001 Mars Odyssey, the longest-surviving continually active spacecraft in orbit around a planet other than Earth, launched from Cape Canaveral. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "NASA's 2001 Mars Odyssey, the longest-surviving continually active spacecraft in orbit around a planet other than Earth, launched... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 7, 2001, NASA's 2001 Mars Odyssey, the longest-surviving continually active spacecraft in orbit around a planet other than Earth, launched from Cape Canaveral. Why it mattered: NASA put a new mission, institution, product, or public force into motion, and it pushed space exploration into a new technical or. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation... The source record identifies NASA as american space and aeronautics agency. Related subjects include NASA (American space and aeronautics agency), 2001 Mars Odyssey (NASA orbiter for geology and hydrology), Cape Canaveral Space Force Station (Military rocket launch site in Florida). The lasting consequence was... The related trail points to NASA, 2001 Mars Odyssey, Cape Canaveral Space Force Station, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-07");
