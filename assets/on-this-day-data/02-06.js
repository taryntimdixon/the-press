/* Detail payload for 02-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["02-06"] = {
  "date": "02-06",
  ...
  "facts": [
    ...
    {
      "label": "Main event",
      "value": "Treaty of Amity and Commerce (France–United States)"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "1778 treaty between the United States and France"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      "title": "Treaty of Amity and Commerce (France–United States)",
      "source": "https://en.wikipedia.org/wiki/Treaty_of_Amity_and_Commerce_(France%E2%80%93United_States)",
      "description": "1778 treaty between the United States and France"
    },
    {
      "title": "Treaty of Alliance (1778)",
      "source": "https://en.wikipedia.org/wiki/Treaty_of_Alliance_(1778)",
      "description": "Military alliance between the revolutionary United States and France"
    }
  ],
  "coolFacts": [
    "February 6 places the reader in 1778, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Treaty of Amity and Commerce (France–United States).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Treaty of Amity and Commerce (France–United States)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Treaty%20of%20Amity%20and%20Commerce%20(France%E2%80%93United%20States)%201778&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Treaty of Amity and Commerce (France–United States)",
      "href": "https://catalog.archives.gov/search?q=Treaty%20of%20Amity%20and%20Commerce%20(France%E2%80%93United%20States)%201778",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Treaty of Amity and Commerce (France–United States)",
      "href": "https://archive.org/search?query=Treaty%20of%20Amity%20and%20Commerce%20(France%E2%80%93United%20States)%201778",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Treaty of Amity and Commerce (France–United States)",
      "href": "https://www.britannica.com/search?query=Treaty%20of%20Amity%20and%20Commerce%20(France%E2%80%93United%20States)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Treaty of Amity and Commerce (France–United States)",
      "href": "https://www.nytimes.com/search?query=Treaty%20of%20Amity%20and%20Commerce%20(France%E2%80%93United%20States)%201778",
  ...
  "article": [
    ...
    {
      "text": "February 6, 1778, is not just a date label for Treaty of Amity and Commerce (France–United States). It is the point where a larger government and civic power story becomes visible enough to study. France and the United States signed the Treaty of Amity and Commerce and the Treaty of Alliance, respectively establishing commercial and military ties between the two nations. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Treaty of Amity and Commerce (France–United States) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Treaty of Amity and Commerce (France–United States) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Treaty of Amity and Commerce (France–United States), the detail work starts with the nouns inside the event itself: France and the United States signed the Treaty of Amity and Commerce and the Treaty of Alliance, respectively establishing commercial and military ties between the two nations. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("02-06");
