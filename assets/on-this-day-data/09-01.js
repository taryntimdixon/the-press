/* Detail payload for 09-01. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-01"] = {
  "date": "09-01",
  ...
  "sourceDescription": "American author and journalist (1899–1961)",
  "visual": "culture",
  "palette": "stage",
  "dek": "Ernest Hemingway's novel The Old Man and the Sea, which later won the Pulitzer Prize for Fiction, was... The deeper story is how this culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 1"
  ...
  "related": [
    {
      "title": "Ernest Hemingway",
      "source": "https://en.wikipedia.org/wiki/Ernest_Hemingway",
      "description": "American author and journalist (1899–1961)"
    },
    {
      "title": "The Old Man and the Sea",
      "source": "https://en.wikipedia.org/wiki/The_Old_Man_and_the_Sea",
      "description": "1952 novella by Ernest Hemingway"
    },
    {
      "title": "Pulitzer Prize for Fiction",
      "source": "https://en.wikipedia.org/wiki/Pulitzer_Prize_for_Fiction",
      "description": "American award for distinguished novels"
    }
  ],
  "coolFacts": [
    "September 1 places the reader in 1952, inside a culture story with consequences beyond the date itself.",
    "Ernest Hemingway's novel The Old Man and the Sea, which later won the Pulitzer Prize for Fiction, was first published.",
    "The central source trail begins with Ernest Hemingway.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Ernest Hemingway",
      "href": "https://commons.wikimedia.org/w/index.php?search=Ernest%20Hemingway%201952&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Ernest Hemingway",
      "href": "https://www.si.edu/search?edan_q=Ernest%20Hemingway%201952",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Ernest Hemingway",
      "href": "https://archive.org/search?query=Ernest%20Hemingway%201952",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Ernest Hemingway",
      "href": "https://www.britannica.com/search?query=Ernest%20Hemingway",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Ernest Hemingway",
      "href": "https://www.nytimes.com/search?query=Ernest%20Hemingway%201952",
  ...
  "article": [
    ...
    {
      "text": "September 1, 1952, is not just a date label for Ernest Hemingway. It is the point where a larger culture story becomes visible enough to study. Ernest Hemingway's novel The Old Man and the Sea, which later won the Pulitzer Prize for Fiction, was first published. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Ernest Hemingway's novel The Old Man and the Sea, which later won the Pulitzer Prize for Fiction, was... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it altered taste, language, fandom, entertainment, memory, or the way audiences recognized themselves. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Ernest Hemingway matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american author and journalist (1899–1961). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 1, 1952, Ernest Hemingway's novel The Old Man and the Sea, which later won the Pulitzer Prize for Fiction, was first published. Why it mattered: Ernest Hemingway marked a first, and it changed what audiences read, watched, collected, celebrated, or argued about together. In the wider culture story, it changed what audiences read, watched, collected, celebrated, or argued about together. The source record identifies Ernest Hemingway as american author and journalist (1899–1961). Related subjects include Ernest Hemingway (American author and journalist (1899–1961)), The Old Man and the Sea (1952 novella by Ernest Hemingway), Pulitzer Prize for Fiction (American award for distinguished novels). The lasting... The related trail points to Ernest Hemingway, The Old Man and the Sea, Pulitzer Prize for Fiction, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Ernest Hemingway into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Ernest Hemingway is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-01");
