/* Detail payload for 03-12. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-12"] = {
  "date": "03-12",
  ...
  "sourceDescription": "Indian independence activist (1869–1948)",
  "visual": "civic",
  "palette": "civic",
  "dek": "Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial... The deeper story is how this government and civic power moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 12"
    ...
    {
      "label": "Source trail",
      "value": "Indian independence activist (1869–1948)"
    }
  ],
  "summary": [
    "March 12, 1930, is not just a date label for Mahatma Gandhi. It is the point where a larger government and civic power story becomes visible enough to study. Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial India. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a formal place where documents, offices, ceremonies, laws, and public legitimacy became the center of the story. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Mahatma Gandhi belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1863,
  "related": [
    {
    ...
    },
    {
      ...
      "description": "1930 Indian protest led by Mahatma Gandhi"
    },
    {
      "title": "Nonviolence",
      "source": "https://en.wikipedia.org/wiki/Nonviolence",
      "description": "Principle or practice of not causing harm to others"
    },
    {
      "title": "History of the salt tax in British India",
      "source": "https://en.wikipedia.org/wiki/History_of_the_salt_tax_in_British_India",
      "description": ""
    }
  ],
  "coolFacts": [
    "March 12 places the reader in 1930, inside a government and civic power story with consequences beyond the date itself.",
    "Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial India.",
    "The central source trail begins with Mahatma Gandhi.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Mahatma Gandhi",
      "href": "https://commons.wikimedia.org/w/index.php?search=Mahatma%20Gandhi%201930&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Mahatma Gandhi",
      "href": "https://catalog.archives.gov/search?q=Mahatma%20Gandhi%201930",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Mahatma Gandhi",
      "href": "https://archive.org/search?query=Mahatma%20Gandhi%201930",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Mahatma Gandhi",
    ...
    },
    {
      ...
      "title": "The New York Times archive search: Mahatma Gandhi",
      "href": "https://www.nytimes.com/search?query=Mahatma%20Gandhi%201930",
  ...
  "article": [
    ...
    {
      "text": "March 12, 1930, is not just a date label for Mahatma Gandhi. It is the point where a larger government and civic power story becomes visible enough to study. Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial India. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 12, 1930, Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial India. Why it mattered: Mahatma Gandhi matters because it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Mahatma Gandhi as indian independence activist (1869–1948). Related subjects include Mahatma Gandhi (Indian independence activist (1869–1948)), Salt March (1930 Indian protest led by Mahatma Gandhi), Nonviolence (Principle or practice of not causing harm to others), History of the salt tax... The related trail points to Mahatma Gandhi, Salt March, Nonviolence, History of the salt tax in British India, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Mahatma Gandhi into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Mahatma Gandhi is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Mahatma Gandhi, the detail work starts with the nouns inside the event itself: Mahatma Gandhi began the Salt March, a 24-day nonviolent walk to defy the British salt tax in colonial India. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-12");
