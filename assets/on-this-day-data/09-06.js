/* Detail payload for 09-06. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-06"] = {
  "date": "09-06",
  "displayDate": "September 6",
  "year": 2000,
  "title": "Los Angeles Dodgers",
  "topic": "Los Angeles Dodgers",
  "headline": "The Los Angeles Dodgers hosted the first Pride Night in Major League Baseball history.",
  ...
  "sourceLabel": "Wikipedia: Los Angeles Dodgers",
  "sourceDescription": "Major League Baseball franchise",
  "visual": "sports",
  "palette": "public-square",
  "dek": "The Los Angeles Dodgers hosted the first Pride Night in Major League Baseball history. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 6"
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "LGBTQ-themed games hosted by sports teams"
    },
    {
  ...
  "coolFacts": [
    "September 6 places the reader in 2000, inside a history story with consequences beyond the date itself.",
    "The Los Angeles Dodgers hosted the first Pride Night in Major League Baseball history.",
    "The central source trail begins with Los Angeles Dodgers.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Los Angeles Dodgers",
      "href": "https://commons.wikimedia.org/w/index.php?search=Los%20Angeles%20Dodgers%202000&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Los Angeles Dodgers",
      "href": "https://www.si.edu/search?edan_q=Los%20Angeles%20Dodgers%202000",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Los Angeles Dodgers",
      "href": "https://archive.org/search?query=Los%20Angeles%20Dodgers%202000",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Los Angeles Dodgers",
      "href": "https://www.britannica.com/search?query=Los%20Angeles%20Dodgers",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Los Angeles Dodgers",
      "href": "https://www.nytimes.com/search?query=Los%20Angeles%20Dodgers%202000",
  ...
  "article": [
    ...
    {
      "text": "September 6, 2000, is not just a date label for Los Angeles Dodgers. It is the point where a larger history story becomes visible enough to study. The Los Angeles Dodgers hosted the first Pride Night in Major League Baseball history. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For Los Angeles Dodgers, the detail work starts with the nouns inside the event itself: The Los Angeles Dodgers hosted the first Pride Night in Major League Baseball history. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-06");
