/* Detail payload for 12-26. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-26"] = {
  "date": "12-26",
  ...
  "sourceDescription": "Transoceanic communication line placed on the seabed",
  "visual": "tech",
  "palette": "laboratory",
  "dek": "Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and... The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "December 26"
    ...
    {
      "label": "Main event",
      "value": "Submarine communications cable"
    },
    {
    ...
    {
      "label": "Source trail",
      "value": "Transoceanic communication line placed on the seabed"
    }
  ],
  "summary": [
    "December 26, 2006, is not just a date label for Submarine communications cable. It is the point where a larger technology story becomes visible enough to study. Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and affecting financial transactions. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a workspace where machines, investors, users, engineers, and public curiosity started pulling in the same direction. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Submarine communications cable belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1870,
  "related": [
    {
      "title": "2006 Hengchun earthquakes",
      "source": "https://en.wikipedia.org/wiki/2006_Hengchun_earthquakes",
      "description": "Earthquakes and tsunami near Taiwan"
    },
    {
      "title": "Submarine communications cable",
      "source": "https://en.wikipedia.org/wiki/Submarine_communications_cable",
      "description": "Transoceanic communication line placed on the seabed"
    }
  ],
  "coolFacts": [
    "December 26 places the reader in 2006, inside a technology story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Submarine communications cable.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Submarine communications cable",
      "href": "https://commons.wikimedia.org/w/index.php?search=Submarine%20communications%20cable%202006&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Submarine communications cable",
      "href": "https://www.si.edu/search?edan_q=Submarine%20communications%20cable%202006",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Submarine communications cable",
      "href": "https://archive.org/search?query=Submarine%20communications%20cable%202006",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Submarine communications cable",
      "href": "https://www.britannica.com/search?query=Submarine%20communications%20cable",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Submarine communications cable",
      "href": "https://www.nytimes.com/search?query=Submarine%20communications%20cable%202006",
  ...
  "article": [
    ...
    {
      "text": "December 26, 2006, is not just a date label for Submarine communications cable. It is the point where a larger technology story becomes visible enough to study. Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and affecting financial transactions. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and... That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Submarine communications cable matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as transoceanic communication line placed on the seabed. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On December 26, 2006, Two earthquakes off the southwest coast of Taiwan damaged submarine communications cables, disrupting Internet services in Asia and affecting financial transactions. Why it mattered: Submarine communications cable matters because it changed how people used machines, networks, media, or information in everyday life. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies Submarine communications cable as transoceanic communication line placed on the seabed. Related subjects include 2006 Hengchun earthquakes (Earthquakes and tsunami near Taiwan), Submarine communications cable (Transoceanic communication line placed on the seabed). The lasting consequence was a faster information world... The related trail points to 2006 Hengchun earthquakes, Submarine communications cable, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Submarine communications cable into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Submarine communications cable is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-26");
