/* Detail payload for 03-20. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["03-20"] = {
  "date": "03-20",
  "displayDate": "March 20",
  "year": 1987,
  "title": "Zidovudine",
  "topic": "Zidovudine",
  "headline": "The antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS.",
  ...
  "source": "https://en.wikipedia.org/wiki/Zidovudine",
  "sourceLabel": "Wikipedia: Zidovudine",
  "sourceDescription": "Antiretroviral medication",
  "visual": "medicine",
  "palette": "laboratory",
  "dek": "The antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS. The deeper story is how this medicine and public health moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 20"
  ...
  "related": [
    ...
    },
    {
      ...
      "description": "Spectrum of conditions caused by HIV infection"
    }
  ],
  "coolFacts": [
    "March 20 places the reader in 1987, inside a medicine and public health story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Zidovudine.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Zidovudine",
      "href": "https://commons.wikimedia.org/w/index.php?search=Zidovudine%201987&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Medical Research",
      "title": "PubMed search: Zidovudine",
      "href": "https://pubmed.ncbi.nlm.nih.gov/?term=Zidovudine%201987",
      "description": "Medical and scientific literature leads connected to the health or biotechnology history."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Zidovudine",
      "href": "https://archive.org/search?query=Zidovudine%201987",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Zidovudine",
      "href": "https://www.britannica.com/search?query=Zidovudine",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Zidovudine",
      "href": "https://www.nytimes.com/search?query=Zidovudine%201987",
  ...
  "article": [
    ...
    {
      "text": "March 20, 1987, is not just a date label for Zidovudine. It is the point where a larger medicine and public health story becomes visible enough to study. The antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On March 20, 1987, the antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS. Why it mattered: Zidovudine marked a first, and it changed how doctors, patients, public-health officials, or researchers understood disease and treatment. In the wider medicine story, it changed how doctors, patients, public-health officials, or researchers understood disease and treatment. The source record identifies Zidovudine as antiretroviral medication. Related subjects include Antiviral drug (Medication used to treat a viral infection), Zidovudine (Antiretroviral medication), Food and Drug Administration (Federal agency of the United States Department of Health and Human Services), HIV/AIDS (Spectrum of conditions caused... The related trail points to Antiviral drug, Zidovudine, Food and Drug Administration, HIV/AIDS, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Zidovudine into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Zidovudine is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Zidovudine, the detail work starts with the nouns inside the event itself: The antiretroviral drug zidovudine became the first treatment approved by the U.S. Food and Drug Administration for HIV/AIDS. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("03-20");
