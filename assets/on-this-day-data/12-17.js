/* Detail payload for 12-17. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["12-17"] = {
  "date": "12-17",
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/Mohamed_Bouazizi",
      "description": "Tunisian who self-immolated (1984–2011)"
    },
    {
      "title": "Sidi Bouzid",
      "source": "https://en.wikipedia.org/wiki/Sidi_Bouzid",
      "description": "City in Sidi Bouzid Governorate, Tunisia"
    },
    {
      "title": "Self-immolation",
      "source": "https://en.wikipedia.org/wiki/Self-immolation",
      "description": "Suicide by setting oneself on fire"
    }
  ],
  "coolFacts": [
    "December 17 places the reader in 2010, inside a protest story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=Arab%20Spring%202010&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "href": "https://catalog.archives.gov/search?q=Arab%20Spring%202010",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Arab Spring",
      "href": "https://archive.org/search?query=Arab%20Spring%202010",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=Arab%20Spring%202010",
  ...
  "article": [
    ...
    {
      "text": "December 17, 2010, is not just a date label for Arab Spring. It is the point where a larger protest story becomes visible enough to study. Arab Spring: Mohamed Bouazizi, a street vendor in Sidi Bouzid, set himself on fire in protest against police harassment, triggering the Tunisian revolution. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "For Arab Spring, the detail work starts with the nouns inside the event itself: Arab Spring: Mohamed Bouazizi, a street vendor in Sidi Bouzid, set himself on fire in protest against police harassment, triggering the Tunisian revolution. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of December 17 is easy: Arab Spring: Mohamed Bouazizi, a street vendor in Sidi Bouzid, set himself on fire in protest against police harassment, triggering the Tunisian revolution. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("12-17");
