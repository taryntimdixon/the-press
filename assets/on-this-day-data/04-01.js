/* Detail payload for 04-01. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-01"] = {
  "date": "04-01",
  "displayDate": "April 1",
  "year": 1976,
  "title": "Steve Jobs",
  "topic": "Steve Jobs",
  "headline": "Steve Jobs and Steve Wozniak founded Apple Computer, Inc..",
  "text": "Steve Jobs and Steve Wozniak founded Apple Computer, Inc..",
  "source": "https://en.wikipedia.org/wiki/Steve_Jobs",
  "sourceLabel": "Wikipedia: Steve Jobs",
  "sourceDescription": "American businessman and inventor (1955–2011)",
  "visual": "tech",
  "palette": "laboratory",
  "dek": "Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. The deeper story is how this technology moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 1"
    ...
    {
      "label": "Source trail",
      "value": "American businessman and inventor (1955–2011)"
    }
  ],
  "summary": [
    "April 1, 1976, is not just a date label for Steve Jobs. It is the point where a larger technology story becomes visible enough to study. Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a workspace where machines, investors, users, engineers, and public curiosity started pulling in the same direction. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Steve Jobs belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1802,
  "related": [
    {
      "title": "Steve Jobs",
      "source": "https://en.wikipedia.org/wiki/Steve_Jobs",
      "description": "American businessman and inventor (1955–2011)"
    },
    {
      "title": "Steve Wozniak",
      "source": "https://en.wikipedia.org/wiki/Steve_Wozniak",
      "description": "American engineer and programmer (born 1950)"
    },
    {
      "title": "Apple Inc.",
  ...
  "coolFacts": [
    "April 1 places the reader in 1976, inside a technology story with consequences beyond the date itself.",
    "Steve Jobs and Steve Wozniak founded Apple Computer, Inc..",
    "The central source trail begins with Steve Jobs.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Steve Jobs",
      "href": "https://commons.wikimedia.org/w/index.php?search=Steve%20Jobs%201976&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Steve Jobs",
      "href": "https://www.si.edu/search?edan_q=Steve%20Jobs%201976",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Steve Jobs",
      "href": "https://archive.org/search?query=Steve%20Jobs%201976",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Steve Jobs",
      "href": "https://www.britannica.com/search?query=Steve%20Jobs",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Steve Jobs",
      "href": "https://www.nytimes.com/search?query=Steve%20Jobs%201976",
  ...
  "article": [
    ...
    {
      "text": "April 1, 1976, is not just a date label for Steve Jobs. It is the point where a larger technology story becomes visible enough to study. Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people used tools, information, screens, networks, or systems in daily life. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Steve Jobs matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american businessman and inventor (1955–2011). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On April 1, 1976, Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. Why it mattered: Steve Jobs matters because it changed how people used machines, networks, media, or information in everyday life. In the wider tech story, it changed how people used machines, networks, media, or information in everyday life. The source record identifies Steve Jobs as american businessman and inventor (1955–2011). Related subjects include Steve Jobs (American businessman and inventor (1955–2011)), Steve Wozniak (American engineer and programmer (born 1950)), Apple Inc. (American multinational technology company). The lasting consequence was a faster information world... The related trail points to Steve Jobs, Steve Wozniak, Apple Inc., which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Steve Jobs is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Steve Jobs, the detail work starts with the nouns inside the event itself: Steve Jobs and Steve Wozniak founded Apple Computer, Inc.. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-01");
