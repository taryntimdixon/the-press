/* Detail payload for 08-02. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["08-02"] = {
  "date": "08-02",
  "displayDate": "August 2",
  "year": 1971,
  "title": "The Who",
  "topic": "The Who",
  "headline": "The English rock band the Who released Who's Next, their only album to top the UK charts.",
  "text": "The English rock band the Who released Who's Next, their only album to top the UK charts.",
  "source": "https://en.wikipedia.org/wiki/The_Who",
  "sourceLabel": "Wikipedia: The Who",
  "sourceDescription": "English rock band",
  "visual": "music",
  "palette": "stage",
  "dek": "The English rock band the Who released Who's Next, their only album to top the UK charts. The deeper story is how this music and broadcast culture moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "August 2"
  ...
  "summary": [
    "August 2, 1971, is not just a date label for The Who. It is the point where a larger music and broadcast culture story becomes visible enough to study. The English rock band the Who released Who's Next, their only album to top the UK charts. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "The English rock band the Who released Who's Next, their only album to top the UK charts. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a performance, studio, stadium, record shop, broadcast booth, or crowd where sound became a public event. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. The Who belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1836,
  "related": [
    {
    ...
    },
    {
      ...
      "description": "1971 studio album by the Who"
    },
    {
      "title": "UK Albums Chart",
      "source": "https://en.wikipedia.org/wiki/UK_Albums_Chart",
      "description": "British albums sales chart"
    }
  ],
  "coolFacts": [
    "August 2 places the reader in 1971, inside a music and broadcast culture story with consequences beyond the date itself.",
    "The English rock band the Who released Who's Next, their only album to top the UK charts.",
    "The central source trail begins with The Who.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: The Who",
      "href": "https://commons.wikimedia.org/w/index.php?search=The%20Who%201971&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: The Who",
      "href": "https://www.si.edu/search?edan_q=The%20Who%201971",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: The Who",
      "href": "https://archive.org/search?query=The%20Who%201971",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: The Who",
      "href": "https://www.britannica.com/search?query=The%20Who",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: The Who",
      "href": "https://www.nytimes.com/search?query=The%20Who%201971",
  ...
  "article": [
    ...
    {
      "text": "August 2, 1971, is not just a date label for The Who. It is the point where a larger music and broadcast culture story becomes visible enough to study. The English rock band the Who released Who's Next, their only album to top the UK charts. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "The English rock band the Who released Who's Next, their only album to top the UK charts. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how audiences gathered, remembered, mourned, celebrated, or imagined themselves through music. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. The Who matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On August 2, 1971, the English rock band the Who released Who's Next, their only album to top the UK charts. Why it mattered: The Who matters because it changed the sound, business, audience, or shared memory of popular music. In the wider music story, it changed the sound, business, audience, or shared memory of popular music. The source record identifies The Who as english rock band. Related subjects include The Who (English rock band), Who's Next (1971 studio album by the Who), UK Albums Chart (British albums sales chart). The lasting consequence was cultural memory: a sound, performance, release, or... The related trail points to The Who, Who's Next, UK Albums Chart, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten The Who into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. The Who is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For The Who, the detail work starts with the nouns inside the event itself: The English rock band the Who released Who's Next, their only album to top the UK charts. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("08-02");
