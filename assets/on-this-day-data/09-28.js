/* Detail payload for 09-28. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-28"] = {
  "date": "09-28",
  ...
  "facts": [
    ...
    {
      "label": "Main event",
      "value": "Declaration of Independence (Mexico)"
    },
    {
  ...
  "related": [
    {
      "title": "Declaration of Independence (Mexico)",
      "source": "https://en.wikipedia.org/wiki/Declaration_of_Independence_(Mexico)",
      "description": "1821 document"
    },
    {
      "title": "National Palace (Mexico)",
      "source": "https://en.wikipedia.org/wiki/National_Palace_(Mexico)",
      "description": "Palace in Mexico City"
    }
  ],
  "coolFacts": [
    "September 28 places the reader in 1821, inside a government and civic power story with consequences beyond the date itself.",
    "The Declaration of Independence of the Mexican Empire from Spain was drafted in the National Palace in Mexico City.",
    "The central source trail begins with Declaration of Independence (Mexico).",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Declaration of Independence (Mexico)",
      "href": "https://commons.wikimedia.org/w/index.php?search=Declaration%20of%20Independence%20(Mexico)%201821&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Declaration of Independence (Mexico)",
      "href": "https://catalog.archives.gov/search?q=Declaration%20of%20Independence%20(Mexico)%201821",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Declaration of Independence (Mexico)",
      "href": "https://archive.org/search?query=Declaration%20of%20Independence%20(Mexico)%201821",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Declaration of Independence (Mexico)",
      "href": "https://www.britannica.com/search?query=Declaration%20of%20Independence%20(Mexico)",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Declaration of Independence (Mexico)",
      "href": "https://www.nytimes.com/search?query=Declaration%20of%20Independence%20(Mexico)%201821",
  ...
  "article": [
    ...
    {
      "text": "September 28, 1821, is not just a date label for Declaration of Independence (Mexico). It is the point where a larger government and civic power story becomes visible enough to study. The Declaration of Independence of the Mexican Empire from Spain was drafted in the National Palace in Mexico City. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 28, 1821, the Declaration of Independence of the Mexican Empire from Spain was drafted in the National Palace in Mexico City. Why it mattered: Declaration of Independence (Mexico) matters because it changed how an institution, law, government, treaty, or public office worked. In the wider civic story, it changed how an institution, law, government, treaty, or public office worked. The source record identifies Declaration of Independence (Mexico) as 1821 document. Related subjects include Declaration of Independence (Mexico) (1821 document), National Palace (Mexico) (Palace in Mexico City). The lasting consequence was institutional: a rule, office, treaty, court, border, or public body worked differently afterward. The related trail points to Declaration of Independence (Mexico), National Palace (Mexico), which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Declaration of Independence (Mexico) into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Declaration of Independence (Mexico) is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Declaration of Independence (Mexico), the detail work starts with the nouns inside the event itself: The Declaration of Independence of the Mexican Empire from Spain was drafted in the National Palace in Mexico City. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-28");
