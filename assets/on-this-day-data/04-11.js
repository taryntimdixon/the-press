/* Detail payload for 04-11. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["04-11"] = {
  "date": "04-11",
  "displayDate": "April 11",
  "year": 1885,
  "title": "Luton Town F.C.",
  "topic": "Luton Town F.C.",
  "headline": "Luton Town Football Club was founded in England.",
  "text": "Luton Town Football Club was founded in England.",
  "source": "https://en.wikipedia.org/wiki/Luton_Town_F.C.",
  "sourceLabel": "Wikipedia: Luton Town F.C.",
  "sourceDescription": "Association football club in Luton, England",
  "visual": "sports",
  "palette": "public-square",
  "dek": "Luton Town Football Club was founded in England. The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "April 11"
    ...
    {
      "label": "Source trail",
      "value": "Association football club in Luton, England"
    }
  ],
  "summary": [
    "April 11, 1885, is not just a date label for Luton Town F.C.. It is the point where a larger history story becomes visible enough to study. Luton Town Football Club was founded in England. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "Luton Town Football Club was founded in England. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "coolFacts": [
    "April 11 places the reader in 1885, inside a history story with consequences beyond the date itself.",
    "Luton Town Football Club was founded in England.",
    "A useful starting source is Luton Town F.C..",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Luton Town F.C.",
      "href": "https://commons.wikimedia.org/w/index.php?search=Luton%20Town%20F.C.%201885&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Luton Town F.C.",
      "href": "https://www.si.edu/search?edan_q=Luton%20Town%20F.C.%201885",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Luton Town F.C.",
      "href": "https://archive.org/search?query=Luton%20Town%20F.C.%201885",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Luton Town F.C.",
      "href": "https://www.britannica.com/search?query=Luton%20Town%20F.C.",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Luton Town F.C.",
      "href": "https://www.nytimes.com/search?query=Luton%20Town%20F.C.%201885",
  ...
  "article": [
    ...
    {
      "text": "April 11, 1885, is not just a date label for Luton Town F.C.. It is the point where a larger history story becomes visible enough to study. Luton Town Football Club was founded in England. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "Luton Town Football Club was founded in England. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Luton Town F.C. matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as association football club in Luton, England. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Luton Town F.C., the detail work starts with the nouns inside the event itself: Luton Town Football Club was founded in England. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("04-11");
