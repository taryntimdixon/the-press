/* Detail payload for 07-11. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["07-11"] = {
  "date": "07-11",
  "displayDate": "July 11",
  "year": 1979,
  ...
  "visual": "space",
  "palette": "neon",
  "dek": "Skylab reentered Earth’s atmosphere, scattering debris over the Indian Ocean and Western Australia. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "July 11"
    ...
    {
      "label": "Source trail",
      "value": "NASA history of Skylab reentry on July 11, 1979"
    }
  ],
  "summary": [
  ...
  "sources": [
    {
      "kind": "NASA History",
      "title": "NASA: Skylab reenters Earth’s atmosphere",
      "href": "https://www.nasa.gov/history/45-years-ago-skylab-reenters-earths-atmosphere/",
      "description": "NASA anniversary history of Skylab’s reentry and debris path."
    },
    {
      "kind": "Image Archive",
      "title": "NASA Images search: Skylab reentry",
      "href": "https://images.nasa.gov/search-results?q=Skylab%20reentry",
      "description": "Images, media, and archive leads connected to Skylab’s return."
    },
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Skylab Falls to Earth",
      "href": "https://commons.wikimedia.org/w/index.php?search=Skylab%20Falls%20to%20Earth%201979&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: Skylab Falls to Earth",
      "href": "https://www.nasa.gov/search/?search=Skylab%20Falls%20to%20Earth%201979",
      "description": "Mission pages, images, technical background, and space-history context where available."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Skylab Falls to Earth",
      "href": "https://archive.org/search?query=Skylab%20Falls%20to%20Earth%201979",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Skylab Falls to Earth",
      "href": "https://www.britannica.com/search?query=Skylab",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Skylab Falls to Earth",
      "href": "https://www.nytimes.com/search?query=Skylab%20Falls%20to%20Earth%201979",
  ...
  "article": [
    ...
    {
      "text": "July 11, 1979, is not just a date label for Skylab Falls to Earth. It is the point where a larger space exploration story becomes visible enough to study. Skylab reentered Earth’s atmosphere, scattering debris over the Indian Ocean and Western Australia and turning space infrastructure, media suspense, and orbital decay into a worldwide spectacle. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it pushed the boundary between ordinary life on Earth and the dangerous machinery of exploration. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Skylab Falls to Earth matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as nASA history of Skylab reentry on July 11, 1979. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The fall made orbital decay visible and turned space infrastructure into a story about risk, uncertainty, debris, and public imagination. That is the specific turn inside Skylab Falls to Earth. The event does not matter only because it appears on a timeline; it matters because it rearranged expectations around a particular institution, medium, body of law, machine, movement, audience, or landscape. The reader can follow that turn through the source trail: the official record, the images, the museum or institutional material, and later reporting that shows how the event kept changing after the first headlines passed.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Skylab Falls to Earth into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Skylab Falls to Earth is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Skylab Falls to Earth, the detail work starts with the nouns inside the event itself: Skylab reentered Earth’s atmosphere, scattering debris over the Indian Ocean and Western Australia and turning space infrastructure, media suspense, and orbital decay into a worldwide spectacle. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("07-11");
