/* Detail payload for 10-09. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-09"] = {
  "date": "10-09",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "1874 treaty establishing the Universal Postal Union"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      ...
      "description": "Specialized agency of the United Nations"
    },
    {
      "title": "Treaty of Bern",
      "source": "https://en.wikipedia.org/wiki/Treaty_of_Bern",
      "description": "1874 treaty establishing the Universal Postal Union"
    }
  ],
  "coolFacts": [
    "October 9 places the reader in 1874, inside a government and civic power story with consequences beyond the date itself.",
    ...
    "A useful starting source is Treaty of Bern.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Treaty of Bern",
      "href": "https://commons.wikimedia.org/w/index.php?search=Treaty%20of%20Bern%201874&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Treaty of Bern",
      "href": "https://catalog.archives.gov/search?q=Treaty%20of%20Bern%201874",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Treaty of Bern",
      "href": "https://archive.org/search?query=Treaty%20of%20Bern%201874",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Treaty of Bern",
      "href": "https://www.britannica.com/search?query=Treaty%20of%20Bern",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Treaty of Bern",
      "href": "https://www.nytimes.com/search?query=Treaty%20of%20Bern%201874",
  ...
  "article": [
    ...
    {
      "text": "October 9, 1874, is not just a date label for Treaty of Bern. It is the point where a larger government and civic power story becomes visible enough to study. The Universal Postal Union, then known as the General Postal Union, was established with the signing of the Treaty of Bern to unify disparate postal services and regulations so that international mail could be exchanged easily. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-09");
