/* Detail payload for 01-10. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["01-10"] = {
  "date": "01-10",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "President of Guinea from 1984 to 2008"
    }
  ],
  "summary": [
    ...
    "The strongest image for this entry is not a symbol floating in empty space. It is a street, square, prison, factory gate, school, or public building where ordinary people made power answer back. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Lansana Conté belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1874,
  "related": [
    {
      "title": "2007 Guinean general strike",
      "source": "https://en.wikipedia.org/wiki/2007_Guinean_general_strike",
      "description": "2007 general strike in Guinea"
    },
    {
      "title": "Lansana Conté",
      "source": "https://en.wikipedia.org/wiki/Lansana_Cont%C3%A9",
      "description": "President of Guinea from 1984 to 2008"
    }
  ],
  "coolFacts": [
    "January 10 places the reader in 2007, inside a protest story with consequences beyond the date itself.",
    ...
    "The central source trail begins with Lansana Conté.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Lansana Conté",
      "href": "https://commons.wikimedia.org/w/index.php?search=Lansana%20Cont%C3%A9%202007&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Public Records",
      "title": "National Archives search: Lansana Conté",
      "href": "https://catalog.archives.gov/search?q=Lansana%20Cont%C3%A9%202007",
      "description": "Public records, photographs, documents, and government-history leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Lansana Conté",
      "href": "https://archive.org/search?query=Lansana%20Cont%C3%A9%202007",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Lansana Conté",
      "href": "https://www.britannica.com/search?query=Lansana%20Cont%C3%A9",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Lansana Conté",
      "href": "https://www.nytimes.com/search?query=Lansana%20Cont%C3%A9%202007",
  ...
  "article": [
    ...
    {
      "text": "The stakes were straightforward but deep: it changed the emotional temperature of politics and showed what pressure from below could do. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Lansana Conté matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as president of Guinea from 1984 to 2008. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Lansana Conté into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Lansana Conté is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "For Lansana Conté, the detail work starts with the nouns inside the event itself: A general strike began in Guinea as an attempt to force President Lansana Conté to resign, eventually resulting in the appointment of two new prime ministers. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("01-10");
