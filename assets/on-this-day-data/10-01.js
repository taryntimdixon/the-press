/* Detail payload for 10-01. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-01"] = {
  "date": "10-01",
  "displayDate": "October 1",
  "year": 1975,
  "title": "Muhammad Ali",
  "topic": "Muhammad Ali",
  "headline": "In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\".",
  ...
  "sourceLabel": "Wikipedia: Muhammad Ali",
  "sourceDescription": "American boxer and activist (1942–2016)",
  "visual": "sports",
  "palette": "public-square",
  "dek": "In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". The deeper story is how this history moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "October 1"
    ...
    {
      "label": "Source trail",
      "value": "American boxer and activist (1942–2016)"
    }
  ],
  "summary": [
    "October 1, 1975, is not just a date label for Muhammad Ali. It is the point where a larger history story becomes visible enough to study. In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
    "The strongest image for this entry is not a symbol floating in empty space. It is a recorded setting where documents, eyewitnesses, objects, and later memory keep pulling one date back into view. That matters because historical change does not happen in abstract nouns. It happens in rooms, streets, laboratories, courts, stadiums, launch pads, offices, shops, ships, fields, and homes. Muhammad Ali belongs to a real setting full of material clues: documents, machines, voices, clothing, weather, architecture, instruments, crowds, and waiting. Those clues help the event feel less like trivia and more like a situation people had to navigate in real time."
  ],
  "wordCount": 1841,
  "related": [
    {
    ...
    },
    {
      ...
      "description": "American boxer (1944–2011)"
    },
    {
      "title": "Thrilla in Manila",
      "source": "https://en.wikipedia.org/wiki/Thrilla_in_Manila",
      "description": "1975 boxing match at the Araneta Coliseum"
    }
  ],
  "coolFacts": [
    "October 1 places the reader in 1975, inside a history story with consequences beyond the date itself.",
    "In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\".",
    "The central source trail begins with Muhammad Ali.",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Muhammad Ali",
      "href": "https://commons.wikimedia.org/w/index.php?search=Muhammad%20Ali%201975&title=Special:MediaSearch&type=image",
    ...
    },
    {
      ...
      "title": "Smithsonian search: Muhammad Ali",
      "href": "https://www.si.edu/search?edan_q=Muhammad%20Ali%201975",
      "description": "Museum objects, archival traces, photographs, and public-history collection leads."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Muhammad Ali",
      "href": "https://archive.org/search?query=Muhammad%20Ali%201975",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Muhammad Ali",
      "href": "https://www.britannica.com/search?query=Muhammad%20Ali",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Muhammad Ali",
      "href": "https://www.nytimes.com/search?query=Muhammad%20Ali%201975",
  ...
  "article": [
    ...
    {
      "text": "October 1, 1975, is not just a date label for Muhammad Ali. It is the point where a larger history story becomes visible enough to study. In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    {
      "text": "In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how later generations understood the period around it. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Muhammad Ali matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as american boxer and activist (1942–2016). That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The event record also gives this page its factual grain: On October 1, 1975, In boxing, Muhammad Ali defeated Joe Frazier in a match known as the \"Thrilla in Manila\". Why it mattered: Muhammad Ali matters because it changed the record book, the audience, or the way a sport understood its own limits. In the wider sports story, it changed the record book, the audience, or the way a sport understood its own limits. The source record identifies Muhammad Ali as american boxer and activist (1942–2016). Related subjects include Muhammad Ali (American boxer and activist (1942–2016)), Joe Frazier (American boxer (1944–2011)), Thrilla in Manila (1975 boxing match at the Araneta Coliseum). The lasting consequence was public memory: a... The related trail points to Muhammad Ali, Joe Frazier, Thrilla in Manila, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Muhammad Ali into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Muhammad Ali is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-01");
