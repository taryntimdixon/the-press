/* Detail payload for 10-21. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["10-21"] = {
  "date": "10-21",
  ...
  "facts": [
    ...
    {
      "label": "Source trail",
      "value": "City in Kiowa County, Kansas"
    }
  ],
  "summary": [
  ...
  "related": [
    {
      ...
      "description": "1867 resettlement agreement between the US government and southern Plains Indian tribes"
    },
    {
      "title": "Medicine Lodge, Kansas",
      "source": "https://en.wikipedia.org/wiki/Medicine_Lodge%2C_Kansas",
      "description": "City in Kiowa County, Kansas"
    },
    {
      "title": "Plains Indians",
      "source": "https://en.wikipedia.org/wiki/Plains_Indians",
      "description": "Native Americans/First Nations peoples of the Great Plains of North America"
    },
    {
      "title": "Oklahoma",
  ...
  "sources": [
    {
      "kind": "Image Archive",
      "title": "Wikimedia Commons: Medicine Lodge, Kansas",
      "href": "https://commons.wikimedia.org/w/index.php?search=Medicine%20Lodge%2C%20Kansas%201867&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Medical Research",
      "title": "PubMed search: Medicine Lodge, Kansas",
      "href": "https://pubmed.ncbi.nlm.nih.gov/?term=Medicine%20Lodge%2C%20Kansas%201867",
      "description": "Medical and scientific literature leads connected to the health or biotechnology history."
    },
    {
      "kind": "Archive Search",
      "title": "Internet Archive: Medicine Lodge, Kansas",
      "href": "https://archive.org/search?query=Medicine%20Lodge%2C%20Kansas%201867",
      "description": "Books, broadcast material, public-domain media, and older documentary traces."
    },
    {
      "kind": "Reference Search",
      "title": "Britannica search: Medicine Lodge, Kansas",
      "href": "https://www.britannica.com/search?query=Medicine%20Lodge%2C%20Kansas",
      "description": "Reference background for the people, institutions, places, and themes around the event."
    },
    {
      "kind": "News/Research Lead",
      "title": "The New York Times archive search: Medicine Lodge, Kansas",
      "href": "https://www.nytimes.com/search?query=Medicine%20Lodge%2C%20Kansas%201867",
  ...
  "article": [
    ...
    {
      "text": "October 21, 1867, is not just a date label for Medicine Lodge, Kansas. It is the point where a larger medicine and public health story becomes visible enough to study. The first and second of three treaties were signed near Medicine Lodge, Kansas, between the United States federal government and several Native American tribes in the Great Plains, requiring them to relocate to areas in present-day western Oklahoma. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The stakes were straightforward but deep: it changed how people understood disease, treatment, risk, biology, or care. That is why this moment is larger than the people most closely attached to it. History often remembers a name, a title, or an image, but the pressure underneath is broader. A single event can expose a system that was already changing. It can reveal who had access, who was excluded, who controlled the tools, who controlled the narrative, and who paid the cost. Medicine Lodge, Kansas matters because it gives the reader a handle on those pressures without pretending they began or ended on one day.",
      "sources": [
        1
      ]
    },
    {
      "text": "The main source record describes the subject as city in Kiowa County, Kansas. That kind of source description is useful because it anchors the story before interpretation begins. From there, the reader can move outward into archive searches, museum collections, press coverage, and reference histories. No single source should carry the whole event. The richer version lives in the overlap: the main record for the fact pattern, image archives for visual evidence, institutional pages for context, and later coverage for how memory changed. A serious history feature should make that trail visible instead of hiding it behind a polished paragraph.",
      "sources": [
        1,
        2,
        3,
    ...
    {
      "text": "The memory of the event also changes depending on who is doing the remembering. A government may remember ceremony. A community may remember pain or pride. A company may remember invention. A movement may remember courage. Fans may remember the feeling of being present at the beginning. Scholars may remember the structures that made the moment possible. The best entry leaves room for all of that. It does not flatten Medicine Lodge, Kansas into a slogan. It lets the reader see the difference between event, evidence, myth, and consequence.",
      "sources": [
        2,
        6
      ]
    ...
    {
      "text": "That structure is important because longform history should invite curiosity without pretending to be the last word. Medicine Lodge, Kansas is the main event, but the reader can follow the evidence outward: to images, original records, institutional pages, newspapers, oral histories, maps, reviews, court records, scientific explainers, or museum objects. The strongest historical reading usually comes from comparing those traces. One source gives the date; another gives the object; another gives the public reaction; another shows what later memory did to the event.",
      "sources": [
        1,
        2,
        3,
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("10-21");
