/* Detail payload for 09-17. Loaded only when this history entry is opened. */
window.PRESS_ON_THIS_DAY_DETAIL = window.PRESS_ON_THIS_DAY_DETAIL || {};
window.PRESS_ON_THIS_DAY_DETAIL["09-17"] = {
  "date": "09-17",
  "displayDate": "September 17",
  "year": 1962,
  "title": "NASA",
  "topic": "NASA",
  "headline": "NASA announced the Next Nine astronauts selected for the purpose of landing on the moon.",
  "text": "NASA announced the Next Nine astronauts selected for the purpose of landing on the moon.",
  "source": "https://en.wikipedia.org/wiki/NASA",
  "sourceLabel": "Wikipedia: NASA",
  "sourceDescription": "American space and aeronautics agency",
  "visual": "space",
  "palette": "lunar",
  "dek": "NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. The deeper story is how this space exploration moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "September 17"
  ...
  "summary": [
    "September 17, 1962, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
    "NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of expanding this entry is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
  ...
  "related": [
    ...
    },
    {
      ...
      "source": "https://en.wikipedia.org/wiki/NASA_Astronaut_Group_2",
      "description": "2nd group of NASA astronauts"
    },
    {
      "title": "Astronaut",
      "source": "https://en.wikipedia.org/wiki/Astronaut",
      "description": "Spacecraft crew member"
    },
    {
      "title": "Moon landing",
      "source": "https://en.wikipedia.org/wiki/Moon_landing",
      "description": "Arrival of a spacecraft on the Moon's surface"
    }
  ],
  "coolFacts": [
    "September 17 places the reader in 1962, inside a space exploration story with consequences beyond the date itself.",
  ...
  "sources": [
    {
      ...
      "href": "https://commons.wikimedia.org/w/index.php?search=NASA%201962&title=Special:MediaSearch&type=image",
      "description": "Image, object, map, and media leads connected to the event or its historical setting."
    },
    {
      "kind": "Space Archive",
      "title": "NASA search: NASA",
      "href": "https://www.nasa.gov/search/?search=NASA%201962",
    ...
    },
    {
      ...
      "href": "https://archive.org/search?query=NASA%201962",
    ...
    },
    {
      ...
      "href": "https://www.nytimes.com/search?query=NASA%201962",
  ...
  "article": [
    ...
    {
      "text": "September 17, 1962, is not just a date label for NASA. It is the point where a larger space exploration story becomes visible enough to study. NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. The useful way to read the event is to slow it down: who had power in the room, what tools or institutions made the moment possible, who had to live with the result, and why later generations kept returning to it. That is what turns a calendar note into history. The event looks simple in one sentence, but the one sentence is only the doorway.",
      "sources": [
        1
      ]
    },
    ...
    {
      "text": "The event record also gives this page its factual grain: On September 17, 1962, NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. Why it mattered: NASA matters because it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications. In the wider space story, it pushed space exploration into a new technical or symbolic frontier, testing machines, navigation, communications, and public imagination... The source record identifies NASA as american space and aeronautics agency. Related subjects include NASA (American space and aeronautics agency), NASA Astronaut Group 2 (2nd group of NASA astronauts), Astronaut (Spacecraft crew member), Moon landing (Arrival of a spacecraft on the Moon's surface). The... The related trail points to NASA, NASA Astronaut Group 2, Astronaut, Moon landing, which gives the reader names, places, institutions, and neighboring subjects to follow after the main entry. Those details matter because they keep the article attached to the actual historical event instead of drifting into a generic lesson. They give the reader a way to ask better questions: what happened first, what happened next, which people or systems were closest to the change, and which pieces of evidence are worth opening in a new tab.",
      "sources": [
        1,
        4
      ]
    ...
    {
      "text": "For NASA, the detail work starts with the nouns inside the event itself: NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. Each noun points outward. If the entry names a person, the reader should ask what network, training, opposition, or opportunity surrounded that person. If it names a tool, building, route, law, performance, or mission, the reader should ask who made it, who used it, who paid for it, and who was left outside its benefits. That is how the one-day marker becomes a story about process, cause, and consequence.",
      "sources": [
        1,
        2,
        4
    ...
    {
      "text": "The short version of September 17 is easy: NASA announced the Next Nine astronauts selected for the purpose of landing on the moon. The fuller version is that this was a day when the world revealed one of its moving parts. People saw a tool, a right, a danger, a performance, a mission, a decision, or a public shock differently afterward. That is why this entry belongs in the daily history calendar. It gives the reader something exact to look at, but it also opens into a bigger question: what changed once people understood that this had happened?",
      "sources": [
        1
      ]
    },
...
if (typeof window.PRESS_ON_THIS_DAY_DETAIL_READY === 'function') window.PRESS_ON_THIS_DAY_DETAIL_READY("09-17");
