...
window.PRESS_ON_THIS_DAY_DETAIL["03-27"] = {
  ...
  "visual": "medicine",
  "palette": "laboratory",
  "dek": "The Food and Drug Administration approved the drug sildenafil, better known by the trade name Viagra, as the first treatment approved in the United States for erectile dysfunction. The deeper story is how this medicine and public health moment changed what people could expect from the world around them.",
  "facts": [
    {
      "label": "Date",
      "value": "March 27"
  ...
  "article": [
    ...
    {
      "text": "The Food and Drug Administration approved the drug sildenafil, better known by the trade name Viagra, as the first treatment approved in the United States for erectile dysfunction. That sentence already contains the spine of the story: a date, a public action, a result, and a claim about importance. What the short version cannot show is the atmosphere around it. The day belonged to people moving through a specific world with the technology, politics, prejudices, hopes, and limits of their time. The point of slowing down is to let the reader stand inside that world long enough to understand why the event mattered before it became famous, clean, and easy to summarize.",
      "sources": [
        1
      ]
    },
