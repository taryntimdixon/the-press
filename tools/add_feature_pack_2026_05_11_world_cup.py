...
TITLE = "The World Cup Has Never Been This Big"
DEK = (
...
CARDS = [
    ...
    {"class": "place", "avatar": "NYNJ", "outlet": "NJ TRANSIT", "sub": "Mobility", "kicker": "Final route", "headline": "The ride to MetLife turned into its own ticketed system.", "deck": "The special roundtrip fare was reduced after backlash.", "body": "Local reporting shows a May reduction from $150 to $105.", "source": "nj-transit-reduced", "image": GALLERY_IMAGES[1]},
    ...
    {"class": "news", "avatar": "AP", "outlet": "Associated Press", "sub": "Visas", "kicker": "Border pressure", "headline": "Iran says it will play, but wants assurances.", "deck": "The bracket arrives with geopolitics attached.", "body": "AP reported Iranian federation concerns about visas, security, and treatment.", "source": "ap-iran"},
    ...
    {"class": "social", "avatar": "IG", "outlet": "FIFA World Cup", "sub": "Instagram", "kicker": "Visual feed", "headline": "The official image stream is part of the event itself.", "deck": "Culture travels through photos before the whistle stops echoing.", "body": "Instagram works as a live gallery of teams, supporters, cities, and moments.", "source": "fifa-instagram"},
    {"class": "official", "avatar": "US", "outlet": "U.S. Soccer", "sub": "Host team", "kicker": "Home pressure", "headline": "The U.S. hosts most of the event and carries a different kind of expectation.", "deck": "The tournament raises soccer's American ceiling.", "body": "U.S. Soccer's public channels anchor the host-team frame.", "source": "ussoccer"},
    ...
    {"class": "official", "avatar": "2030", "outlet": "FIFA", "sub": "Future hosts", "kicker": "Next century", "headline": "The future of the World Cup is already on the calendar.", "deck": "2026 previews the event's next size and shape.", "body": "The 2030 and 2034 host cycles show the World Cup's expanding geography.", "source": "fifa-2030"},
    ...
    {"class": "social", "avatar": "YT", "outlet": "FIFA", "sub": "YouTube", "kicker": "Video shelf", "headline": "Highlights will speak the tournament's global second language.", "deck": "YouTube gives fans a way back into the match after the whistle.", "body": "FIFA's channel anchors highlights, archive video, explainers, and long-tail viewing.", "source": "fifa-youtube"},
    ...
    {"class": "social", "avatar": "TH", "outlet": "FIFA World Cup", "sub": "Threads", "kicker": "Platform spread", "headline": "The same match will spark different conversations on different apps.", "deck": "Fragmented media is now a matchday condition.", "body": "Threads adds another official lane for quick tournament updates and reaction.", "source": "fifa-threads"},
    ...
    {"class": "news", "avatar": "TSN", "outlet": "TSN", "sub": "Canada media", "kicker": "North screen", "headline": "Canadian coverage will make the tournament local every day.", "deck": "A host nation feels real through daily repetition.", "body": "TSN's soccer coverage is one part of Canada's World Cup media layer.", "source": "tsn"},
    ...
    {"class": "news", "avatar": "ESPN", "outlet": "ESPN", "sub": "Sports desk", "kicker": "Daily debate", "headline": "The World Cup turns into a month-long argument machine.", "deck": "Sports networks will turn every matchday into a national conversation.", "body": "ESPN's World Cup page sits in the daily U.S. sports-news layer.", "source": "espn-world-cup"},
    ...
    {"class": "source", "avatar": "DATA", "outlet": "Soccerway", "sub": "Data", "kicker": "Match record", "headline": "Scores enter history only when they are findable.", "deck": "The data layer is part of the public memory.", "body": "Soccerway provides match and competition records that help track the field.", "source": "soccerway"},
    ...
    {"class": "place", "avatar": "BOS", "outlet": "Boston FWC26", "sub": "Host city", "kicker": "New England", "headline": "Boston's World Cup runs through regional transportation and culture.", "deck": "Gillette turns one matchday into a metro problem.", "body": "Boston's host committee is a public doorway into the local plan.", "source": "boston-host"},
    ...
    {"class": "place", "avatar": "HOU", "outlet": "Houston FWC26", "sub": "Host city", "kicker": "Gulf heat", "headline": "Houston's challenge starts before fans reach the gate.", "deck": "Heat, travel, and visitor movement sit under the matchday story.", "body": "Houston's host committee gives the local event infrastructure a public face.", "source": "houston-host"},
    ...
    {"class": "place", "avatar": "TOR", "outlet": "City of Toronto", "sub": "Host city", "kicker": "Canada stage", "headline": "Toronto's World Cup runs on city services as much as sport.", "deck": "Public information shapes the fan experience.", "body": "Toronto's municipal page is a public reference for local planning.", "source": "toronto-host"},
    ...
    {"class": "utility", "avatar": "LA", "outlet": "LA Metro", "sub": "Transit", "kicker": "Car city puzzle", "headline": "Los Angeles has to make visitor movement legible.", "deck": "Mega-event ambition runs through the transit map.", "body": "LA Metro is one of the core public references for moving through the host region.", "source": "la-metro"},
...
SECTIONS = [
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            '<p>The best World Cups have always been bigger than the field, but not in the same way. They were bigger because a match rearranged a national mood, because a street exploded after a goal, because an underdog made strangers remember where they were. The 2026 version starts with physical and administrative scale before it earns the emotional kind. It has to move bodies before it can move hearts.</p>',
    ...
    },
    {
        ...
        "paragraphs": [
            '<p>The 2026 host map is a thesis. Mexico brings the tournament back to a country that already gave the World Cup two of its most mythic editions, 1970 and 1986. Canada hosts its first men\'s World Cup matches after years of building its national team and soccer infrastructure. The United States hosts most of the schedule and tries again to convert a massive sports economy into something closer to a football country. The map does more than place the games. It makes the tournament\'s argument about the sport\'s future.</p>',
            ...
            '<p>That variation could be the tournament\'s strength. A World Cup should not feel identical in every city. It should sound different in Mexico City than in Seattle, in Miami than in Vancouver, in Kansas City than in Toronto. The event will be richer if each place brings its own weather, food, music, transport habits, immigrant histories, and football cultures into the frame. But variation curdles into confusion when the common basics fail. A fan should not need a local Ph.D. in parking policy to reach a match. A visitor should not have to guess whether a shuttle exists, whether a ticket works, or whether the last train has already left.</p>',
    ...
    {
        "id": "ticket-tells-the-story",
        "heading": "The ticket tells the story",
        "paragraphs": [
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            '<p>The New York New Jersey final region shows how quickly transportation turns political. NJ TRANSIT and the host committee announced a regional stadium mobility plan in April, including special match-specific rail tickets to the Meadowlands. The initial roundtrip price of $150 drew outrage. In early May, NBC New York reported that the price was reduced to $105. That correction matters not only because of the dollars, but because it moved the ride itself into public view. The route to the final is not a neutral detail. It is part of the price of participation.</p>',
    ...
    },
    {
        ...
        "paragraphs": [
            '<p>The field is the quietest confession in the whole event. Several U.S. World Cup venues are NFL buildings, designed first for American football, concerts, corporate suites, and the economics of multipurpose entertainment. The World Cup arrives with a more exacting demand: make the building speak football in the global sense, not merely host soccer as another event line on a calendar.</p>',
            ...
            '<p>Grass is not nostalgia. It is performance infrastructure. It affects ball speed, bounce, traction, fatigue, injury risk, drainage, irrigation, sunlight, airflow, and how a temporary surface holds together under repeated training and match stress. A great pitch disappears into the game because it lets the game explain itself. A bad one enters the plot, and almost never in a good way. Players notice first. Then coaches. Then everyone.</p>',
    ...
    },
    {
        ...
        "paragraphs": [
            '<p>The World Cup is a soft-power event until it is not. It asks countries to show openness, then forces governments to manage every risk that openness creates. The 2026 tournament arrives in a politically tense moment, and the closer kickoff gets, the more visible that tension grows. Security is no longer a background promise. It is part of the story fans, teams, governments, and host cities are already reading.</p>',
            f'<p>Canada announced up to C$145 million in federal support for public safety and security around matches in Toronto and Vancouver. In the United States, recent reporting has focused on heightened risk around U.S. matches, soft targets, hotels, transit hubs, and public gatherings, with the final carrying National Special Security Event weight. That does not mean fear should set the tournament\'s mood. It means the event\'s public joy depends on careful, quiet, layered work. {inline_source("canada-security", "Canada security source")}</p>',
            '<p>The border story is just as complicated. AP reported that Iran\'s soccer federation said it would participate but wanted assurances around visas, security, and treatment, including for team members who had completed mandatory military service in the Revolutionary Guard. That is a sports item only if sports is defined too narrowly. The bracket brings governments into contact. Players and fans move through consular systems, airports, interviews, watchlists, sanctions, media scrutiny, protest politics, and public suspicion. A fixture can enter diplomacy before it reaches kickoff.</p>',
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            '<p>Other firsts carry consequences. In 104 matches, growth either feels generous or overbuilt. Across three countries, one brand has to pass through many legal systems. A richer ticket platform puts demand pricing beside football\'s mass identity. A social-media World Cup splits the public square into platform-sized rooms. A hotter summer brings climate planning out of the appendix. Newness alone is not progress. It is only an opening argument.</p>',
            '<p>There will be small firsts too, the ones that matter more to people than to press releases. A child in Toronto may attend a men\'s World Cup match at home for the first time. A family in Mexico City may connect 2026 to stories told about 1986. A supporter from a debuting nation may see their flag in a stadium they never expected to enter. A U.S. city that has always treated soccer as a niche may discover that the niche was actually a crowd waiting for permission to step into the light.</p>',
    ...
    },
    {
        ...
        "paragraphs": [
            ...
            '<p>Through this event, the world will read North America. The United States will show whether it can host without turning every experience into a premium tier. Mexico will fuse memory with modern pressure. Canada will try to make its first men\'s World Cup feel confident, inclusive, and serious. Three governments will share a stage at a time when borders and nationalism keep hardening. The global game will stretch again, and the question is whether it can keep the intimacy that made it global in the first place.</p>',
            '<p>The future of the World Cup is leaning toward larger hosts, larger budgets, larger political consequences, and hotter questions. The 2030 and 2034 cycles are not distant abstractions. They are the next chapters in a story 2026 is helping to write. If this tournament works, it will strengthen the argument that expansion can broaden belonging. If it fails in public ways, it will feed the suspicion that football\'s greatest event has grown too large, too expensive, and too insulated from the people who give it meaning.</p>',
            '<p>So the stakes are not only who lifts the trophy. The stakes are whether the World Cup can remain the world\'s most generous sporting idea while operating as one of its most complicated logistical products. That balance is fragile. It depends on planners who sweat small details, fans who bring the event to life, workers whose labor is treated with respect, cities willing to learn quickly, and organizers honest enough to admit that scale is not the same thing as welcome.</p>',
        ],
    },
    {
        ...
        "paragraphs": [
            '<p>The successful version of this World Cup is easy to imagine because it is made of ordinary things done well. The opening match feels historic without feeling overproduced. The trains are findable. The shuttle signs are clear. Water is available before people are desperate. Security is serious without tipping into theater. Ticket buyers understand what they purchased. Workers get shade, breaks, and respect. The pitch holds. A visitor who speaks little English can still navigate the day. The stadium is loud because supporters are there, not because the event has been engineered into a generic entertainment product.</p>',
            '<p>The best version also allows the sport to surprise the machinery. A debutant nation steals a point. A favorite survives a scare. A goalkeeper enters national myth. A host city expected to be quiet turns into a street party. A fan without a ticket finds a watch party that feels like belonging. A child learns a player\'s name and keeps it. The World Cup needs planning so that unplanned magic has room to happen.</p>',
            '<p>The failed version is just as visible. A price story overwhelms an access story. A heat plan breaks at the first long queue. A transit surcharge turns into a civic grievance. A security scare away from the stadium redefines a week. A temporary pitch draws player anger. A border dispute drags a fixture into diplomacy. A fan festival reads like crowd-management homework. The tournament still happens, the money still moves, the final still gets played, but the memory gathers around everything that made the game harder to reach.</p>',
            '<p>For years, the 2026 World Cup sounded like the future. Then it sounded like a schedule. Now it sounds like a checklist. That is not a demotion. It is the moment serious hosts should want, because a checklist is how a promise reaches the street. The ball will soon return the tournament to uncertainty, which is where football is happiest. Until then, the story belongs to the system around the match: tickets, trains, heat, grass, security, borders, workers, fans, cities, screens, memory, and the public square.</p>',
...
def render_aside() -> str:
  ...
  <ul>
    ...
    <li>The biggest pressure points include ticket prices, transit, heat, grass installation, public safety, borders, labor, broadcast reach, and social-media accountability.</li>
...
<section class="aside-card">
  ...
  <ol>
    ...
    <li><a href="#ticket-tells-the-story">Tickets</a></li>
    ...
    story.update(
        {
            ...
            "imageAiCaption": "",
            "imageCaption": "The 2026 World Cup puts tickets, transit, heat, security, media, memory and the matchday system around the game.",
            "keywords": [
                "FIFA World Cup 2026",
                "World Cup",
                "soccer",
            ...
            "excerpt": "The 2026 World Cup is one month away, and the hard part is the machine around the match: tickets, transit, heat, grass, security, borders, social media, history and whether a continental event can still feel human.",
            "related": [
